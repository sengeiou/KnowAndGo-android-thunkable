...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public C3873Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        C3873Response response = null;
        int i = 0;
        while (!this.canceled) {
            try {
                C3873Response proceed = realInterceptorChain.proceed(request, streamAllocation2, (HttpCodec) null, (RealConnection) null);
                C3873Response build = response != null ? proceed.newBuilder().priorResponse(response.newBuilder().body((ResponseBody) null).build()).build() : proceed;
                try {
    ...
    private Request followUpRequest(C3873Response response, Route route) throws IOException {
        String header;
        HttpUrl resolve;
        Proxy proxy;
        if (response != null) {
    ...
    private int retryAfter(C3873Response response, int i) {
    ...
    private boolean sameConnection(C3873Response response, HttpUrl httpUrl) {
