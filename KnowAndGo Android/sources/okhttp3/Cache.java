...
import okhttp3.internal.p029io.FileSystem;
...
public final class Cache implements Closeable, Flushable {
    ...
    Cache(File file, long j, FileSystem fileSystem) {
        this.internalCache = new InternalCache() {
            public C3873Response get(Request request) throws IOException {
                return Cache.this.get(request);
            }

            public CacheRequest put(C3873Response response) throws IOException {
            ...
            public void update(C3873Response response, C3873Response response2) {
    ...
    @Nullable
    public C3873Response get(Request request) {
        try {
            ...
            try {
                ...
                C3873Response response = entry.response(snapshot);
    ...
    /* access modifiers changed from: package-private */
    @Nullable
    public CacheRequest put(C3873Response response) {
    ...
    private static final class Entry {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m2491of(list.get(i).getEncoded()).base64()).writeByte(10);
                }
