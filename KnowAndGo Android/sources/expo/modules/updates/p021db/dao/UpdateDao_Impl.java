...
public final class UpdateDao_Impl extends UpdateDao {
    ...
    public UpdateDao_Impl(RoomDatabase roomDatabase) {
        ...
        this.__insertionAdapterOfUpdateEntity = new EntityInsertionAdapter<UpdateEntity>(roomDatabase) {
            ...
            public void bind(SupportSQLiteStatement supportSQLiteStatement, UpdateEntity updateEntity) {
                byte[] uuidToBytes = Converters.uuidToBytes(updateEntity.f2958id);
                if (uuidToBytes == null) {
                    supportSQLiteStatement.bindNull(1);
                } else {
                    supportSQLiteStatement.bindBlob(1, uuidToBytes);
                }
                if (updateEntity.projectIdentifier == null) {
                    supportSQLiteStatement.bindNull(2);
                } else {
                    supportSQLiteStatement.bindString(2, updateEntity.projectIdentifier);
                }
    ...
    public List<UpdateEntity> _loadUpdatesWithStatuses(List<UpdateStatus> list) {
        ...
        newStringBuilder.append("SELECT * FROM updates WHERE status IN (");
        int size = list.size();
        ...
        try {
            ...
            int columnIndexOrThrow2 = CursorUtil.getColumnIndexOrThrow(query, "project_identifier");
    ...
    public expo.modules.updates.p021db.entity.AssetEntity _loadLaunchAsset(java.util.UUID r19) {
        /*
            r18 = this;
            r1 = r18
            ...
            byte[] r0 = expo.modules.updates.p021db.Converters.uuidToBytes(r19)
        ...
        L_0x0016:
            ...
            r2.f2957id = r0     // Catch:{ all -> 0x00da }
            java.lang.String r0 = r5.getString(r6)     // Catch:{ all -> 0x00da }
            android.net.Uri r0 = expo.modules.updates.p021db.Converters.stringToUri(r0)     // Catch:{ all -> 0x00da }
            r2.url = r0     // Catch:{ all -> 0x00da }
            java.lang.String r0 = r5.getString(r8)     // Catch:{ all -> 0x00da }
            org.json.JSONObject r0 = expo.modules.updates.p021db.Converters.stringToJsonObject(r0)     // Catch:{ all -> 0x00da }
        ...
        L_0x00ac:
            java.util.Date r0 = expo.modules.updates.p021db.Converters.longToDate(r17)     // Catch:{ all -> 0x00da }
            ...
            expo.modules.updates.db.enums.HashType r0 = expo.modules.updates.p021db.Converters.intToHashType(r0)     // Catch:{ all -> 0x00da }
        ...
        L_0x00da:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: expo.modules.updates.p021db.dao.UpdateDao_Impl._loadLaunchAsset(java.util.UUID):expo.modules.updates.db.entity.AssetEntity");
    }
