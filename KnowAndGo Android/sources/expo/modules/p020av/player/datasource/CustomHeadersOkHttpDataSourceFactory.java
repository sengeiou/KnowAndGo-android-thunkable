package expo.modules.p020av.player.datasource;
...
public class CustomHeadersOkHttpDataSourceFactory extends HttpDataSource.BaseFactory {
    ...
    public CustomHeadersOkHttpDataSourceFactory(@NonNull Call.Factory factory, @Nullable String str, @Nullable Map<String, Object> map) {
    ...
    public void updateRequestProperties(HttpDataSource.RequestProperties requestProperties, @Nullable Map<String, Object> map) {
        if (map != null) {
