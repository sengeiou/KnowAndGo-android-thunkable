...
public final class ImageLoaderModule implements InternalModule, ImageLoader {
    ...
    public ImageLoaderModule(@NotNull Context context2) {
    ...
    @NotNull
    public Future<Bitmap> loadImageForDisplayFromURL(@NotNull String str) {
    ...
    public void loadImageForDisplayFromURL(@NotNull String str, @NotNull ImageLoader.ResultListener resultListener) {
        Intrinsics.checkParameterIsNotNull(str, ImagesContract.URL);
    ...
    @NotNull
    public Future<Bitmap> loadImageForManipulationFromURL(@NotNull @NonNull String str) {
        Intrinsics.checkParameterIsNotNull(str, ImagesContract.URL);
        SimpleSettableFuture simpleSettableFuture = new SimpleSettableFuture();
    ...
    public void loadImageForManipulationFromURL(@NotNull String str, @NotNull ImageLoader.ResultListener resultListener) {
        Intrinsics.checkParameterIsNotNull(str, ImagesContract.URL);
        Intrinsics.checkParameterIsNotNull(resultListener, "resultListener");
