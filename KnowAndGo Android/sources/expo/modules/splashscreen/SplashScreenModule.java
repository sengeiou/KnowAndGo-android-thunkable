...
@Metadata(mo39784bv = {1, 0, 3}, mo39785d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u0000 \u00112\u00020\u0001:\u0001\u0011B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0007\u001a\u00020\bH\u0016J\u0010\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fH\u0007J\u0010\u0010\r\u001a\u00020\n2\u0006\u0010\u000e\u001a\u00020\u000fH\u0016J\u0010\u0010\u0010\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fH\u0007R\u000e\u0010\u0005\u001a\u00020\u0006X.¢\u0006\u0002\n\u0000¨\u0006\u0012"}, mo39786d2 = {"Lexpo/modules/splashscreen/SplashScreenModule;", "Lorg/unimodules/core/ExportedModule;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "activityProvider", "Lorg/unimodules/core/interfaces/ActivityProvider;", "getName", "", "hideAsync", "", "promise", "Lorg/unimodules/core/Promise;", "onCreate", "moduleRegistry", "Lorg/unimodules/core/ModuleRegistry;", "preventAutoHideAsync", "Companion", "expo-splash-screen_release"}, mo39787k = 1, mo39788mv = {1, 1, 16})
...
public final class SplashScreenModule extends ExportedModule {
    ...
    @Metadata(mo39784bv = {1, 0, 3}, mo39785d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo39786d2 = {"Lexpo/modules/splashscreen/SplashScreenModule$Companion;", "", "()V", "ERROR_TAG", "", "NAME", "expo-splash-screen_release"}, mo39787k = 1, mo39788mv = {1, 1, 16})
    /* compiled from: SplashScreenModule.kt */
    ...
    public SplashScreenModule(@NotNull Context context) {
        super(context);
        Intrinsics.checkParameterIsNotNull(context, "context");
    }

    public void onCreate(@NotNull ModuleRegistry moduleRegistry) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(module, "moduleRegistry.getModule…vityProvider::class.java)");
        this.activityProvider = (ActivityProvider) module;
    }

    @ExpoMethod
    public final void preventAutoHideAsync(@NotNull Promise promise) {
    ...
    @ExpoMethod
    public final void hideAsync(@NotNull Promise promise) {
        Intrinsics.checkParameterIsNotNull(promise, BaseJavaModule.METHOD_TYPE_PROMISE);
        ActivityProvider activityProvider2 = this.activityProvider;
        if (activityProvider2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("activityProvider");
