...
public final class ScreenOrientationModule extends ExportedModule implements LifecycleEventListener {
    ...
    public ScreenOrientationModule(@NotNull Context context) {
        super(context);
    ...
    @ExpoMethod
    public final void lockAsync(int i, @NotNull Promise promise) {
    ...
    @ExpoMethod
    public final void lockPlatformAsync(int i, @NotNull Promise promise) {
        Intrinsics.checkParameterIsNotNull(promise, BaseJavaModule.METHOD_TYPE_PROMISE);
        ActivityProvider activityProvider = this.mActivityProvider;
        if (activityProvider == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mActivityProvider");
    ...
    @ExpoMethod
    public final void getOrientationAsync(@NotNull Promise promise) {
        Intrinsics.checkParameterIsNotNull(promise, BaseJavaModule.METHOD_TYPE_PROMISE);
        ActivityProvider activityProvider = this.mActivityProvider;
        if (activityProvider == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mActivityProvider");
    ...
    @ExpoMethod
    public final void getOrientationLockAsync(@NotNull Promise promise) {
        Intrinsics.checkParameterIsNotNull(promise, BaseJavaModule.METHOD_TYPE_PROMISE);
        ActivityProvider activityProvider = this.mActivityProvider;
        if (activityProvider == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mActivityProvider");
    ...
    @ExpoMethod
    public final void getPlatformOrientationLockAsync(@NotNull Promise promise) {
        Intrinsics.checkParameterIsNotNull(promise, BaseJavaModule.METHOD_TYPE_PROMISE);
        ActivityProvider activityProvider = this.mActivityProvider;
        if (activityProvider == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mActivityProvider");
    ...
    @ExpoMethod
    public final void supportsOrientationLockAsync(int i, @NotNull Promise promise) {
        Intrinsics.checkParameterIsNotNull(promise, BaseJavaModule.METHOD_TYPE_PROMISE);
        try {
