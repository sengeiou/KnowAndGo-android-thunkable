...
public class RNGoogleSigninModule extends ReactContextBaseJavaModule {
    ...
    public void handleSignInTaskResult(Task<GoogleSignInAccount> task) {
        try {
            ...
            this.promiseWrapper.resolve(C0618Utils.getUserProperties(result));
    ...
    public void signOut(final Promise promise) {
        if (this._apiClient == null) {
            ...
            this._apiClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
    ...
    public void handleSignOutOrRevokeAccessTask(@NonNull Task<Void> task, Promise promise) {
        ...
        int exceptionCode = C0618Utils.getExceptionCode(task);
    ...
    public void revokeAccess(final Promise promise) {
        if (this._apiClient == null) {
            ...
            this._apiClient.revokeAccess().addOnCompleteListener(new OnCompleteListener<Void>() {
                public void onComplete(@NonNull Task<Void> task) {
                    RNGoogleSigninModule.this.handleSignOutOrRevokeAccessTask(task, promise);
                }
            });
    ...
    public void getCurrentUser(Promise promise) {
        ...
        if (lastSignedInAccount == null) {
            ...
            writableMap = C0618Utils.getUserProperties(lastSignedInAccount);
        }
    ...
    private void startTokenRetrievalTaskWithRecovery(GoogleSignInAccount googleSignInAccount) {
        WritableMap userProperties = C0618Utils.getUserProperties(googleSignInAccount);
    ...
    private static class AccessTokenRetrievalTask extends AsyncTask<WritableMap, Void, Void> {
        ...
        private void insertAccessTokenIntoUserProperties(RNGoogleSigninModule rNGoogleSigninModule, WritableMap writableMap) throws IOException, GoogleAuthException {
            writableMap.putString("accessToken", GoogleAuthUtil.getToken((Context) rNGoogleSigninModule.getReactApplicationContext(), new Account(writableMap.getMap("user").getString("email"), "com.google"), C0618Utils.scopesToString(writableMap.getArray("scopes"))));
        }

        private void handleException(RNGoogleSigninModule rNGoogleSigninModule, Exception exc, WritableMap writableMap, @Nullable WritableMap writableMap2) {
