...
public final class TypeIntersector {
    ...
    private final SimpleType intersectTypesWithoutIntersectionType(Set<? extends SimpleType> set) {
        ...
        Function0 typeIntersector$intersectTypesWithoutIntersectionType$errorMessage$1 = new C3833x7a6103fb(set);
        Collection collection = set;
        Collection<SimpleType> filterTypes = filterTypes(collection, new C3834x702eebb8(this));
        ...
        if (!_Assertions.ENABLED || z) {
            ...
            Collection<SimpleType> filterTypes2 = filterTypes(filterTypes, new C3835xc97d8c34(NewKotlinTypeChecker.INSTANCE));
