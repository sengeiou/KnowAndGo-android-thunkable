...
public final class NewCapturedTypeKt {
    public static /* synthetic */ SimpleType captureFromArguments$default(SimpleType simpleType, CaptureStatus captureStatus, Function2<Object, Object, Unit> function2, int i, Object obj) {
        if ((i & 4) != 0) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (typeProjection2.getProjectionKind() != Variance.INVARIANT) {
                ...
                if (!typeProjection2.isStarProjection() && typeProjection2.getProjectionKind() == Variance.OUT_VARIANCE) {
                    list2 = CollectionsKt.plus(list2, NewKotlinTypeChecker.INSTANCE.transformToNewType(typeProjection2.getType().unwrap()));
                }
