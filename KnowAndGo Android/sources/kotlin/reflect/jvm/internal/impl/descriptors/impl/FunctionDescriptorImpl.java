...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public FunctionDescriptor getOriginal() {
        FunctionDescriptor original2 = this.original == this ? this : this.original.getOriginal();
        if (original2 == null) {
            $$$reportNull$$$0(18);
        }
        return original2;
    ...
    public class CopyConfiguration implements FunctionDescriptor.CopyBuilder<FunctionDescriptor> {
        ...
        public CopyConfiguration(@NotNull FunctionDescriptorImpl functionDescriptorImpl, @NotNull TypeSubstitution typeSubstitution, @NotNull DeclarationDescriptor declarationDescriptor, @NotNull Modality modality, @NotNull Visibility visibility, @NotNull CallableMemberDescriptor.Kind kind2, @Nullable List<ValueParameterDescriptor> list, @NotNull ReceiverParameterDescriptor receiverParameterDescriptor, @Nullable KotlinType kotlinType, Name name2) {
    ...
    public FunctionDescriptor doSubstitute(@NotNull CopyConfiguration copyConfiguration) {
        ...
        if (!copyConfiguration.userDataMap.isEmpty() || this.userDataMap != null) {
            ...
            if (this.userDataMap != null) {
                for (Map.Entry next : this.userDataMap.entrySet()) {
