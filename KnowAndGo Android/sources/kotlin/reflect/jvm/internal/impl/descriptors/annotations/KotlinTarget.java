...
public enum KotlinTarget {
    ...
    static {
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(TuplesKt.m2473to(AnnotationUseSiteTarget.CONSTRUCTOR_PARAMETER, VALUE_PARAMETER), TuplesKt.m2473to(AnnotationUseSiteTarget.FIELD, FIELD), TuplesKt.m2473to(AnnotationUseSiteTarget.PROPERTY, PROPERTY), TuplesKt.m2473to(AnnotationUseSiteTarget.FILE, FILE), TuplesKt.m2473to(AnnotationUseSiteTarget.PROPERTY_GETTER, PROPERTY_GETTER), TuplesKt.m2473to(AnnotationUseSiteTarget.PROPERTY_SETTER, PROPERTY_SETTER), TuplesKt.m2473to(AnnotationUseSiteTarget.RECEIVER, VALUE_PARAMETER), TuplesKt.m2473to(AnnotationUseSiteTarget.SETTER_PARAMETER, VALUE_PARAMETER), TuplesKt.m2473to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, FIELD));
    }
