...
public final class MemberDeserializer {
    private final AnnotationDeserializer annotationDeserializer = new AnnotationDeserializer(this.f3000c.getComponents().getModuleDescriptor(), this.f3000c.getComponents().getNotFoundClasses());
    /* access modifiers changed from: private */

    /* renamed from: c */
    public final DeserializationContext f3000c;
    ...
    public MemberDeserializer(@NotNull DeserializationContext deserializationContext) {
        ...
        this.f3000c = deserializationContext;
    }
    ...
    public final PropertyDescriptor loadProperty(@NotNull ProtoBuf.Property property) {
        ...
        DeclarationDescriptor containingDeclaration = this.f3000c.getContainingDeclaration();
        ...
        Name name = NameResolverUtilKt.getName(this.f3000c.getNameResolver(), property.getName());
        ...
        DeserializedPropertyDescriptor deserializedPropertyDescriptor2 = new DeserializedPropertyDescriptor(containingDeclaration, (PropertyDescriptor) null, annotations2, modality, visibility, booleanValue, name, memberKind, booleanValue2, booleanValue3, booleanValue4, booleanValue5, bool6.booleanValue(), property, this.f3000c.getNameResolver(), this.f3000c.getTypeTable(), this.f3000c.getVersionRequirementTable(), this.f3000c.getContainerSource());
        DeserializationContext deserializationContext = this.f3000c;
        ...
        KotlinType type2 = childContext$default.getTypeDeserializer().type(ProtoTypeTableUtilKt.returnType(property4, this.f3000c.getTypeTable()));
        ...
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(property4, this.f3000c.getTypeTable());
        ...
        if (bool16.booleanValue()) {
            deserializedPropertyDescriptor3.setCompileTimeInitializer(this.f3000c.getStorageManager().createNullableLazyValue(new MemberDeserializer$loadProperty$3(this, property4, deserializedPropertyDescriptor3)));
        }
    ...
    private final kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.DeserializedMemberDescriptor.CoroutinesCompatibilityMode computeExperimentalityModeForFunctions(@org.jetbrains.annotations.NotNull kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.DeserializedCallableMemberDescriptor r4, kotlin.reflect.jvm.internal.impl.descriptors.ReceiverParameterDescriptor r5, java.util.Collection<? extends kotlin.reflect.jvm.internal.impl.descriptors.ValueParameterDescriptor> r6, java.util.Collection<? extends kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor> r7, kotlin.reflect.jvm.internal.impl.types.KotlinType r8, boolean r9) {
        /*
            r3 = this;
            r0 = r4
    ...
    private final boolean versionAndReleaseCoroutinesMismatch(@NotNull DeserializedMemberDescriptor deserializedMemberDescriptor) {
        boolean z;
        boolean z2;
        if (!this.f3000c.getComponents().getConfiguration().getReleaseCoroutines()) {
            return false;
        }
    ...
    public final SimpleFunctionDescriptor loadFunction(@NotNull ProtoBuf.Function function) {
        ...
        if (Intrinsics.areEqual((Object) DescriptorUtilsKt.getFqNameSafe(this.f3000c.getContainingDeclaration()).child(NameResolverUtilKt.getName(this.f3000c.getNameResolver(), function.getName())), (Object) SuspendFunctionTypeUtilKt.KOTLIN_SUSPEND_BUILT_IN_FUNCTION_FQ_NAME)) {
            versionRequirementTable = VersionRequirementTable.Companion.getEMPTY();
        } else {
            versionRequirementTable = this.f3000c.getVersionRequirementTable();
        }
        DeserializedSimpleFunctionDescriptor deserializedSimpleFunctionDescriptor = new DeserializedSimpleFunctionDescriptor(this.f3000c.getContainingDeclaration(), (SimpleFunctionDescriptor) null, annotations2, NameResolverUtilKt.getName(this.f3000c.getNameResolver(), function.getName()), ProtoEnumFlags.INSTANCE.memberKind(Flags.MEMBER_KIND.get(flags)), function, this.f3000c.getNameResolver(), this.f3000c.getTypeTable(), versionRequirementTable, this.f3000c.getContainerSource(), (SourceElement) null, 1024, (DefaultConstructorMarker) null);
        DeserializationContext deserializationContext = this.f3000c;
        ...
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(function2, this.f3000c.getTypeTable());
        ...
        KotlinType type2 = childContext$default.getTypeDeserializer().type(ProtoTypeTableUtilKt.returnType(function2, this.f3000c.getTypeTable()));
        Modality modality = ProtoEnumFlags.INSTANCE.modality(Flags.MODALITY.get(flags));
        Visibility visibility = ProtoEnumFlags.INSTANCE.visibility(Flags.VISIBILITY.get(flags));
        ...
        Pair<CallableDescriptor.UserDataKey<?>, Object> deserializeContractFromFunction = this.f3000c.getComponents().getContractDeserializer().deserializeContractFromFunction(function2, deserializedSimpleFunctionDescriptor3, this.f3000c.getTypeTable(), this.f3000c.getTypeDeserializer());
    ...
    public final TypeAliasDescriptor loadTypeAlias(@NotNull ProtoBuf.TypeAlias typeAlias) {
        ...
        for (ProtoBuf.Annotation annotation : iterable) {
            ...
            arrayList.add(annotationDeserializer2.deserializeAnnotation(annotation, this.f3000c.getNameResolver()));
        }
        DeserializedTypeAliasDescriptor deserializedTypeAliasDescriptor = new DeserializedTypeAliasDescriptor(this.f3000c.getStorageManager(), this.f3000c.getContainingDeclaration(), companion.create((List) arrayList), NameResolverUtilKt.getName(this.f3000c.getNameResolver(), typeAlias.getName()), ProtoEnumFlags.INSTANCE.visibility(Flags.VISIBILITY.get(typeAlias.getFlags())), typeAlias, this.f3000c.getNameResolver(), this.f3000c.getTypeTable(), this.f3000c.getVersionRequirementTable(), this.f3000c.getContainerSource());
        List<ProtoBuf.TypeParameter> typeParameterList = typeAlias.getTypeParameterList();
        Intrinsics.checkExpressionValueIsNotNull(typeParameterList, "proto.typeParameterList");
        DeserializationContext childContext$default = DeserializationContext.childContext$default(this.f3000c, deserializedTypeAliasDescriptor, typeParameterList, (NameResolver) null, (TypeTable) null, (VersionRequirementTable) null, (BinaryVersion) null, 60, (Object) null);
        deserializedTypeAliasDescriptor.initialize(childContext$default.getTypeDeserializer().getOwnTypeParameters(), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.underlyingType(typeAlias2, this.f3000c.getTypeTable())), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.expandedType(typeAlias2, this.f3000c.getTypeTable())), checkExperimentalCoroutine(deserializedTypeAliasDescriptor, childContext$default.getTypeDeserializer()));
    ...
    public final ClassConstructorDescriptor loadConstructor(@NotNull ProtoBuf.Constructor constructor, boolean z) {
        ...
        if (containingDeclaration != null) {
            ...
            DeserializedClassConstructorDescriptor deserializedClassConstructorDescriptor2 = new DeserializedClassConstructorDescriptor(classDescriptor, (ConstructorDescriptor) null, getAnnotations(messageLite, constructor.getFlags(), AnnotatedCallableKind.FUNCTION), z, CallableMemberDescriptor.Kind.DECLARATION, constructor, this.f3000c.getNameResolver(), this.f3000c.getTypeTable(), this.f3000c.getVersionRequirementTable(), this.f3000c.getContainerSource(), (SourceElement) null, 1024, (DefaultConstructorMarker) null);
            MemberDeserializer memberDeserializer = DeserializationContext.childContext$default(this.f3000c, deserializedClassConstructorDescriptor2, CollectionsKt.emptyList(), (NameResolver) null, (TypeTable) null, (VersionRequirementTable) null, (BinaryVersion) null, 60, (Object) null).getMemberDeserializer();
            ...
            DeclarationDescriptor containingDeclaration2 = this.f3000c.getContainingDeclaration();
    ...
    private final Annotations getAnnotations(MessageLite messageLite, int i, AnnotatedCallableKind annotatedCallableKind) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f3000c.getStorageManager(), new MemberDeserializer$getAnnotations$1(this, messageLite, annotatedCallableKind));
    }
    ...
    private final Annotations getPropertyFieldAnnotations(ProtoBuf.Property property, boolean z) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f3000c.getStorageManager(), new MemberDeserializer$getPropertyFieldAnnotations$1(this, z, property));
    }
    ...
    private final Annotations getReceiverParameterAnnotations(MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind) {
        return new DeserializedAnnotations(this.f3000c.getStorageManager(), new MemberDeserializer$getReceiverParameterAnnotations$1(this, messageLite, annotatedCallableKind));
    }
    ...
    private final java.util.List<kotlin.reflect.jvm.internal.impl.descriptors.ValueParameterDescriptor> valueParameters(java.util.List<kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf.ValueParameter> r27, kotlin.reflect.jvm.internal.impl.protobuf.MessageLite r28, kotlin.reflect.jvm.internal.impl.serialization.deserialization.AnnotatedCallableKind r29) {
        /*
            r26 = this;
            r8 = r26
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r0 = r8.f3000c
        ...
        L_0x0092:
            ...
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r1 = r8.f3000c
            ...
            kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializationContext r2 = r8.f3000c
    ...
    public final ProtoContainer asProtoContainer(@NotNull DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor instanceof PackageFragmentDescriptor) {
            return new ProtoContainer.Package(((PackageFragmentDescriptor) declarationDescriptor).getFqName(), this.f3000c.getNameResolver(), this.f3000c.getTypeTable(), this.f3000c.getContainerSource());
        }
