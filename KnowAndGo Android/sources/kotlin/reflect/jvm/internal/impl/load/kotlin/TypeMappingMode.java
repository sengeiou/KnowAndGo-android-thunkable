...
public final class TypeMappingMode {
    @NotNull
    @JvmField
    public static final TypeMappingMode CLASS_DECLARATION = new TypeMappingMode(false, true, false, false, false, GENERIC_ARGUMENT, false, (TypeMappingMode) null, (TypeMappingMode) null, 476, (DefaultConstructorMarker) null);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    @NotNull
    @JvmField
    public static final TypeMappingMode DEFAULT = new TypeMappingMode(false, false, false, false, false, GENERIC_ARGUMENT, false, (TypeMappingMode) null, (TypeMappingMode) null, 476, (DefaultConstructorMarker) null);
    @NotNull
    @JvmField
    public static final TypeMappingMode GENERIC_ARGUMENT = new TypeMappingMode(false, false, false, false, false, (TypeMappingMode) null, false, (TypeMappingMode) null, (TypeMappingMode) null, FrameMetricsAggregator.EVERY_DURATION, (DefaultConstructorMarker) null);
    @NotNull
    @JvmField
    public static final TypeMappingMode RETURN_TYPE_BOXED = new TypeMappingMode(false, true, false, false, false, (TypeMappingMode) null, false, (TypeMappingMode) null, (TypeMappingMode) null, 509, (DefaultConstructorMarker) null);
    @NotNull
    @JvmField
    public static final TypeMappingMode SUPER_TYPE = new TypeMappingMode(false, false, false, true, false, GENERIC_ARGUMENT, false, (TypeMappingMode) null, (TypeMappingMode) null, 471, (DefaultConstructorMarker) null);
    @NotNull
    @JvmField
    public static final TypeMappingMode SUPER_TYPE_KOTLIN_COLLECTIONS_AS_IS = new TypeMappingMode(false, false, false, true, false, GENERIC_ARGUMENT, false, (TypeMappingMode) null, (TypeMappingMode) null, 407, (DefaultConstructorMarker) null);
    @NotNull
    @JvmField
    public static final TypeMappingMode VALUE_FOR_ANNOTATION = new TypeMappingMode(false, false, true, false, false, new TypeMappingMode(false, false, true, false, false, GENERIC_ARGUMENT, false, (TypeMappingMode) null, (TypeMappingMode) null, 475, (DefaultConstructorMarker) null), false, (TypeMappingMode) null, (TypeMappingMode) null, 472, (DefaultConstructorMarker) null);
