...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f2983c;
    ...
    public LazyJavaClassDescriptor(@NotNull LazyJavaResolverContext lazyJavaResolverContext, @NotNull DeclarationDescriptor declarationDescriptor, @NotNull JavaClass javaClass, @Nullable ClassDescriptor classDescriptor) {
        ...
        this.f2983c = ContextKt.childForClassOrPackage$default(this.outerContext, this, this.jClass, 0, 4, (Object) null);
        ClassDescriptor classDescriptor2 = this;
        this.f2983c.getComponents().getJavaResolverCache().recordClass(this.jClass, classDescriptor2);
        boolean z = false;
        ...
        if (!_Assertions.ENABLED || z2) {
            ...
            this.unsubstitutedMemberScope = new LazyJavaClassMemberScope(this.f2983c, classDescriptor2, this.jClass);
            this.innerClassesScope = new InnerClassesScopeWrapper(getUnsubstitutedMemberScope());
            this.staticScope = new LazyJavaStaticClassScope(this.f2983c, this.jClass, this);
            this.annotations = LazyJavaAnnotationsKt.resolveAnnotations(this.f2983c, this.jClass);
            this.declaredParameters = this.f2983c.getStorageManager().createLazyValue(new LazyJavaClassDescriptor$declaredParameters$1(this));
            return;
        }
    ...
    private final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public LazyJavaClassTypeConstructor() {
            super(LazyJavaClassDescriptor.this.f2983c.getStorageManager());
            this.parameters = LazyJavaClassDescriptor.this.f2983c.getStorageManager().createLazyValue(new C3683xbaf55d8a(this));
        }
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                KotlinType transformJavaType = LazyJavaClassDescriptor.this.f2983c.getTypeResolver().transformJavaType(next, JavaTypeResolverKt.toAttributes$default(TypeUsage.SUPERTYPE, false, (TypeParameterDescriptor) null, 3, (Object) null));
            ...
            if (!arrayList2.isEmpty()) {
                ErrorReporter errorReporter = LazyJavaClassDescriptor.this.f2983c.getComponents().getErrorReporter();
            ...
            return collection.isEmpty() ^ true ? CollectionsKt.toList(arrayList) : CollectionsKt.listOf(LazyJavaClassDescriptor.this.f2983c.getModule().getBuiltIns().getAnyType());
        }
        ...
        private final kotlin.reflect.jvm.internal.impl.types.KotlinType getPurelyImplementedSupertype() {
            ...
            L_0x002d:
                ...
                kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor r4 = kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor.this
                kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r4 = r4.f2983c
        ...
        public SupertypeLoopChecker getSupertypeLoopChecker() {
            return LazyJavaClassDescriptor.this.f2983c.getComponents().getSupertypeLoopChecker();
        }
    ...
    public final LazyJavaClassDescriptor copy$descriptors_jvm(@NotNull JavaResolverCache javaResolverCache, @Nullable ClassDescriptor classDescriptor) {
        ...
        LazyJavaResolverContext replaceComponents = ContextKt.replaceComponents(this.f2983c, this.f2983c.getComponents().replace(javaResolverCache));
