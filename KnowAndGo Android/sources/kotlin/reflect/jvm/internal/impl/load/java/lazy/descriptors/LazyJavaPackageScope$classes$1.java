...
final class LazyJavaPackageScope$classes$1 extends Lambda implements Function1<LazyJavaPackageScope.FindClassRequest, ClassDescriptor> {
    ...
    /* renamed from: $c */
    final /* synthetic */ LazyJavaResolverContext f2987$c;
    ...
    LazyJavaPackageScope$classes$1(LazyJavaPackageScope lazyJavaPackageScope, LazyJavaResolverContext lazyJavaResolverContext) {
        ...
        this.f2987$c = lazyJavaResolverContext;
    }
    ...
    public final ClassDescriptor invoke(@NotNull LazyJavaPackageScope.FindClassRequest findClassRequest) {
        ...
        if (findClassRequest.getJavaClass() != null) {
            result = this.f2987$c.getComponents().getKotlinClassFinder().findKotlinClassOrContent(findClassRequest.getJavaClass());
        } else {
            result = this.f2987$c.getComponents().getKotlinClassFinder().findKotlinClassOrContent(classId);
        }
        ...
        if (access$resolveKotlinBinaryClass instanceof LazyJavaPackageScope.KotlinClassLookupResult.NotFound) {
            ...
            if (javaClass == null) {
                JavaClassFinder finder = this.f2987$c.getComponents().getFinder();
                if (result != null) {
            ...
            if ((javaClass2 != null ? javaClass2.getLightClassOriginKind() : null) != LightClassOriginKind.BINARY) {
                ...
                if (fqName == null || fqName.isRoot() || (!Intrinsics.areEqual((Object) fqName.parent(), (Object) this.this$0.getOwnerDescriptor().getFqName()))) {
                    ...
                    lazyJavaClassDescriptor = new LazyJavaClassDescriptor(this.f2987$c, this.this$0.getOwnerDescriptor(), javaClass2, (ClassDescriptor) null, 8, (DefaultConstructorMarker) null);
                    this.f2987$c.getComponents().getJavaClassesTracker().reportClass(lazyJavaClassDescriptor);
                }
                return lazyJavaClassDescriptor;
            }
            throw new IllegalStateException("Couldn't find kotlin binary class for light class created by kotlin binary file\n" + "JavaClass: " + javaClass2 + 10 + "ClassId: " + classId + 10 + "findKotlinClass(JavaClass) = " + KotlinClassFinderKt.findKotlinClass(this.f2987$c.getComponents().getKotlinClassFinder(), javaClass2) + 10 + "findKotlinClass(ClassId) = " + KotlinClassFinderKt.findKotlinClass(this.f2987$c.getComponents().getKotlinClassFinder(), classId) + 10);
        }
