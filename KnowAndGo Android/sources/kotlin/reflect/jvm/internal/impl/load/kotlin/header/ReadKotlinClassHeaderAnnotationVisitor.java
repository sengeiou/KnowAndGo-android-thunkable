...
public class ReadKotlinClassHeaderAnnotationVisitor implements KotlinJvmBinaryClass.AnnotationVisitor {
    ...
    public KotlinClassHeader createHeader() {
        ...
        return new KotlinClassHeader(this.headerKind, jvmMetadataVersion, this.bytecodeVersion != null ? this.bytecodeVersion : JvmBytecodeBinaryVersion.INVALID_VERSION, this.data, this.incompatibleData, this.strings, this.extraString, this.extraInt, this.packageName);
    }
