...
public class JvmBuiltInsSettings implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    private final SimpleType getCloneableType() {
        return (SimpleType) StorageKt.getValue(this.cloneableType$delegate, (Object) this, (KProperty<?>) $$delegatedProperties[2]);
    }

    private final Annotations getNotConsideredDeprecation() {
        return (Annotations) StorageKt.getValue(this.notConsideredDeprecation$delegate, (Object) this, (KProperty<?>) $$delegatedProperties[3]);
    }
    ...
    private final KotlinType createMockJavaIoSerializableType(@NotNull StorageManager storageManager) {
        ClassDescriptorImpl classDescriptorImpl = new ClassDescriptorImpl(new C3635xaea9d104(this, this.moduleDescriptor, new FqName("java.io")), Name.identifier("Serializable"), Modality.ABSTRACT, ClassKind.INTERFACE, CollectionsKt.listOf(new LazyWrappedType(storageManager, new C3636xf01ceaf8(this))), SourceElement.NO_SOURCE, false, storageManager);
    ...
    private final Collection<SimpleFunctionDescriptor> getAdditionalFunctions(ClassDescriptor classDescriptor, Function1<? super MemberScope, ? extends Collection<? extends SimpleFunctionDescriptor>> function1) {
        ...
        MemberScope unsubstitutedMemberScope = this.javaAnalogueClassesWithCustomSupertypeCache.computeIfAbsent(DescriptorUtilsKt.getFqNameSafe(declarationDescriptor), new C3637x1b86dd87(javaAnalogue, classDescriptor2)).getUnsubstitutedMemberScope();
    ...
    public java.util.Collection<kotlin.reflect.jvm.internal.impl.descriptors.ClassConstructorDescriptor> getConstructors(@org.jetbrains.annotations.NotNull kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor r18) {
        ...
        L_0x0095:
            ...
            boolean r14 = r6.invoke((kotlin.reflect.jvm.internal.impl.descriptors.ConstructorDescriptor) r15, (kotlin.reflect.jvm.internal.impl.descriptors.ConstructorDescriptor) r14)
        ...
        L_0x00b2:
            ...
            java.lang.String r9 = r14.signature((kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor) r4, (java.lang.String) r9)
        ...
        L_0x00fb:
            ...
            java.lang.String r6 = r12.signature((kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor) r4, (java.lang.String) r6)
