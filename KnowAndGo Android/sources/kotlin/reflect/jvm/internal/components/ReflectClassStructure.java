...
final class ReflectClassStructure {
    ...
    private final ClassLiteralValue classLiteralValue(@NotNull Class<?> cls) {
        int i = 0;
        while (cls.isArray()) {
            i++;
