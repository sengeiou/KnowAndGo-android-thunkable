...
class AlertController {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        View findViewById2 = this.mWindow.findViewById(C0064R.C0067id.scrollIndicatorDown);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0064R.C0067id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0064R.C0067id.scrollView);
