...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0064R.C0067id.search_src_text);
        ...
        this.mVoiceWebSearchIntent.addFlags(C1470C.ENCODING_PCM_MU_LAW);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(C1470C.ENCODING_PCM_MU_LAW);
