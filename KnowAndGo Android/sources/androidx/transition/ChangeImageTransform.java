...
public class ChangeImageTransform extends Transition {
    ...
    private static Matrix copyImageMatrix(@NonNull ImageView imageView) {
        ...
        if (drawable.getIntrinsicWidth() > 0 && drawable.getIntrinsicHeight() > 0) {
            switch (C04993.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C04993 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C04993.<clinit>():void");
        }
    }
