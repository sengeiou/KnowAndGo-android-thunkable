...
public class Explode extends Visibility {
    ...
    public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        return TranslationAnimationCreator.createAnimation(view, transitionValues2, rect.left, rect.top, translationX + ((float) this.mTempLoc[0]), translationY + ((float) this.mTempLoc[1]), translationX, translationY, sDecelerate, this);
    }
    ...
    public Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        float translationX = view.getTranslationX();
        float translationY = view.getTranslationY();
        int[] iArr = (int[]) transitionValues.view.getTag(C0510R.C0513id.transition_position);
        if (iArr != null) {
        ...
        calculateOut(viewGroup, rect, this.mTempLoc);
        return TranslationAnimationCreator.createAnimation(view, transitionValues, i, i2, translationX, translationY, f2 + ((float) this.mTempLoc[0]), f + ((float) this.mTempLoc[1]), sAccelerate, this);
    }
