...
public abstract class FragmentTransaction {
    ...
    static final class C0297Op {
        ...
        C0297Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0297Op(int i, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    private Fragment createFragment(@NonNull Class<? extends Fragment> cls, @Nullable Bundle bundle) {
        if (this.mFragmentFactory == null) {
            ...
            Fragment instantiate = this.mFragmentFactory.instantiate(this.mClassLoader, cls.getName());
            if (bundle != null) {
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        addOp(new C0297Op(3, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C0297Op(4, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction show(@NonNull Fragment fragment) {
        addOp(new C0297Op(5, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        addOp(new C0297Op(6, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction attach(@NonNull Fragment fragment) {
        addOp(new C0297Op(7, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0297Op(8, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C0297Op(10, fragment, state));
        return this;
    }
