...
class FragmentTransition {
    ...
    private static void configureTransitionsReordered(androidx.fragment.app.FragmentManager r19, int r20, androidx.fragment.app.FragmentTransition.FragmentContainerTransition r21, android.view.View r22, androidx.collection.ArrayMap<java.lang.String, java.lang.String> r23, androidx.fragment.app.FragmentTransition.Callback r24) {
        /*
            r0 = r19
            r4 = r21
            r9 = r22
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            addToFirstInLastOut(backStackRecord, (FragmentTransaction.C0297Op) backStackRecord.mOps.get(i), sparseArray, false, z);
        }
    }
    ...
    public static void calculatePopFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        if (backStackRecord.mManager.mContainer.onHasView()) {
            for (int size = backStackRecord.mOps.size() - 1; size >= 0; size--) {
                addToFirstInLastOut(backStackRecord, (FragmentTransaction.C0297Op) backStackRecord.mOps.get(size), sparseArray, true, z);
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x002d, code lost:
        if (r0.mAdded != false) goto L_0x0082;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:54:0x0080, code lost:
        if (r0.mHidden == false) goto L_0x0082;
     */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void addToFirstInLastOut(androidx.fragment.app.BackStackRecord r8, androidx.fragment.app.FragmentTransaction.C0297Op r9, android.util.SparseArray<androidx.fragment.app.FragmentTransition.FragmentContainerTransition> r10, boolean r11, boolean r12) {
        /*
