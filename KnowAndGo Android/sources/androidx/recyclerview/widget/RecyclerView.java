...
import androidx.recyclerview.C0388R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public void onScrolled(@C0063Px int i, @C0063Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0388R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0388R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0388R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i, 0);
        }
        String string = obtainStyledAttributes.getString(C0388R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0388R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0388R.styleable.RecyclerView_android_clipToPadding, true);
        this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0388R.styleable.RecyclerView_fastScrollEnabled, false);
        if (this.mEnableFastScroller) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0388R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0388R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0388R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0388R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
    ...
    public boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            ...
            scrollStep(i7, i8, this.mReusableIntPair);
        ...
        this.mReusableIntPair[0] = 0;
        this.mReusableIntPair[1] = 0;
        dispatchNestedScroll(i6, i5, i4, i3, this.mScrollOffset, 0, this.mReusableIntPair);
        int i11 = i4 - this.mReusableIntPair[0];
        int i12 = i3 - this.mReusableIntPair[1];
    ...
    public void smoothScrollBy(@C0063Px int i, @C0063Px int i2) {
        smoothScrollBy(i, i2, (Interpolator) null);
    }

    public void smoothScrollBy(@C0063Px int i, @C0063Px int i2, @Nullable Interpolator interpolator) {
        smoothScrollBy(i, i2, interpolator, Integer.MIN_VALUE);
    }

    public void smoothScrollBy(@C0063Px int i, @C0063Px int i2, @Nullable Interpolator interpolator, int i3) {
        smoothScrollBy(i, i2, interpolator, i3, false);
    }

    /* access modifiers changed from: package-private */
    public void smoothScrollBy(@C0063Px int i, @C0063Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        if (this.mLayout == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutSuppressed) {
            int i4 = 0;
    ...
    public void offsetChildrenVertical(@C0063Px int i) {
        int childCount = this.mChildHelper.getChildCount();
    ...
    public void offsetChildrenHorizontal(@C0063Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.dispatchNestedPreScroll(i3, i4, RecyclerView.this.mReusableIntPair, (int[]) null, 1)) {
                ...
                RecyclerView.this.mReusableIntPair[0] = 0;
                RecyclerView.this.mReusableIntPair[1] = 0;
                RecyclerView.this.dispatchNestedScroll(i2, i, i3, i4, (int[]) null, 1, RecyclerView.this.mReusableIntPair);
    ...
    public static abstract class LayoutManager {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:25:0x0079 A[ADDED_TO_REGION] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean performAccessibilityAction(@androidx.annotation.NonNull androidx.recyclerview.widget.RecyclerView.Recycler r7, @androidx.annotation.NonNull androidx.recyclerview.widget.RecyclerView.State r8, int r9, @androidx.annotation.Nullable android.os.Bundle r10) {
            /*
                r6 = this;
            ...
            L_0x0012:
                androidx.recyclerview.widget.RecyclerView r7 = r6.mRecyclerView
                r9 = -1
                boolean r7 = r7.canScrollVertically(r9)
            ...
            L_0x002c:
                ...
                boolean r9 = r0.canScrollHorizontally(r9)
            ...
            L_0x0044:
                androidx.recyclerview.widget.RecyclerView r7 = r6.mRecyclerView
                boolean r7 = r7.canScrollVertically(r10)
            ...
            L_0x005c:
                ...
                boolean r9 = r9.canScrollHorizontally(r10)
                if (r9 == 0) goto L_0x0075
                int r9 = r6.getWidth()
                int r0 = r6.getPaddingLeft()
                int r9 = r9 - r0
    ...
    public static abstract class SmoothScroller {
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0063Px int i, @C0063Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public static class Action {
            ...
            public Action(@C0063Px int i, @C0063Px int i2) {
                this(i, i2, Integer.MIN_VALUE, (Interpolator) null);
            }

            public Action(@C0063Px int i, @C0063Px int i2, int i3) {
                this(i, i2, i3, (Interpolator) null);
            }

            public Action(@C0063Px int i, @C0063Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0063Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@C0063Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0063Px int i, @C0063Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
