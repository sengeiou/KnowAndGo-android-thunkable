...
public class AnimationUtilsCompat {
    ...
    public static android.view.animation.Interpolator loadInterpolator(android.content.Context r4, int r5) throws android.content.res.Resources.NotFoundException {
        ...
        L_0x000b:
            ...
            androidx.interpolator.view.animation.FastOutLinearInInterpolator r4 = new androidx.interpolator.view.animation.FastOutLinearInInterpolator     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
        ...
        L_0x001e:
            ...
            androidx.interpolator.view.animation.FastOutSlowInInterpolator r4 = new androidx.interpolator.view.animation.FastOutSlowInInterpolator     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
            return r4
        L_0x0029:
            r1 = 17563662(0x10c000e, float:2.5713978E-38)
            if (r5 != r1) goto L_0x0034
            androidx.interpolator.view.animation.LinearOutSlowInInterpolator r4 = new androidx.interpolator.view.animation.LinearOutSlowInInterpolator     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
            return r4
        L_0x0034:
        ...
        L_0x0098:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.AnimationUtilsCompat.loadInterpolator(android.content.Context, int):android.view.animation.Interpolator");
    }
