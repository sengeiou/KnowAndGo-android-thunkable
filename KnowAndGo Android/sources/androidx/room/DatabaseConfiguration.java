...
public class DatabaseConfiguration {
    ...
    public boolean isMigrationRequired(int i, int i2) {
        if ((!(i > i2) || !this.allowDestructiveMigrationOnDowngrade) && this.requireMigration && (this.mMigrationNotRequiredFrom == null || !this.mMigrationNotRequiredFrom.contains(Integer.valueOf(i)))) {
            return true;
        }
        return false;
    }
