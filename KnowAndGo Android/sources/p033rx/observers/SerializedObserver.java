...
public class SerializedObserver<T> implements Observer<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x004b, code lost:
        if (p033rx.internal.operators.NotificationLite.accept(r6.actual, r4) == false) goto L_0x0050;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x0054, code lost:
        ...
        r6.actual.onError(p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r7));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x0067, code lost:
        r6.terminated = true;
        p033rx.exceptions.Exceptions.throwOrReport(r1, (p033rx.Observer<?>) r6.actual, (java.lang.Object) r7);
     */
    ...
    public void onNext(T r7) {
        ...
        L_0x001b:
            java.lang.Object r7 = p033rx.internal.operators.NotificationLite.next(r7)     // Catch:{ all -> 0x006f }
        ...
        L_0x0045:
            ...
            boolean r4 = p033rx.internal.operators.NotificationLite.accept(r5, r4)     // Catch:{ Throwable -> 0x0053 }
        ...
        L_0x0053:
            ...
            java.lang.Throwable r7 = p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r7)
            r0.onError(r7)
            return
        L_0x0063:
            r7 = move-exception
        ...
        L_0x0066:
            ...
            r6.terminated = r0
            rx.Observer<? super T> r0 = r6.actual
            p033rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r1, (p033rx.Observer<?>) r0, (java.lang.Object) r7)
            return
        L_0x006f:
            r7 = move-exception
            monitor-exit(r6)     // Catch:{ all -> 0x006f }
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: p033rx.observers.SerializedObserver.onNext(java.lang.Object):void");
    }
