...
import p033rx.internal.producers.SingleProducer;
import p033rx.internal.schedulers.EventLoopsScheduler;
...
public final class ScalarSynchronousObservable<T> extends Observable<T> {
    ...
    public Observable<T> scalarScheduleOn(final Scheduler scheduler) {
        ...
        return unsafeCreate(new ScalarAsyncOnSubscribe(this.f3075t, func1));
    }
    ...
    public <R> Observable<R> scalarFlatMap(final Func1<? super T, ? extends Observable<? extends R>> func1) {
        return unsafeCreate(new Observable.OnSubscribe<R>() {
            public void call(Subscriber<? super R> subscriber) {
                Observable observable = (Observable) func1.call(ScalarSynchronousObservable.this.f3075t);
                if (observable instanceof ScalarSynchronousObservable) {
                    subscriber.setProducer(ScalarSynchronousObservable.createProducer(subscriber, ((ScalarSynchronousObservable) observable).f3075t));
                } else {
