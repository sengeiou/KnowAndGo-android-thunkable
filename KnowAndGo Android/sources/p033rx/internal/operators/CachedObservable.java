...
import p033rx.internal.util.LinkedArrayList;
...
public final class CachedObservable<T> extends Observable<T> {
    ...
    static final class ReplayProducer<T> extends AtomicLong implements Producer, Subscription {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x003d, code lost:
            if (p033rx.internal.operators.NotificationLite.isCompleted(r3) == false) goto L_0x004b;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x004f, code lost:
            if (p033rx.internal.operators.NotificationLite.isError(r3) == false) goto L_0x00c1;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:33:0x0051, code lost:
            r2.onError(p033rx.internal.operators.NotificationLite.getError(r3));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:51:0x007b, code lost:
            if (p033rx.internal.operators.NotificationLite.accept(r2, r13) == false) goto L_0x0084;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:61:?, code lost:
            p033rx.exceptions.Exceptions.throwIfFatal(r3);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:63:?, code lost:
            unsubscribe();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:64:0x009a, code lost:
            if (p033rx.internal.operators.NotificationLite.isError(r13) != false) goto L_?;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:67:0x00a2, code lost:
            r2.onError(p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r3, p033rx.internal.operators.NotificationLite.getValue(r13)));
         */
        ...
        public void replay() {
            ...
            L_0x002f:
                ...
                boolean r4 = p033rx.internal.operators.NotificationLite.isCompleted(r3)     // Catch:{ all -> 0x00d9 }
            ...
            L_0x0046:
                ...
                goto L_0x00db
            L_0x004b:
                boolean r4 = p033rx.internal.operators.NotificationLite.isError(r3)     // Catch:{ all -> 0x00d9 }
                if (r4 == 0) goto L_0x00c1
                java.lang.Throwable r3 = p033rx.internal.operators.NotificationLite.getError(r3)     // Catch:{ all -> 0x00d9 }
            ...
            L_0x0075:
                ...
                boolean r14 = p033rx.internal.operators.NotificationLite.accept(r2, r13)     // Catch:{ Throwable -> 0x008e }
                if (r14 == 0) goto L_0x0084
                r15.unsubscribe()     // Catch:{ Throwable -> 0x0081 }
                return
            L_0x0081:
                r3 = move-exception
                r4 = 1
            ...
            L_0x008e:
                ...
                r4 = 0
            L_0x0090:
                p033rx.exceptions.Exceptions.throwIfFatal(r3)     // Catch:{ all -> 0x00ae }
                r15.unsubscribe()     // Catch:{ all -> 0x0046 }
                boolean r4 = p033rx.internal.operators.NotificationLite.isError(r13)     // Catch:{ all -> 0x0046 }
                if (r4 != 0) goto L_0x00ad
                boolean r4 = p033rx.internal.operators.NotificationLite.isCompleted(r13)     // Catch:{ all -> 0x0046 }
                if (r4 != 0) goto L_0x00ad
                java.lang.Object r4 = p033rx.internal.operators.NotificationLite.getValue(r13)     // Catch:{ all -> 0x0046 }
                java.lang.Throwable r3 = p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r3, r4)     // Catch:{ all -> 0x0046 }
            ...
            L_0x00e6:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.CachedObservable.ReplayProducer.replay():void");
        }
    }
}
