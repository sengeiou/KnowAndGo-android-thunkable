...
import p033rx.subjects.Subject;
...
public final class OperatorMulticast<T, R> extends ConnectableObservable<R> {
    ...
    public void connect(p033rx.functions.Action1<? super p033rx.Subscription> r6) {
        /*
            r5 = this;
        ...
        L_0x000e:
            ...
            rx.subjects.Subject r1 = (p033rx.subjects.Subject) r1     // Catch:{ all -> 0x0071 }
            rx.Subscriber r2 = p033rx.observers.Subscribers.from(r1)     // Catch:{ all -> 0x0071 }
            ...
            rx.Subscription r3 = p033rx.subscriptions.Subscriptions.create(r3)     // Catch:{ all -> 0x0071 }
            r2.set(r3)     // Catch:{ all -> 0x0071 }
            java.lang.Object r2 = r2.get()     // Catch:{ all -> 0x0071 }
            rx.Subscription r2 = (p033rx.Subscription) r2     // Catch:{ all -> 0x0071 }
        ...
        L_0x003b:
            ...
            rx.Subscriber r3 = (p033rx.Subscriber) r3     // Catch:{ all -> 0x0071 }
        ...
        L_0x0071:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorMulticast.connect(rx.functions.Action1):void");
    }
}
