...
import p033rx.internal.util.OpenHashSet;
...
public final class OperatorReplay<T> extends ConnectableObservable<T> implements Subscription {
    ...
    static <T> ConnectableObservable<T> create(Observable<? extends T> observable, final Func0<? extends ReplayBuffer<T>> func0) {
        ...
        return new OperatorReplay(new Observable.OnSubscribe<T>() {
            ...
            public void call(p033rx.Subscriber<? super T> r4) {
                /*
                    r3 = this;
                L_0x0000:
                    java.util.concurrent.atomic.AtomicReference r0 = r0
                    java.lang.Object r0 = r0.get()
                    rx.internal.operators.OperatorReplay$ReplaySubscriber r0 = (p033rx.internal.operators.OperatorReplay.ReplaySubscriber) r0
                    ...
                    rx.internal.operators.OperatorReplay$ReplayBuffer r2 = (p033rx.internal.operators.OperatorReplay.ReplayBuffer) r2
                    r1.<init>(r2)
                    r1.init()
                ...
                L_0x0024:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorReplay.C42257.call(rx.Subscriber):void");
            }
    ...
    public void connect(p033rx.functions.Action1<? super p033rx.Subscription> r5) {
        ...
        L_0x0048:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorReplay.connect(rx.functions.Action1):void");
    }
    ...
    static final class ReplaySubscriber<T> extends Subscriber<T> implements Subscription {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void manageRequests(p033rx.internal.operators.OperatorReplay.InnerProducer<T> r10) {
            /*
                r9 = this;
            ...
            L_0x007a:
                ...
                rx.internal.operators.OperatorReplay$InnerProducer r1 = (p033rx.internal.operators.OperatorReplay.InnerProducer) r1
            ...
            L_0x00b4:
                ...
                throw r10
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorReplay.ReplaySubscriber.manageRequests(rx.internal.operators.OperatorReplay$InnerProducer):void");
        }
    ...
    static final class UnboundedReplayBuffer<T> extends ArrayList<Object> implements ReplayBuffer<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:26:0x003f, code lost:
            if (p033rx.internal.operators.NotificationLite.accept(r3, r10) == false) goto L_0x0042;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:34:0x005a, code lost:
            if (p033rx.internal.operators.NotificationLite.isError(r10) != false) goto L_?;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:37:0x0062, code lost:
            r3.onError(p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r0, p033rx.internal.operators.NotificationLite.getValue(r10)));
         */
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void replay(p033rx.internal.operators.OperatorReplay.InnerProducer<T> r13) {
            /*
                r12 = this;
                monitor-enter(r13)
            ...
            L_0x0031:
                ...
                boolean r11 = p033rx.internal.operators.NotificationLite.accept(r3, r10)     // Catch:{ Throwable -> 0x004f }
            ...
            L_0x004f:
                ...
                p033rx.exceptions.Exceptions.throwIfFatal(r0)
                r13.unsubscribe()
                boolean r13 = p033rx.internal.operators.NotificationLite.isError(r10)
                if (r13 != 0) goto L_0x006d
                boolean r13 = p033rx.internal.operators.NotificationLite.isCompleted(r10)
                if (r13 != 0) goto L_0x006d
                java.lang.Object r13 = p033rx.internal.operators.NotificationLite.getValue(r10)
                java.lang.Throwable r13 = p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r0, r13)
                r3.onError(r13)
            L_0x006d:
                return
            L_0x006e:
            ...
            L_0x0095:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorReplay.UnboundedReplayBuffer.replay(rx.internal.operators.OperatorReplay$InnerProducer):void");
        }
    }
    ...
    static class BoundedReplayBuffer<T> extends AtomicReference<Node> implements ReplayBuffer<T> {
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x0014, code lost:
            r0 = (p033rx.internal.operators.OperatorReplay.Node) r12.index();
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:24:0x003e, code lost:
            r8 = (p033rx.internal.operators.OperatorReplay.Node) r0.get();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:25:0x0044, code lost:
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:29:0x0051, code lost:
            if (p033rx.internal.operators.NotificationLite.accept(r1, r0) == false) goto L_0x0056;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:37:0x0063, code lost:
            r12.index = null;
            p033rx.exceptions.Exceptions.throwIfFatal(r2);
            r12.unsubscribe();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:38:0x006f, code lost:
            if (p033rx.internal.operators.NotificationLite.isError(r0) != false) goto L_?;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:41:0x0077, code lost:
            r1.onError(p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r2, p033rx.internal.operators.NotificationLite.getValue(r0)));
         */
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final void replay(p033rx.internal.operators.OperatorReplay.InnerProducer<T> r12) {
            /*
                r11 = this;
                monitor-enter(r12)
            ...
            L_0x0014:
                ...
                rx.internal.operators.OperatorReplay$Node r0 = (p033rx.internal.operators.OperatorReplay.Node) r0
            ...
            L_0x003a:
                ...
                rx.internal.operators.OperatorReplay$Node r8 = (p033rx.internal.operators.OperatorReplay.Node) r8
                if (r8 == 0) goto L_0x0083
                java.lang.Object r0 = r8.value
                java.lang.Object r0 = r11.leaveTransform(r0)
                r9 = 0
                boolean r10 = p033rx.internal.operators.NotificationLite.accept(r1, r0)     // Catch:{ Throwable -> 0x0062 }
            ...
            L_0x0062:
                ...
                p033rx.exceptions.Exceptions.throwIfFatal(r2)
                r12.unsubscribe()
                boolean r12 = p033rx.internal.operators.NotificationLite.isError(r0)
                if (r12 != 0) goto L_0x0082
                boolean r12 = p033rx.internal.operators.NotificationLite.isCompleted(r0)
                if (r12 != 0) goto L_0x0082
                java.lang.Object r12 = p033rx.internal.operators.NotificationLite.getValue(r0)
                java.lang.Throwable r12 = p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r2, r12)
                r1.onError(r12)
            L_0x0082:
                return
            L_0x0083:
            ...
            L_0x00a7:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorReplay.BoundedReplayBuffer.replay(rx.internal.operators.OperatorReplay$InnerProducer):void");
        }
    ...
    static final class SizeAndTimeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        public void truncateFinal() {
            /*
                ...
                rx.internal.operators.OperatorReplay$Node r2 = (p033rx.internal.operators.OperatorReplay.Node) r2
                java.lang.Object r3 = r2.get()
                rx.internal.operators.OperatorReplay$Node r3 = (p033rx.internal.operators.OperatorReplay.Node) r3
                r4 = 0
            L_0x0016:
                r9 = r3
                r3 = r2
                ...
                rx.schedulers.Timestamped r5 = (p033rx.schedulers.Timestamped) r5
            ...
            L_0x003f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorReplay.SizeAndTimeBoundReplayBuffer.truncateFinal():void");
        }
    }
}
