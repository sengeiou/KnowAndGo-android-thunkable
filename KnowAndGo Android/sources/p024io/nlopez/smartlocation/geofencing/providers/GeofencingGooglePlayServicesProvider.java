package p024io.nlopez.smartlocation.geofencing.providers;
...
import p024io.nlopez.smartlocation.geofencing.GeofencingStore;
import p024io.nlopez.smartlocation.geofencing.model.GeofenceModel;
import p024io.nlopez.smartlocation.geofencing.utils.TransitionGeofence;
...
public class GeofencingGooglePlayServicesProvider implements GeofencingProvider, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<Status> {
        ...
        this.geofencingReceiver = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                if (GeofencingGooglePlayServicesProvider.BROADCAST_INTENT_ACTION.equals(intent.getAction()) && intent.hasExtra(GeofencingGooglePlayServicesProvider.GEOFENCES_EXTRA_ID)) {
                    GeofencingGooglePlayServicesProvider.this.logger.mo39738d("Received geofencing event", new Object[0]);
                    ...
                    for (String next : intent.getStringArrayListExtra(GeofencingGooglePlayServicesProvider.GEOFENCES_EXTRA_ID)) {
                        ...
                        if (geofenceModel != null) {
                            ...
                            access$000.mo39746w("Tried to retrieve geofence " + next + " but it was not in the store", new Object[0]);
                        }
                    }
                }
            }
    ...
    public void onResult(@NonNull Status status) {
        if (status.isSuccess()) {
            this.logger.mo39738d("Geofencing update request successful", new Object[0]);
            ...
            this.logger.mo39746w("Unable to register, but we can solve this - will startActivityForResult expecting result code 10003 (if received, please try again)", new Object[0]);
            try {
