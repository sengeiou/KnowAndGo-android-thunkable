package p024io.nlopez.smartlocation.activity;
...
import p024io.nlopez.smartlocation.common.Store;
...
public class ActivityStore implements Store<DetectedActivity> {
    ...
    public DetectedActivity get(String str) {
        if (this.preferences == null || !this.preferences.contains(getFieldKey(str, ACTIVITY_ID)) || !this.preferences.contains(getFieldKey(str, CONFIDENCE_ID))) {
            return null;
        }
