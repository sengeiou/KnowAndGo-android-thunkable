...
public final class C2603xd84c18d9 implements Factory<Scheduler> {
    private final Provider<ExecutorService> serviceProvider;

    public C2603xd84c18d9(Provider<ExecutorService> provider) {
    ...
    public static C2603xd84c18d9 create(Provider<ExecutorService> provider) {
        return new C2603xd84c18d9(provider);
    }
