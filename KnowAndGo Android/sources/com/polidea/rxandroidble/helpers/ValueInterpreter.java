...
public class ValueInterpreter {
    ...
    public static Integer getIntValue(@NonNull byte[] bArr, int i, @IntRange(from = 0) int i2) {
        if (getTypeLen(i) + i2 > bArr.length) {
            RxBleLog.m1092w("Int formatType (0x%x) is longer than remaining bytes (%d) - returning null", Integer.valueOf(i), Integer.valueOf(bArr.length - i2));
            return null;
        }
        switch (i) {
            case 17:
            ...
            default:
                RxBleLog.m1092w("Passed an invalid integer formatType (0x%x) - returning null", Integer.valueOf(i));
                return null;
        }
    }
    ...
    public static Float getFloatValue(@NonNull byte[] bArr, int i, @IntRange(from = 0) int i2) {
        if (getTypeLen(i) + i2 > bArr.length) {
            RxBleLog.m1092w("Float formatType (0x%x) is longer than remaining bytes (%d) - returning null", Integer.valueOf(i), Integer.valueOf(bArr.length - i2));
            return null;
        } else if (i == 50) {
            ...
            RxBleLog.m1092w("Passed an invalid float formatType (0x%x) - returning null", Integer.valueOf(i));
            return null;
        }
    }
    ...
    public static String getStringValue(@NonNull byte[] bArr, @IntRange(from = 0) int i) {
        if (i > bArr.length) {
            RxBleLog.m1092w("Passed offset that exceeds the length of the byte array - returning null", new Object[0]);
            return null;
        }
