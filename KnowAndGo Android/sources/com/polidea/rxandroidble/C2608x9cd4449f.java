...
public final class C2608x9cd4449f implements Factory<LocationServicesStatus> {
    ...
    public C2608x9cd4449f(ClientComponent.ClientModule clientModule, Provider<Integer> provider, Provider<LocationServicesStatusApi18> provider2, Provider<LocationServicesStatusApi23> provider3) {
    ...
    public static C2608x9cd4449f create(ClientComponent.ClientModule clientModule, Provider<Integer> provider, Provider<LocationServicesStatusApi18> provider2, Provider<LocationServicesStatusApi23> provider3) {
        return new C2608x9cd4449f(clientModule, provider, provider2, provider3);
    }
