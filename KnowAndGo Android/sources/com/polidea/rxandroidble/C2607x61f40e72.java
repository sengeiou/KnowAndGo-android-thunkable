...
public final class C2607x61f40e72 implements Factory<Observable<Boolean>> {
    ...
    public C2607x61f40e72(ClientComponent.ClientModule clientModule, Provider<Integer> provider, Provider<LocationServicesOkObservableApi23> provider2) {
    ...
    public static C2607x61f40e72 create(ClientComponent.ClientModule clientModule, Provider<Integer> provider, Provider<LocationServicesOkObservableApi23> provider2) {
        return new C2607x61f40e72(clientModule, provider, provider2);
    }
    ...
    public static p033rx.Observable<java.lang.Boolean> proxyProvideLocationServicesOkObservable(com.polidea.rxandroidble.ClientComponent.ClientModule r0, int r1, bleshadow.javax.inject.Provider<com.polidea.rxandroidble.internal.util.LocationServicesOkObservableApi23> r2) {
        /*
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.polidea.rxandroidble.C2607x61f40e72.proxyProvideLocationServicesOkObservable(com.polidea.rxandroidble.ClientComponent$ClientModule, int, bleshadow.javax.inject.Provider):rx.Observable");
    }
}
