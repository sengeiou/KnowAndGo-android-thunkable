...
public class RxBleConnectionImpl implements RxBleConnection {
    ...
    public Observable<RxBleDeviceServices> discoverServices(long j, @NonNull TimeUnit timeUnit) {
    ...
    public Observable<byte[]> readDescriptor(@NonNull final UUID uuid, @NonNull final UUID uuid2, @NonNull final UUID uuid3) {
    ...
    public Observable<byte[]> readDescriptor(@NonNull BluetoothGattDescriptor bluetoothGattDescriptor) {
    ...
    public Observable<byte[]> writeDescriptor(@NonNull final UUID uuid, @NonNull final UUID uuid2, @NonNull final UUID uuid3, @NonNull final byte[] bArr) {
        return discoverServices().flatMap(new Func1<RxBleDeviceServices, Observable<BluetoothGattDescriptor>>() {
            public Observable<BluetoothGattDescriptor> call(RxBleDeviceServices rxBleDeviceServices) {
                return rxBleDeviceServices.getDescriptor(uuid, uuid2, uuid3);
            }
    ...
    public Observable<byte[]> writeDescriptor(@NonNull BluetoothGattDescriptor bluetoothGattDescriptor, @NonNull byte[] bArr) {
    ...
    public <T> Observable<T> queue(@NonNull final RxBleCustomOperation<T> rxBleCustomOperation) {
