...
public class ClientStateObservable extends Observable<RxBleClient.State> {
    ...
    protected ClientStateObservable(com.polidea.rxandroidble.internal.util.RxBleAdapterWrapper r9, p033rx.Observable<com.polidea.rxandroidble.RxBleAdapterStateObservable.BleAdapterState> r10, @bleshadow.javax.inject.Named("location-ok-boolean-observable") p033rx.Observable<java.lang.Boolean> r11, com.polidea.rxandroidble.internal.util.LocationServicesStatus r12, @bleshadow.javax.inject.Named("timeout") p033rx.Scheduler r13) {
        /*
            r8 = this;
            ...
            r6 = r11
            r1.<init>(r3, r4, r5, r6)
            rx.Emitter$BackpressureMode r9 = p033rx.Emitter.BackpressureMode.LATEST
            r0.<init>(r7, r9)
            r8.<init>(r0)
            return
        */
