...
public class RxBleServicesLogger {
    ...
    public void log(RxBleDeviceServices rxBleDeviceServices, BluetoothDevice bluetoothDevice) {
        if (RxBleLog.isAtLeast(2)) {
            RxBleLog.m1090v("Preparing services description", new Object[0]);
            RxBleLog.m1090v(prepareServicesDescription(rxBleDeviceServices, bluetoothDevice), new Object[0]);
        }
    }
