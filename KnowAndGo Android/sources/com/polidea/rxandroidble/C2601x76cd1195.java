...
public final class C2601x76cd1195 implements Factory<Scheduler> {
    private final Provider<ExecutorService> serviceProvider;

    public C2601x76cd1195(Provider<ExecutorService> provider) {
    ...
    public static C2601x76cd1195 create(Provider<ExecutorService> provider) {
        return new C2601x76cd1195(provider);
    }
