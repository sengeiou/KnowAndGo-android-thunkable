...
public class IdGeneratorKey {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f1092id == idGeneratorKey.f1092id && this.deviceAddress.equals(idGeneratorKey.deviceAddress)) {
    ...
    public int hashCode() {
        return (((this.deviceAddress.hashCode() * 31) + this.uuid.hashCode()) * 31) + this.f1092id;
    }
}
