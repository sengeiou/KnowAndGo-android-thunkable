...
class NetworkCallbackConnectivityReceiver extends ConnectivityReceiver {
    ...
    public void updateAndSend() {
        ...
        if (this.mNetworkCapabilities != null) {
            if (this.mNetworkCapabilities.hasTransport(2)) {
    ...
    private class ConnectivityNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            ...
            NetworkCallbackConnectivityReceiver.this.mNetworkCapabilities = NetworkCallbackConnectivityReceiver.this.getConnectivityManager().getNetworkCapabilities(network);
