            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (access$000 != null) {
                    ...
                    if (!RNDeviceModule.this.mLastBatteryState.equalsIgnoreCase(string) || RNDeviceModule.this.mLastPowerSaveState != valueOf2.booleanValue()) {
                        RNDeviceModule.this.sendEvent(RNDeviceModule.this.getReactApplicationContext(), "RNDeviceInfo_powerStateDidChange", string);
                    ...
                    if (RNDeviceModule.this.mLastBatteryLevel != valueOf.doubleValue()) {
                        RNDeviceModule.this.sendEvent(RNDeviceModule.this.getReactApplicationContext(), "RNDeviceInfo_batteryLevelDidChange", valueOf);
                        if (valueOf.doubleValue() <= 0.15d) {
                            RNDeviceModule.this.sendEvent(RNDeviceModule.this.getReactApplicationContext(), "RNDeviceInfo_batteryLevelIsLow", valueOf);
                        }
                    ...
                    if (t.getName().equalsIgnoreCase("wlan0")) {
                        ...
                        if (hardwareAddress == null) {
                            ...
                            for (int i = 0; i < length; i++) {
                                sb2.append(String.format("%02X:", new Object[]{Byte.valueOf(hardwareAddress[i])}));
                            }
                            if (sb2.length() > 0) {
