    ...
    public void execute(Runnable runnable) {
        if (runnable == null) {
            ...
            if (size > i && this.mMaxQueueSize.compareAndSet(i, size)) {
                FLog.m84v(TAG, "%s: max pending work in queue = %d", (Object) this.mName, (Object) Integer.valueOf(size));
            }
            startWorkerIfNeeded();
        } else {
    ...
    public void startWorkerIfNeeded() {
        ...
        while (i < this.mMaxConcurrency) {
            ...
            if (this.mPendingWorkers.compareAndSet(i, i2)) {
                FLog.m85v(TAG, "%s: starting worker %d of %d", (Object) this.mName, (Object) Integer.valueOf(i2), (Object) Integer.valueOf(this.mMaxConcurrency));
                this.mExecutor.execute(this.mTaskRunner);
                return;
            }
            FLog.m83v(TAG, "%s: race in startWorkerIfNeeded; retrying", (Object) this.mName);
        ...
        public void run() {
            ...
            try {
                ...
                if (runnable != null) {
                    ...
                    FLog.m83v((Class<?>) ConstrainedExecutorService.TAG, "%s: Worker has nothing to run", (Object) ConstrainedExecutorService.this.mName);
                }
                if (isEmpty) {
                    FLog.m84v((Class<?>) ConstrainedExecutorService.TAG, "%s: worker finished; %d workers left", (Object) ConstrainedExecutorService.this.mName, (Object) Integer.valueOf(access$400.decrementAndGet()));
                }
            } finally {
                ...
                if (!ConstrainedExecutorService.this.mWorkQueue.isEmpty()) {
                    ...
                    FLog.m84v((Class<?>) ConstrainedExecutorService.TAG, "%s: worker finished; %d workers left", (Object) ConstrainedExecutorService.this.mName, (Object) Integer.valueOf(decrementAndGet));
                }
            }
        }
    }
