...
public class RetainingDataSourceSupplier<T> implements Supplier<DataSource<T>> {
    ...
    private static class RetainingDataSource<T> extends AbstractDataSource<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x0025, code lost:
            r4.subscribe(new com.facebook.datasource.RetainingDataSourceSupplier.RetainingDataSource.InternalDataSubscriber(r3, (com.facebook.datasource.RetainingDataSourceSupplier.C09681) null), com.facebook.common.executors.CallerThreadExecutor.getInstance());
         */
