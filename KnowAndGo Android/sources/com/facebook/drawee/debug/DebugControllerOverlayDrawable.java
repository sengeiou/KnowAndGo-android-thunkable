...
public class DebugControllerOverlayDrawable extends Drawable implements ImageLoadingTimeListener {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mImageId != null) {
            addDebugText(canvas, "IDs", format("%s, %s", this.mControllerId, this.mImageId));
        } else {
        ...
        if (this.mImageFormat != null) {
            addDebugText(canvas, "i format", this.mImageFormat);
        }
        if (this.mFrameCount > 0) {
            addDebugText(canvas, "anim", format("f %d, l %d", Integer.valueOf(this.mFrameCount), Integer.valueOf(this.mLoopCount)));
        }
        if (this.mScaleType != null) {
            addDebugText(canvas, "scale", (Object) this.mScaleType);
        }
        if (this.mFinalImageTimeMs >= 0) {
            addDebugText(canvas, "t", format("%d ms", Long.valueOf(this.mFinalImageTimeMs)));
        }
        if (this.mOriginText != null) {
            addDebugText(canvas, "origin", this.mOriginText, this.mOriginColor);
        }
    ...
    private void addDebugText(Canvas canvas, String str, String str2, int i) {
        ...
        canvas.drawRect((float) (this.mCurrentTextXPx - 4), (float) (this.mCurrentTextYPx + 8), ((float) this.mCurrentTextXPx) + measureText + measureText2 + 4.0f, (float) (this.mCurrentTextYPx + this.mLineIncrementPx + 8), this.mPaint);
        this.mPaint.setColor(-1);
