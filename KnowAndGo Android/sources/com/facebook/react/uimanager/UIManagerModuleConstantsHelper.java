...
class UIManagerModuleConstantsHelper {
    ...
    static Map<String, Object> getDefaultExportableEventTypes() {
        return MapBuilder.m139of(BUBBLING_EVENTS_KEY, UIManagerModuleConstants.getBubblingEventTypeConstants(), DIRECT_EVENTS_KEY, UIManagerModuleConstants.getDirectEventTypeConstants());
    }
