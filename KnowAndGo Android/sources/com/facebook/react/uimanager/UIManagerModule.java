...
public class UIManagerModule extends ReactContextBaseJavaModule implements OnBatchCompleteListener, LifecycleEventListener, UIManager {
    ...
    public void createView(int i, String str, int i2, ReadableMap readableMap) {
        if (DEBUG) {
            ...
            FLog.m50d(ReactConstants.TAG, str2);
    ...
    public void updateView(final int r4, java.lang.String r5, final com.facebook.react.bridge.ReadableMap r6) {
        /*
            ...
            com.facebook.common.logging.FLog.m50d((java.lang.String) r1, (java.lang.String) r0)
    ...
    public void invalidateNodeLayout(int i) {
        ...
        if (resolveShadowNode == null) {
            FLog.m102w(ReactConstants.TAG, "Warning : attempted to dirty a non-existent react shadow node. reactTag=" + i);
            return;
        }
