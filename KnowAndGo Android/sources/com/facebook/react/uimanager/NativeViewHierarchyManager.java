...
public class NativeViewHierarchyManager {
    ...
    public synchronized void updateInstanceHandle(int i, long j) {
        ...
        try {
            ...
            String str = TAG;
            FLog.m63e(str, "Unable to update properties for view tag " + i, (Throwable) e);
        }
        return;
    }
    ...
    private void updateInstanceHandle(View view, long j) {
        UiThreadUtil.assertOnUiThread();
        view.setTag(C1129R.C1132id.view_tag_instance_handle, Long.valueOf(j));
    }
    ...
    public long getInstanceHandle(int i) {
        ...
        if (view != null) {
            Long l = (Long) view.getTag(C1129R.C1132id.view_tag_instance_handle);
            if (l != null) {
                return l.longValue();
            }
    ...
    public final synchronized void addRootViewGroup(int i, View view) {
        if (view.getId() != -1) {
            String str = TAG;
            FLog.m62e(str, "Trying to add a root view with an explicit id (" + view.getId() + ") already set. React Native uses the id field to track react tags and will overwrite this field. If that is fine, explicitly overwrite the id field to View.NO_ID before calling addRootView.");
        }
            ...
            if (this.mTagsToViewManagers.get(view.getId()) != null) {
                ...
                if ((view instanceof ViewGroup) && (viewManager instanceof ViewGroupManager)) {
                    ...
                    for (int childCount = viewGroupManager.getChildCount(viewGroup) - 1; childCount >= 0; childCount--) {
                        ...
                        if (childAt == null) {
                            FLog.m62e(TAG, "Unable to drop null child view");
