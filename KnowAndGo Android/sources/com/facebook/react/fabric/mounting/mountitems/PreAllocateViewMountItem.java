...
public class PreAllocateViewMountItem implements MountItem {
    ...
    public PreAllocateViewMountItem(@NonNull ThemedReactContext themedReactContext, int i, int i2, @NonNull String str, @Nullable ReadableMap readableMap, @NonNull StateWrapper stateWrapper, boolean z) {
    ...
    public void execute(@NonNull MountingManager mountingManager) {
        if (FabricUIManager.ENABLE_FABRIC_LOGS) {
            FLog.m50d(FabricUIManager.TAG, "Executing pre-allocation of: " + toString());
        }
