...
public class ReactViewBackgroundDrawable extends Drawable {
    ...
    private void updatePath() {
        if (this.mNeedUpdatePathForBorderRadius) {
            ...
            fArr[0] = max + (i > 0 ? f8 : 0.0f);
            fArr[1] = (i > 0 ? f8 : 0.0f) + max2;
            int i2 = (borderRadiusOrDefaultTo2 > 0.0f ? 1 : (borderRadiusOrDefaultTo2 == 0.0f ? 0 : -1));
            fArr[2] = (i2 > 0 ? f8 : 0.0f) + max3;
            fArr[3] = (i2 > 0 ? f8 : 0.0f) + max4;
            int i3 = (f7 > 0.0f ? 1 : (f7 == 0.0f ? 0 : -1));
            fArr[4] = (i3 > 0 ? f8 : 0.0f) + max5;
            fArr[5] = (i3 > 0 ? f8 : 0.0f) + max6;
            int i4 = (f6 > 0.0f ? 1 : (f6 == 0.0f ? 0 : -1));
            fArr[6] = (i4 > 0 ? f8 : 0.0f) + max7;
            if (i4 <= 0) {
                f8 = 0.0f;
            }
            fArr[7] = f8 + max8;
