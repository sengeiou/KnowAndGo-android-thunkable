...
public class ReactImageManager extends SimpleViewManager<ReactImageView> {
    ...
    public ReactImageView createViewInstance(ThemedReactContext themedReactContext) {
        ...
        if (this.mCallerContextFactory != null) {
            obj = this.mCallerContextFactory.getOrCreateCallerContext(themedReactContext);
        } else {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m141of(ImageLoadEvent.eventNameForType(4), MapBuilder.m138of("registrationName", "onLoadStart"), ImageLoadEvent.eventNameForType(2), MapBuilder.m138of("registrationName", "onLoad"), ImageLoadEvent.eventNameForType(1), MapBuilder.m138of("registrationName", "onError"), ImageLoadEvent.eventNameForType(3), MapBuilder.m138of("registrationName", "onLoadEnd"));
    }
