...
public class DevLoadingViewController {
    ...
    public void showForRemoteJSEnabled() {
        Context context = getContext();
        if (context != null) {
            showMessage(context.getString(C1129R.string.catalyst_debug_connecting));
        }
    }
    ...
    public void showInternal(String str) {
        if (this.mDevLoadingPopup == null || !this.mDevLoadingPopup.isShowing()) {
            ...
            if (currentActivity == null) {
                FLog.m62e(ReactConstants.TAG, "Unable to display loading message because react activity isn't available");
                return;
            }
            Rect rect = new Rect();
            currentActivity.getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
            int i = rect.top;
            this.mDevLoadingView = (TextView) ((LayoutInflater) currentActivity.getSystemService("layout_inflater")).inflate(C1129R.layout.dev_loading_view, (ViewGroup) null);
