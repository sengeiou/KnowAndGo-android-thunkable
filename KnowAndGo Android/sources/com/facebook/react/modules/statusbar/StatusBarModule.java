...
public class StatusBarModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        return MapBuilder.m139of(HEIGHT_KEY, Float.valueOf(dIPFromPixel), DEFAULT_BACKGROUND_COLOR_KEY, str);
    }
    ...
    public void setColor(int i, boolean z) {
        ...
        if (currentActivity == null) {
            FLog.m102w(ReactConstants.TAG, "StatusBarModule: Ignored status bar change, current activity is null.");
