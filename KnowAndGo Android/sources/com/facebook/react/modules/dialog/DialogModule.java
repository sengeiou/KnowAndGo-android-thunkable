...
public class DialogModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    static final Map<String, Object> CONSTANTS = MapBuilder.m142of(ACTION_BUTTON_CLICKED, ACTION_BUTTON_CLICKED, "dismissed", "dismissed", KEY_BUTTON_POSITIVE, -1, KEY_BUTTON_NEGATIVE, -2, KEY_BUTTON_NEUTRAL, -3);
    ...
    public void onHostResume() {
        ...
        if (fragmentManagerHelper != null) {
            ...
            FLog.m98w((Class<?>) DialogModule.class, "onHostResume called but no FragmentManager found");
        }
    }
