            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                while (i < readableArray.size()) {
                    ...
                    try {
                        ...
                        FLog.m103w(ReactConstants.TAG, e.getMessage(), (Throwable) e);
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    while (i < readableArray.size()) {
                        if (readableArray.getArray(i).size() != 2) {
                            ...
                            try {
                                ...
                                FLog.m103w(ReactConstants.TAG, e2.getMessage(), (Throwable) e2);
                            ...
                            try {
                                ...
                                FLog.m103w(ReactConstants.TAG, e3.getMessage(), (Throwable) e3);
                    ...
                    try {
                        ...
                        FLog.m103w(ReactConstants.TAG, e4.getMessage(), (Throwable) e4);
                        writableMap = AsyncStorageErrorUtil.getError((String) null, e4.getMessage());
                    }
                } catch (Exception e5) {
                    FLog.m103w(ReactConstants.TAG, e5.getMessage(), (Throwable) e5);
                    WritableMap error = AsyncStorageErrorUtil.getError((String) null, e5.getMessage());
                    try {
                        AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                    } catch (Exception e6) {
                        FLog.m103w(ReactConstants.TAG, e6.getMessage(), (Throwable) e6);
                        if (error == null) {
                    ...
                    try {
                        ...
                        FLog.m103w(ReactConstants.TAG, e7.getMessage(), (Throwable) e7);
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    try {
                        ...
                        FLog.m103w(ReactConstants.TAG, e8.getMessage(), (Throwable) e8);
