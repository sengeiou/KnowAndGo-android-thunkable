...
public final class JSPackagerClient implements ReconnectingWebSocket.MessageCallback {
    ...
    private class ResponderImpl implements Responder {
        ...
        public void respond(Object obj) {
            try {
                ...
                FLog.m63e(JSPackagerClient.TAG, "Responding failed", (Throwable) e);
            }
        }
        ...
        public void error(Object obj) {
            try {
                ...
                FLog.m63e(JSPackagerClient.TAG, "Responding with error failed", (Throwable) e);
            }
        }
    }
    ...
    public void onMessage(String str) {
        try {
            ...
            if (optInt != 2) {
                String str2 = TAG;
                FLog.m62e(str2, "Message with incompatible or missing version of protocol received: " + optInt);
            ...
            FLog.m63e(TAG, "Handling the message failed", (Throwable) e);
        }
    }

    public void onMessage(ByteString byteString) {
        FLog.m102w(TAG, "Websocket received message with payload of unexpected type binary");
    }
    ...
    private void abortOnMessage(Object obj, String str) {
        ...
        String str2 = TAG;
        FLog.m62e(str2, "Handling the message failed with reason: " + str);
    }
}
