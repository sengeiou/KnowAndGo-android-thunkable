...
public class BytesRange {
    ...
    public String toHttpRangeHeaderValue() {
        return String.format((Locale) null, "bytes=%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f101to)});
    }

    public boolean contains(@Nullable BytesRange bytesRange) {
        return bytesRange != null && this.from <= bytesRange.from && this.f101to >= bytesRange.f101to;
    }

    public String toString() {
        return String.format((Locale) null, "%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f101to)});
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.from == bytesRange.from && this.f101to == bytesRange.f101to) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return HashCodeUtil.hashCode(this.from, this.f101to);
    }
