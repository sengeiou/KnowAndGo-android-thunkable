...
public abstract class LocalFetchProducer implements Producer<EncodedImage> {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        final C10851 r0 = new StatefulProducerRunnable<EncodedImage>(consumer, producerListener, producerContext, getProducerName()) {
            /* access modifiers changed from: protected */
            @Nullable
    ...
    public EncodedImage getByteBufferBackedEncodedImage(InputStream inputStream, int i) throws IOException {
        ...
        if (i <= 0) {
            try {
                of = CloseableReference.m126of(this.mPooledByteBufferFactory.newByteBuffer(inputStream));
            } catch (Throwable th) {
            ...
            of = CloseableReference.m126of(this.mPooledByteBufferFactory.newByteBuffer(inputStream, i));
        }
