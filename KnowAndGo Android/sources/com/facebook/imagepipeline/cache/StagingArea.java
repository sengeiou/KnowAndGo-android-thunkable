...
public class StagingArea {
    ...
    public synchronized com.facebook.imagepipeline.image.EncodedImage get(com.facebook.cache.common.CacheKey r7) {
        /*
            ...
            com.facebook.common.logging.FLog.m100w((java.lang.Class<?>) r1, (java.lang.String) r2, (java.lang.Object[]) r3)     // Catch:{ all -> 0x004b }
            r7 = 0
    ...
    public synchronized boolean containsKey(CacheKey cacheKey) {
        ...
        synchronized (encodedImage) {
            ...
            this.mMap.remove(cacheKey);
            FLog.m100w(TAG, "Found closed reference %d for key %s (%d)", Integer.valueOf(System.identityHashCode(encodedImage)), cacheKey.getUriString(), Integer.valueOf(System.identityHashCode(cacheKey)));
            return false;
        }
    }

    private synchronized void logStats() {
        FLog.m83v(TAG, "Count = %d", (Object) Integer.valueOf(this.mMap.size()));
    }
}
