        ...
        if (!fileName.startsWith("data:") || fileName.indexOf("base64,") <= 0) {
            try {
                if (!TextUtils.isEmpty(this.imagesFolder)) {
                    ...
                    return putBitmap(str, C0744Utils.resizeBitmapIfNeeded(BitmapFactory.decodeStream(assets.open(this.imagesFolder + fileName), (Rect) null, options), lottieImageAsset.getWidth(), lottieImageAsset.getHeight()));
                }
