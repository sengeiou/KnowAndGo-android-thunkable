...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        ...
        this.mContainer = (ViewGroup) LayoutInflater.from(this.mContext).inflate(C2266R.layout.amu_text_bubble, (ViewGroup) null);
        this.mRotationLayout = (RotationLayout) this.mContainer.getChildAt(0);
        TextView textView = (TextView) this.mRotationLayout.findViewById(C2266R.C2269id.amu_text);
    ...
    public void setContentView(View view) {
        ...
        View findViewById = this.mRotationLayout.findViewById(C2266R.C2269id.amu_text);
    ...
    private static int getTextStyle(int i) {
        switch (i) {
            ...
            case 6:
            case 7:
                return C2266R.style.amu_Bubble_TextAppearance_Light;
            default:
                return C2266R.style.amu_Bubble_TextAppearance_Dark;
        }
    }
}
