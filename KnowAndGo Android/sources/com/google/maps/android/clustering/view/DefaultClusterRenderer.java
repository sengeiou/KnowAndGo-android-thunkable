...
import com.google.maps.android.C2266R;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public DefaultClusterRenderer(Context context, GoogleMap googleMap, ClusterManager<T> clusterManager) {
        ...
        this.mIconGenerator.setTextAppearance(C2266R.style.amu_ClusterIcon_TextAppearance);
    ...
    private SquareTextView makeSquareTextView(Context context) {
        ...
        squareTextView.setId(C2266R.C2269id.amu_text);
    ...
    private static double distanceSquared(Point point, Point point2) {
        return ((point.f1043x - point2.f1043x) * (point.f1043x - point2.f1043x)) + ((point.f1044y - point2.f1044y) * (point.f1044y - point2.f1044y));
    }
            ...
            if (!DefaultClusterRenderer.this.shouldRenderAsCluster(this.cluster)) {
                for (T t : this.cluster.getItems()) {
                    ...
                    if (marker == null) {
                        ...
                        if (this.animateFrom != null) {
                            markerModifier.animate(markerWithPosition2, this.animateFrom, t.getPosition());
                        }
                    } else {
                        markerWithPosition2 = new MarkerWithPosition(marker);
                    }
    ...
    private class AnimationTask extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            LatLng unused = this.markerWithPosition.position = this.f1042to;
        }
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            double d2 = ((this.f1042to.latitude - this.from.latitude) * d) + this.from.latitude;
            double d3 = this.f1042to.longitude - this.from.longitude;
