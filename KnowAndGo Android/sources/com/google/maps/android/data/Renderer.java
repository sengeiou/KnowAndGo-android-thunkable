...
public class Renderer {
    ...
    public Feature getContainerFeature(Object obj) {
        if (this.mContainerFeatures != null) {
            return this.mContainerFeatures.getKey(obj);
        }
        return null;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0059, code lost:
        if (r0.equals("Point") != false) goto L_0x005d;
     */
    ...
    public java.lang.Object addKmlPlacemarkToMap(com.google.maps.android.data.kml.KmlPlacemark r11, com.google.maps.android.data.Geometry r12, com.google.maps.android.data.kml.KmlStyle r13, com.google.maps.android.data.kml.KmlStyle r14, boolean r15) {
        /*
            ...
            java.lang.String r4 = r11.getProperty(r4)     // Catch:{ NumberFormatException -> 0x001a }
            float r4 = java.lang.Float.parseFloat(r4)     // Catch:{ NumberFormatException -> 0x001a }
            r3 = r4
            goto L_0x001b
        L_0x001a:
            r1 = 0
    ...
    private void createInfoWindow() {
        this.mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                View inflate = LayoutInflater.from(Renderer.this.mContext).inflate(C2266R.layout.amu_info_window, (ViewGroup) null);
                TextView textView = (TextView) inflate.findViewById(C2266R.C2269id.window);
