...
public class SampleQueue implements TrackOutput {
    ...
    private void readEncryptionData(DecoderInputBuffer decoderInputBuffer, SampleMetadataQueue.SampleExtrasHolder sampleExtrasHolder) {
        ...
        if (decoderInputBuffer2.cryptoInfo.f136iv == null) {
            decoderInputBuffer2.cryptoInfo.f136iv = new byte[16];
        }
        readData(j2, decoderInputBuffer2.cryptoInfo.f136iv, (int) b2);
        long j3 = j2 + ((long) b2);
        if (z) {
        ...
        decoderInputBuffer2.cryptoInfo.set(i, iArr2, iArr4, cryptoData.encryptionKey, decoderInputBuffer2.cryptoInfo.f136iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
