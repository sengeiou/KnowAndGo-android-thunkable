...
final class HlsMediaChunk extends MediaChunk {
    ...
    private void loadMedia() throws java.io.IOException, java.lang.InterruptedException {
        ...
        L_0x0037:
            com.google.android.exoplayer2.upstream.StatsDataSource r3 = r7.dataSource     // Catch:{ all -> 0x0074 }
            com.google.android.exoplayer2.extractor.DefaultExtractorInput r0 = r7.prepareExtraction(r3, r0)     // Catch:{ all -> 0x0074 }
            if (r2 == 0) goto L_0x0044
            int r2 = r7.nextLoadPosition     // Catch:{ all -> 0x0074 }
            r0.skipFully(r2)     // Catch:{ all -> 0x0074 }
        L_0x0044:
            if (r1 != 0) goto L_0x0061
            boolean r1 = r7.loadCanceled     // Catch:{ all -> 0x0052 }
            if (r1 != 0) goto L_0x0061
            com.google.android.exoplayer2.extractor.Extractor r1 = r7.extractor     // Catch:{ all -> 0x0052 }
            r2 = 0
        ...
        L_0x0052:
            ...
            com.google.android.exoplayer2.upstream.DataSpec r0 = r7.dataSpec     // Catch:{ all -> 0x0074 }
            long r4 = r0.absoluteStreamPosition     // Catch:{ all -> 0x0074 }
            r0 = 0
            long r2 = r2 - r4
            int r0 = (int) r2     // Catch:{ all -> 0x0074 }
            r7.nextLoadPosition = r0     // Catch:{ all -> 0x0074 }
            throw r1     // Catch:{ all -> 0x0074 }
        L_0x0061:
            long r0 = r0.getPosition()     // Catch:{ all -> 0x0074 }
            com.google.android.exoplayer2.upstream.DataSpec r2 = r7.dataSpec     // Catch:{ all -> 0x0074 }
            long r2 = r2.absoluteStreamPosition     // Catch:{ all -> 0x0074 }
            r4 = 0
            long r0 = r0 - r2
            int r0 = (int) r0     // Catch:{ all -> 0x0074 }
            r7.nextLoadPosition = r0     // Catch:{ all -> 0x0074 }
            com.google.android.exoplayer2.upstream.StatsDataSource r0 = r7.dataSource
            com.google.android.exoplayer2.util.Util.closeQuietly((com.google.android.exoplayer2.upstream.DataSource) r0)
            return
        L_0x0074:
            r0 = move-exception
            com.google.android.exoplayer2.upstream.StatsDataSource r1 = r7.dataSource
    ...
    private DefaultExtractorInput prepareExtraction(DataSource dataSource, DataSpec dataSpec) throws IOException, InterruptedException {
        ...
        if (((Boolean) createExtractor.second).booleanValue()) {
            this.output.setSampleOffsetUs(peekId3PrivTimestamp != C1470C.TIME_UNSET ? this.timestampAdjuster.adjustTsTimestamp(peekId3PrivTimestamp) : this.startTimeUs);
        }
