...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    public void onPrimaryPlaylistRefreshed(HlsMediaPlaylist hlsMediaPlaylist) {
        ...
        long usToMs = hlsMediaPlaylist2.hasProgramDateTime ? C1470C.usToMs(hlsMediaPlaylist2.startTimeUs) : -9223372036854775807L;
        ...
        if (this.playlistTracker.isLive()) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(j3, usToMs, hlsMediaPlaylist2.durationUs, hlsMediaPlaylist2.durationUs, 0, j4 == C1470C.TIME_UNSET ? 0 : j4, true, false, this.tag);
        }
