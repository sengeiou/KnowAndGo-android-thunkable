...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    private long lastLoadedChunkEndTimeBeforeRefreshUs = C1470C.TIME_UNSET;
    private long lastLoadedChunkEndTimeUs = C1470C.TIME_UNSET;
    ...
    public boolean maybeRefreshManifestOnLoadingError(Chunk chunk) {
        ...
        if (!(this.lastLoadedChunkEndTimeUs != C1470C.TIME_UNSET && this.lastLoadedChunkEndTimeUs < chunk.startTimeUs)) {
            return false;
        }
        maybeNotifyDashManifestRefreshNeeded();
        return true;
    ...
    public void onChunkLoadCompleted(Chunk chunk) {
        if (this.lastLoadedChunkEndTimeUs != C1470C.TIME_UNSET || chunk.endTimeUs > this.lastLoadedChunkEndTimeUs) {
    ...
    private void maybeNotifyDashManifestRefreshNeeded() {
        if (this.lastLoadedChunkEndTimeBeforeRefreshUs == C1470C.TIME_UNSET || this.lastLoadedChunkEndTimeBeforeRefreshUs != this.lastLoadedChunkEndTimeUs) {
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private void parsePlayerEmsgEvent(long j, EventMessage eventMessage) {
            ...
            if (access$100 != C1470C.TIME_UNSET) {
