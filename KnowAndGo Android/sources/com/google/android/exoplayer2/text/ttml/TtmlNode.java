...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        return new TtmlNode((String) null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C1470C.TIME_UNSET, C1470C.TIME_UNSET, (TtmlStyle) null, (String[]) null, "");
    }
    ...
    public boolean isActive(long j) {
        return (this.startTimeUs == C1470C.TIME_UNSET && this.endTimeUs == C1470C.TIME_UNSET) || (this.startTimeUs <= j && this.endTimeUs == C1470C.TIME_UNSET) || ((this.startTimeUs == C1470C.TIME_UNSET && j < this.endTimeUs) || (this.startTimeUs <= j && j < this.endTimeUs));
    }
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z) {
        ...
        if (z || equals) {
            if (this.startTimeUs != C1470C.TIME_UNSET) {
                treeSet.add(Long.valueOf(this.startTimeUs));
            }
            if (this.endTimeUs != C1470C.TIME_UNSET) {
