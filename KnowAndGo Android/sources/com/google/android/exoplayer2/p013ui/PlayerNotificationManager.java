...
public class PlayerNotificationManager {
    ...
    public PlayerNotificationManager(Context context2, String str, int i, MediaDescriptionAdapter mediaDescriptionAdapter2, @Nullable CustomActionReceiver customActionReceiver2) {
        ...
        this.color = 0;
        this.smallIconResourceId = C1581R.C1583drawable.exo_notification_small_icon;
        this.defaults = 0;
        this.priority = -1;
    ...
    private static Map<String, NotificationCompat.Action> createPlaybackActions(Context context2, int i) {
        ...
        hashMap.put(ACTION_PLAY, new NotificationCompat.Action(C1581R.C1583drawable.exo_notification_play, context2.getString(C1581R.string.exo_controls_play_description), createBroadcastIntent(ACTION_PLAY, context2, i)));
        hashMap.put(ACTION_PAUSE, new NotificationCompat.Action(C1581R.C1583drawable.exo_notification_pause, context2.getString(C1581R.string.exo_controls_pause_description), createBroadcastIntent(ACTION_PAUSE, context2, i)));
        hashMap.put(ACTION_STOP, new NotificationCompat.Action(C1581R.C1583drawable.exo_notification_stop, context2.getString(C1581R.string.exo_controls_stop_description), createBroadcastIntent(ACTION_STOP, context2, i)));
        hashMap.put(ACTION_REWIND, new NotificationCompat.Action(C1581R.C1583drawable.exo_notification_rewind, context2.getString(C1581R.string.exo_controls_rewind_description), createBroadcastIntent(ACTION_REWIND, context2, i)));
        hashMap.put(ACTION_FAST_FORWARD, new NotificationCompat.Action(C1581R.C1583drawable.exo_notification_fastforward, context2.getString(C1581R.string.exo_controls_fastforward_description), createBroadcastIntent(ACTION_FAST_FORWARD, context2, i)));
        hashMap.put(ACTION_PREVIOUS, new NotificationCompat.Action(C1581R.C1583drawable.exo_notification_previous, context2.getString(C1581R.string.exo_controls_previous_description), createBroadcastIntent(ACTION_PREVIOUS, context2, i)));
        hashMap.put(ACTION_NEXT, new NotificationCompat.Action(C1581R.C1583drawable.exo_notification_next, context2.getString(C1581R.string.exo_controls_next_description), createBroadcastIntent(ACTION_NEXT, context2, i)));
        return hashMap;
    }
    ...
    private static PendingIntent createBroadcastIntent(String str, Context context2, int i) {
        ...
        return PendingIntent.getBroadcast(context2, i, intent, C1470C.ENCODING_PCM_MU_LAW);
    }
            ...
            if (access$100 != null && PlayerNotificationManager.this.isNotificationStarted && intent.getIntExtra(PlayerNotificationManager.EXTRA_INSTANCE_ID, PlayerNotificationManager.this.instanceId) == PlayerNotificationManager.this.instanceId) {
                ...
                if (PlayerNotificationManager.ACTION_PLAY.equals(action) || PlayerNotificationManager.ACTION_PAUSE.equals(action)) {
                    ...
                    if (nextWindowIndex != -1) {
                        PlayerNotificationManager.this.controlDispatcher.dispatchSeekTo(access$100, nextWindowIndex, C1470C.TIME_UNSET);
                    }
                    ...
                    if (previousWindowIndex == -1 || (access$100.getCurrentPosition() > PlayerNotificationManager.MAX_POSITION_FOR_SEEK_TO_PREVIOUS && (!this.window.isDynamic || this.window.isSeekable))) {
                        PlayerNotificationManager.this.controlDispatcher.dispatchSeekTo(access$100, access$100.getCurrentWindowIndex(), C1470C.TIME_UNSET);
                    } else {
                        PlayerNotificationManager.this.controlDispatcher.dispatchSeekTo(access$100, previousWindowIndex, C1470C.TIME_UNSET);
                    }
