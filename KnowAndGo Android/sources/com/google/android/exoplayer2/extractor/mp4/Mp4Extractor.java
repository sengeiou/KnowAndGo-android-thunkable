...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        while (i2 < size) {
            ...
            j = Math.max(j, track.durationUs != C1470C.TIME_UNSET ? track.durationUs : trackSampleTable.durationUs);
            if (track.type == 2) {
                if (i3 == -1) {
                    i3 = arrayList.size();
                }
    ...
    private ArrayList<TrackSampleTable> getTrackSampleTables(Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder, boolean z) throws ParserException {
        ...
        for (int i = 0; i < containerAtom.containerChildren.size(); i++) {
            ...
            if (containerAtom2.type == Atom.TYPE_trak && (parseTrak = AtomParsers.parseTrak(containerAtom2, containerAtom.getLeafAtomOfType(Atom.TYPE_mvhd), C1470C.TIME_UNSET, (DrmInitData) null, z, this.isQuickTime)) != null) {
