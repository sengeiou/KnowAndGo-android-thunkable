...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    static SpliceInsertCommand parseFromSection(ParsableByteArray parsableByteArray, long j, TimestampAdjuster timestampAdjuster) {
        ...
        if (!z6) {
            ...
            long parseSpliceTime = (!z8 || z10) ? C1470C.TIME_UNSET : TimeSignalCommand.parseSpliceTime(parsableByteArray, j);
            if (!z8) {
                int readUnsignedByte2 = parsableByteArray.readUnsignedByte();
                list2 = new ArrayList(readUnsignedByte2);
                for (int i4 = 0; i4 < readUnsignedByte2; i4++) {
                    int readUnsignedByte3 = parsableByteArray.readUnsignedByte();
                    long parseSpliceTime2 = !z10 ? TimeSignalCommand.parseSpliceTime(parsableByteArray, j) : C1470C.TIME_UNSET;
            ...
            z4 = false;
            z3 = false;
            j3 = C1470C.TIME_UNSET;
            z2 = false;
            j2 = C1470C.TIME_UNSET;
            i3 = 0;
            i2 = 0;
            i = 0;
            z = false;
