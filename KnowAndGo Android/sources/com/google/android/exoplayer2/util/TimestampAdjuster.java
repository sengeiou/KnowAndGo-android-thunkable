...
public final class TimestampAdjuster {
    ...
    private volatile long lastSampleTimestampUs = C1470C.TIME_UNSET;
    ...
    public synchronized void setFirstSampleTimestampUs(long j) {
        Assertions.checkState(this.lastSampleTimestampUs == C1470C.TIME_UNSET);
    ...
    public long getLastAdjustedTimestampUs() {
        if (this.lastSampleTimestampUs == C1470C.TIME_UNSET) {
            return this.firstSampleTimestampUs != Long.MAX_VALUE ? this.firstSampleTimestampUs : C1470C.TIME_UNSET;
        }
    ...
    public long getTimestampOffsetUs() {
        ...
        return this.lastSampleTimestampUs == C1470C.TIME_UNSET ? C1470C.TIME_UNSET : this.timestampOffsetUs;
    }

    public void reset() {
        this.lastSampleTimestampUs = C1470C.TIME_UNSET;
    }
    ...
    public synchronized void waitUntilInitialized() throws InterruptedException {
        while (this.lastSampleTimestampUs == C1470C.TIME_UNSET) {
            wait();
        }
    }
