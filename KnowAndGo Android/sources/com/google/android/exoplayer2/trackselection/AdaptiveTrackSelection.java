...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter2, long j, long j2, long j3, float f, float f2, long j4, Clock clock2) {
        ...
        this.reason = 1;
        this.lastBufferEvaluationMs = C1470C.TIME_UNSET;
    ...
    public int evaluateQueueSize(long j, List<? extends MediaChunk> list) {
        long elapsedRealtime = this.clock.elapsedRealtime();
        if (this.lastBufferEvaluationMs != C1470C.TIME_UNSET && elapsedRealtime - this.lastBufferEvaluationMs < this.minTimeBetweenBufferReevaluationMs) {
            return list.size();
        }
    ...
    private long minDurationForQualityIncreaseUs(long j) {
        return (j > C1470C.TIME_UNSET ? 1 : (j == C1470C.TIME_UNSET ? 0 : -1)) != 0 && (j > this.minDurationForQualityIncreaseUs ? 1 : (j == this.minDurationForQualityIncreaseUs ? 0 : -1)) <= 0 ? (long) (((float) j) * this.bufferedFractionToLiveEdgeForQualityIncrease) : this.minDurationForQualityIncreaseUs;
    }
}
