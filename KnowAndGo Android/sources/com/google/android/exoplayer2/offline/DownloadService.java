...
public abstract class DownloadService extends Service {
    ...
    public int onStartCommand(android.content.Intent r5, int r6, int r7) {
        ...
        L_0x008c:
            ...
            com.google.android.exoplayer2.util.Log.m153e(r5, r6)
            goto L_0x00c5
        L_0x00a3:
        ...
        L_0x00bd:
            ...
            com.google.android.exoplayer2.util.Log.m154e(r6, r7, r5)
        L_0x00c5:
        ...
        public void requirementsNotMet(RequirementsWatcher requirementsWatcher2) {
            ...
            if (this.scheduler != null) {
                if (!this.scheduler.schedule(this.requirements, this.context.getPackageName(), DownloadService.ACTION_RESTART)) {
                    Log.m153e(DownloadService.TAG, "Scheduling downloads failed.");
                }
            }
        }
