...
public final class C2028by {

    /* renamed from: a */
    private static final C1982af f765a = new C1982af("PhoneskyVerificationUtils");
    ...
    public static boolean m725a(Context context) {
        try {
            ...
            if (signatureArr == null || (r1 = signatureArr.length) == 0) {
                f765a.mo33554d("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                return false;
            }
            for (Signature byteArray : signatureArr) {
                String a = C2096p.m908a(byteArray.toByteArray());
