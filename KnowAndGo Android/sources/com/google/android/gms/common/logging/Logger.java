...
public class Logger {
    ...
    @KeepForSdk
    /* renamed from: v */
    public void mo22703v(String str, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    @KeepForSdk
    /* renamed from: d */
    public void mo22698d(String str, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public void mo22701i(String str, @Nullable Object... objArr) {
        Log.i(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: w */
    public void mo22704w(String str, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo22700e(String str, @Nullable Object... objArr) {
        Log.e(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo22699e(String str, Throwable th, @Nullable Object... objArr) {
