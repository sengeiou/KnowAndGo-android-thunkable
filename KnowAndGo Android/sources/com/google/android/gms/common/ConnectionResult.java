...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo22648id = 2)
    private final int zzh;
    @SafeParcelable.Field(getter = "getResolution", mo22648id = 3)
    private final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getErrorMessage", mo22648id = 4)
    private final String zzj;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) int i2, @SafeParcelable.Param(mo22651id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo22651id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
