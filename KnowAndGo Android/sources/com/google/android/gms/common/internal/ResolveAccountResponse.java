...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo22648id = 3)
    private ConnectionResult zadi;
    @SafeParcelable.Field(getter = "getSaveDefaultAccount", mo22648id = 4)
    private boolean zagg;
    @SafeParcelable.VersionField(mo22654id = 1)
    private final int zalf;
    @SafeParcelable.Field(mo22648id = 2)
    private IBinder zanx;
    @SafeParcelable.Field(getter = "isFromCrossClientAuth", mo22648id = 5)
    private boolean zapc;

    @SafeParcelable.Constructor
    ResolveAccountResponse(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) IBinder iBinder, @SafeParcelable.Param(mo22651id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(mo22651id = 4) boolean z, @SafeParcelable.Param(mo22651id = 5) boolean z2) {
        this.zalf = i;
        this.zanx = iBinder;
