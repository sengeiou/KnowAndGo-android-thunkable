...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    GetServiceRequest(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) int i2, @SafeParcelable.Param(mo22651id = 3) int i3, @SafeParcelable.Param(mo22651id = 4) String str, @SafeParcelable.Param(mo22651id = 5) IBinder iBinder, @SafeParcelable.Param(mo22651id = 6) Scope[] scopeArr, @SafeParcelable.Param(mo22651id = 7) Bundle bundle, @SafeParcelable.Param(mo22651id = 8) Account account, @SafeParcelable.Param(mo22651id = 10) Feature[] featureArr, @SafeParcelable.Param(mo22651id = 11) Feature[] featureArr2, @SafeParcelable.Param(mo22651id = 12) boolean z) {
        this.version = i;
        this.zzdg = i2;
        this.zzdh = i3;
