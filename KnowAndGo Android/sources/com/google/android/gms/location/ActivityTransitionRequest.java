...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo22648id = 2)
    @Nullable
    private final String tag;
    @SafeParcelable.Field(getter = "getActivityTransitions", mo22648id = 1)
    private final List<ActivityTransition> zzl;
    @SafeParcelable.Field(getter = "getClients", mo22648id = 3)
    ...
    public ActivityTransitionRequest(@SafeParcelable.Param(mo22651id = 1) List<ActivityTransition> list, @SafeParcelable.Param(mo22651id = 2) @Nullable String str, @SafeParcelable.Param(mo22651id = 3) @Nullable List<ClientIdentity> list2) {
