...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getStatus", mo22648id = 1)
    private final Status zzbl;
    @SafeParcelable.Field(getter = "getLocationSettingsStates", mo22648id = 2)
    ...
    public LocationSettingsResult(@SafeParcelable.Param(mo22651id = 1) Status status, @SafeParcelable.Param(mo22651id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
