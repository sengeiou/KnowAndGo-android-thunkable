...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo22648id = 3)
    private final String tag;
    @SafeParcelable.VersionField(mo22654id = 1)
    private final int versionCode;
    @SafeParcelable.Field(getter = "getPlaceId", mo22648id = 2)
    private final String zza;
    @SafeParcelable.Field(getter = "getSource", mo22648id = 4)
    private final String zzb;

    @SafeParcelable.Constructor
    PlaceReport(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) String str, @SafeParcelable.Param(mo22651id = 3) String str2, @SafeParcelable.Param(mo22651id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;
