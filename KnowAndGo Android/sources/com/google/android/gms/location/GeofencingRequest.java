...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getParcelableGeofences", mo22648id = 1)
    private final List<zzbh> zzap;
    @SafeParcelable.Field(getter = "getInitialTrigger", mo22648id = 2)
    ...
    GeofencingRequest(@SafeParcelable.Param(mo22651id = 1) List<zzbh> list, @SafeParcelable.Param(mo22651id = 2) int i, @SafeParcelable.Param(mo22651id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }
