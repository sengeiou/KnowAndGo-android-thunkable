...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "isGpsUsable", mo22648id = 1)
    private final boolean zzbn;
    @SafeParcelable.Field(getter = "isNetworkLocationUsable", mo22648id = 2)
    private final boolean zzbo;
    @SafeParcelable.Field(getter = "isBleUsable", mo22648id = 3)
    private final boolean zzbp;
    @SafeParcelable.Field(getter = "isGpsPresent", mo22648id = 4)
    private final boolean zzbq;
    @SafeParcelable.Field(getter = "isNetworkLocationPresent", mo22648id = 5)
    private final boolean zzbr;
    @SafeParcelable.Field(getter = "isBlePresent", mo22648id = 6)
    private final boolean zzbs;

    @SafeParcelable.Constructor
    public LocationSettingsStates(@SafeParcelable.Param(mo22651id = 1) boolean z, @SafeParcelable.Param(mo22651id = 2) boolean z2, @SafeParcelable.Param(mo22651id = 3) boolean z3, @SafeParcelable.Param(mo22651id = 4) boolean z4, @SafeParcelable.Param(mo22651id = 5) boolean z5, @SafeParcelable.Param(mo22651id = 6) boolean z6) {
        this.zzbn = z;
        this.zzbo = z2;
        this.zzbp = z3;
        this.zzbq = z4;
