...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_PRIORITY", mo22648id = 1)
    private int priority;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPIRE_AT", mo22648id = 5)
    private long zzaf;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_INTERVAL", mo22648id = 2)
    private long zzaw;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_FASTEST_INTERVAL", mo22648id = 3)
    private long zzax;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPLICIT_FASTEST_INTERVAL", mo22648id = 4)
    private boolean zzay;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_SMALLEST_DISPLACEMENT", mo22648id = 7)
    private float zzaz;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_MAX_WAIT_TIME", mo22648id = 8)
    private long zzba;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_NUM_UPDATES", mo22648id = 6)
    private int zzx;
    ...
    LocationRequest(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) long j, @SafeParcelable.Param(mo22651id = 3) long j2, @SafeParcelable.Param(mo22651id = 4) boolean z, @SafeParcelable.Param(mo22651id = 5) long j3, @SafeParcelable.Param(mo22651id = 6) int i2, @SafeParcelable.Param(mo22651id = 7) float f, @SafeParcelable.Param(mo22651id = 8) long j4) {
        this.priority = i;
        this.zzaw = j;
        this.zzax = j2;
        this.zzay = z;
