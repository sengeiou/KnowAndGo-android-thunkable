...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo22648id = 2)
    private final ConnectionResult zadi;
    @SafeParcelable.VersionField(mo22654id = 1)
    private final int zalf;
    @SafeParcelable.Field(getter = "getResolveAccountResponse", mo22648id = 3)
    private final ResolveAccountResponse zase;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(mo22651id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
