...
public final class zah extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getResolveAccountRequest", mo22648id = 2)
    private final ResolveAccountRequest zasd;

    @SafeParcelable.Constructor
    zah(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) ResolveAccountRequest resolveAccountRequest) {
        this.zalf = i;
