...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getIdToken", mo22648id = 2)
    @NonNull
    private final String zzak;
    @SafeParcelable.Field(getter = "getAccountType", mo22648id = 1)
    @NonNull
    private final String zzr;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(mo22651id = 1) @NonNull String str, @SafeParcelable.Param(mo22651id = 2) @NonNull String str2) {
