...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    ProxyResponse(@SafeParcelable.Param(mo22651id = 1000) int i, @SafeParcelable.Param(mo22651id = 1) int i2, @SafeParcelable.Param(mo22651id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(mo22651id = 3) int i3, @SafeParcelable.Param(mo22651id = 4) Bundle bundle, @SafeParcelable.Param(mo22651id = 5) byte[] bArr) {
        this.versionCode = i;
