...
public class SignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "", mo22648id = 4)
    @Deprecated
    private String zzba;
    @SafeParcelable.Field(getter = "getGoogleSignInAccount", mo22648id = 7)
    private GoogleSignInAccount zzbb;
    @SafeParcelable.Field(defaultValue = "", mo22648id = 8)
    @Deprecated
    private String zzbc;

    @SafeParcelable.Constructor
    SignInAccount(@SafeParcelable.Param(mo22651id = 4) String str, @SafeParcelable.Param(mo22651id = 7) GoogleSignInAccount googleSignInAccount, @SafeParcelable.Param(mo22651id = 8) String str2) {
