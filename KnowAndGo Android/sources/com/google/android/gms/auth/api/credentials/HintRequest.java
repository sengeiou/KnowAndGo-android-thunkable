...
public final class HintRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountTypes", mo22648id = 4)
    ...
    @SafeParcelable.Field(getter = "getHintPickerConfig", mo22648id = 1)
    private final CredentialPickerConfig zzah;
    @SafeParcelable.Field(getter = "isEmailAddressIdentifierSupported", mo22648id = 2)
    private final boolean zzai;
    @SafeParcelable.Field(getter = "isPhoneNumberIdentifierSupported", mo22648id = 3)
    private final boolean zzaj;
    @SafeParcelable.Field(mo22648id = 1000)
    private final int zzu;

    @SafeParcelable.Constructor
    HintRequest(@SafeParcelable.Param(mo22651id = 1000) int i, @SafeParcelable.Param(mo22651id = 1) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(mo22651id = 2) boolean z, @SafeParcelable.Param(mo22651id = 3) boolean z2, @SafeParcelable.Param(mo22651id = 4) String[] strArr, @SafeParcelable.Param(mo22651id = 5) boolean z3, @SafeParcelable.Param(mo22651id = 6) String str, @SafeParcelable.Param(mo22651id = 7) String str2) {
        this.zzu = i;
