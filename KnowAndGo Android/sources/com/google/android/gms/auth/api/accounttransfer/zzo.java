...
public class zzo extends zzaz {
    ...
    @SafeParcelable.Field(getter = "getRegisteredAccountTypes", mo22648id = 2)
    private List<String> zzbf;
    @SafeParcelable.Field(getter = "getInProgressAccountTypes", mo22648id = 3)
    private List<String> zzbg;
    @SafeParcelable.Field(getter = "getSuccessAccountTypes", mo22648id = 4)
    private List<String> zzbh;
    @SafeParcelable.Field(getter = "getFailedAccountTypes", mo22648id = 5)
    private List<String> zzbi;
    @SafeParcelable.Field(getter = "getEscrowedAccountTypes", mo22648id = 6)
    ...
    zzo(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) @Nullable List<String> list, @SafeParcelable.Param(mo22651id = 3) @Nullable List<String> list2, @SafeParcelable.Param(mo22651id = 4) @Nullable List<String> list3, @SafeParcelable.Param(mo22651id = 5) @Nullable List<String> list4, @SafeParcelable.Param(mo22651id = 6) @Nullable List<String> list5) {
        this.zzv = i;
        this.zzbf = list;
        this.zzbg = list2;
        this.zzbh = list3;
