    ...
    public final void run() {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                zzbd.mo22700e("Unable to revoke access!", new Object[0]);
            }
            Logger logger = zzbd;
            StringBuilder sb = new StringBuilder(26);
            sb.append("Response Code: ");
            sb.append(responseCode);
            logger.mo22698d(sb.toString(), new Object[0]);
        } catch (IOException e) {
            Logger logger2 = zzbd;
            String valueOf3 = String.valueOf(e.toString());
            logger2.mo22700e(valueOf3.length() != 0 ? "IOException when revoking access: ".concat(valueOf3) : new String("IOException when revoking access: "), new Object[0]);
        } catch (Exception e2) {
            Logger logger3 = zzbd;
            String valueOf4 = String.valueOf(e2.toString());
            logger3.mo22700e(valueOf4.length() != 0 ? "Exception when revoking access: ".concat(valueOf4) : new String("Exception when revoking access: "), new Object[0]);
        }
