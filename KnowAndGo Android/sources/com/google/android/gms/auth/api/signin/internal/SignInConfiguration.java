...
public final class SignInConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsumerPkgName", mo22648id = 2)
    private final String zzbr;
    @SafeParcelable.Field(getter = "getGoogleConfig", mo22648id = 5)
    private GoogleSignInOptions zzbs;

    @SafeParcelable.Constructor
    public SignInConfiguration(@SafeParcelable.Param(mo22651id = 2) String str, @SafeParcelable.Param(mo22651id = 5) GoogleSignInOptions googleSignInOptions) {
