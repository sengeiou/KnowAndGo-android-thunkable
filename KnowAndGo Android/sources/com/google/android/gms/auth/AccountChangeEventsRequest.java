...
public class AccountChangeEventsRequest extends AbstractSafeParcelable {
    ...
    AccountChangeEventsRequest(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) int i2, @SafeParcelable.Param(mo22651id = 3) String str, @SafeParcelable.Param(mo22651id = 4) Account account) {
        this.zze = i;
        this.zzi = i2;
        this.zzg = str;
