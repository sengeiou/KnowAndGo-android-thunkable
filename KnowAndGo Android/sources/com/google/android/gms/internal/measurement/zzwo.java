...
class zzwo<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final V put(K k, V v) {
        ...
        int zza = zza(k);
        if (zza >= 0) {
            return this.zzcbu.get(zza).setValue(v);
        }
        zzyf();
        ...
        if (this.zzcbu.size() == this.zzcbt) {
            zzwv remove = this.zzcbu.remove(this.zzcbt - 1);
    ...
    private final int zza(K k) {
        ...
        if (size >= 0) {
            int compareTo = k.compareTo((Comparable) this.zzcbu.get(size).getKey());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = k.compareTo((Comparable) this.zzcbu.get(i2).getKey());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zzcbw == null) {
            this.zzcbw = new zzwx(this, (zzwp) null);
        }
        return this.zzcbw;
    }
    ...
    public final Set<Map.Entry<K, V>> zzye() {
        if (this.zzcby == null) {
            this.zzcby = new zzwr(this, (zzwp) null);
        }
        return this.zzcby;
    }
