...
public abstract class zztv extends zztd {
    ...
    static final class zze extends zztv {
        ...
        public final void zzc(byte b) throws IOException {
            ...
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.zzbuy), Long.valueOf(this.zzbuw), 1}));
        }
        ...
        public final void write(byte[] bArr, int i, int i2) throws IOException {
            if (bArr != null && i >= 0 && i2 >= 0 && bArr.length - i2 >= i) {
                long j = (long) i2;
                if (this.zzbuw - j >= this.zzbuy) {
                    zzxj.zza(bArr, (long) i, this.zzbuy, j);
                    this.zzbuy += j;
                    return;
                }
            }
