...
final class zzvk implements zzwm {
    ...
    public final <T> zzwl<T> zzh(Class<T> cls) {
        ...
        if (zzf.zzxn()) {
            ...
            return zzvz.zza(cls, zzf, zzwe.zzxr(), zzvf.zzxe(), zzwn.zzxz(), (zzuc<?>) null, zzvs.zzxk());
        } else if (zza(zzf)) {
            return zzvz.zza(cls, zzf, zzwe.zzxq(), zzvf.zzxd(), zzwn.zzxx(), zzue.zzvv(), zzvs.zzxj());
        } else {
            return zzvz.zza(cls, zzf, zzwe.zzxq(), zzvf.zzxd(), zzwn.zzxy(), (zzuc<?>) null, zzvs.zzxj());
        }
    }

    private static boolean zza(zzvt zzvt) {
        return zzvt.zzxm() == zzuo.zze.zzbyu;
    }

    private static zzvu zzxf() {
        try {
            return (zzvu) Class.forName("com.google.protobuf.DescriptorMessageInfoFactory").getDeclaredMethod("getInstance", new Class[0]).invoke((Object) null, new Object[0]);
