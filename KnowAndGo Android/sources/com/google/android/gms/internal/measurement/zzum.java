...
abstract class zzum<T extends zzub> {
    ...
    static <T extends zzub> T zzd(Class<T> cls) {
        ...
        try {
            ...
            Iterator<S> it = ServiceLoader.load(zzum.class, classLoader).iterator();
            ...
            try {
                return (zzub) cls.getMethod("combine", new Class[]{Collection.class}).invoke((Object) null, new Object[]{arrayList});
