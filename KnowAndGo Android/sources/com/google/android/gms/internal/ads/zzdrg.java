...
final class zzdrg extends zzdrd {
    ...
    public final int zzb(int r18, byte[] r19, int r20, int r21) {
        ...
        L_0x001e:
            ...
            long r13 = r11 + r9
            byte r3 = com.google.android.gms.internal.ads.zzdqz.zza((byte[]) r0, (long) r11)
        ...
        L_0x0032:
            ...
            long r2 = r7 + r9
            byte r7 = com.google.android.gms.internal.ads.zzdqz.zza((byte[]) r0, (long) r7)
        ...
        L_0x0087:
            r2 = 0
            long r7 = r13 + r9
            byte r2 = com.google.android.gms.internal.ads.zzdqz.zza((byte[]) r0, (long) r13)
        ...
        L_0x0098:
            int r1 = r1 + -3
            long r13 = r7 + r9
            byte r3 = com.google.android.gms.internal.ads.zzdqz.zza((byte[]) r0, (long) r7)
            ...
            long r2 = r13 + r9
            byte r7 = com.google.android.gms.internal.ads.zzdqz.zza((byte[]) r0, (long) r13)
            if (r7 > r11) goto L_0x00bb
            long r7 = r2 + r9
            byte r2 = com.google.android.gms.internal.ads.zzdqz.zza((byte[]) r0, (long) r2)
            if (r2 <= r11) goto L_0x0031
        L_0x00bb:
            return r12
        L_0x00bc:
    ...
    /* access modifiers changed from: package-private */
    public final String zzn(byte[] bArr, int i, int i2) throws zzdok {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            int i3 = i + i2;
            char[] cArr = new char[i2];
            int i4 = 0;
            while (r13 < i3) {
                byte zza = zzdqz.zza(bArr, (long) r13);
                if (!zzdrc.zze(zza)) {
                    break;
                }
                i = r13 + 1;
                zzdrc.zza(zza, cArr, i4);
                i4++;
            }
            int i5 = i4;
            while (r13 < i3) {
                int i6 = r13 + 1;
                byte zza2 = zzdqz.zza(bArr, (long) r13);
                if (zzdrc.zze(zza2)) {
                    int i7 = i5 + 1;
                    zzdrc.zza(zza2, cArr, i5);
                    while (i6 < i3) {
                        byte zza3 = zzdqz.zza(bArr, (long) i6);
                        if (!zzdrc.zze(zza3)) {
                            break;
                        }
                        i6++;
                        zzdrc.zza(zza3, cArr, i7);
                        i7++;
                    }
                    r13 = i6;
                    i5 = i7;
                } else if (zzdrc.zzf(zza2)) {
                    if (i6 < i3) {
                        int i8 = i6 + 1;
                        zzdrc.zza(zza2, zzdqz.zza(bArr, (long) i6), cArr, i5);
                        r13 = i8;
                        i5++;
                    } else {
                        throw zzdok.zzayk();
                    }
                } else if (zzdrc.zzg(zza2)) {
                    if (i6 < i3 - 1) {
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        zzdrc.zza(zza2, zzdqz.zza(bArr, (long) i6), zzdqz.zza(bArr, (long) i9), cArr, i5);
                        r13 = i10;
                        i5++;
                    } else {
                        throw zzdok.zzayk();
                    ...
                    int i11 = i6 + 1;
                    byte zza4 = zzdqz.zza(bArr, (long) i6);
                    int i12 = i11 + 1;
                    zzdrc.zza(zza2, zza4, zzdqz.zza(bArr, (long) i11), zzdqz.zza(bArr, (long) i12), cArr, i5);
                    r13 = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzdok.zzayk();
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (charAt3 < 128 && j < j4) {
                j2 = j + 1;
                zzdqz.zza(bArr2, j, (byte) charAt3);
            } else if (charAt3 < 2048 && j <= j4 - 2) {
                long j5 = j + 1;
                zzdqz.zza(bArr2, j, (byte) ((charAt3 >>> 6) | 960));
                j = j5 + 1;
                zzdqz.zza(bArr2, j5, (byte) ((charAt3 & '?') | 128));
                i6++;
            } else if ((charAt3 < 55296 || 57343 < charAt3) && j <= j4 - 3) {
                long j6 = j + 1;
                zzdqz.zza(bArr2, j, (byte) ((charAt3 >>> 12) | 480));
                long j7 = j6 + 1;
                zzdqz.zza(bArr2, j6, (byte) (((charAt3 >>> 6) & 63) | 128));
                j2 = j7 + 1;
                zzdqz.zza(bArr2, j7, (byte) ((charAt3 & '?') | 128));
            } else if (j <= j4 - 4) {
                int i7 = i6 + 1;
                if (i7 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j8 = j + 1;
                        zzdqz.zza(bArr2, j, (byte) ((codePoint >>> 18) | PsExtractor.VIDEO_STREAM_MASK));
                        long j9 = j8 + 1;
                        zzdqz.zza(bArr2, j8, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j10 = j9 + 1;
                        zzdqz.zza(bArr2, j9, (byte) (((codePoint >>> 6) & 63) | 128));
                        j = j10 + 1;
                        zzdqz.zza(bArr2, j10, (byte) ((codePoint & 63) | 128));
                        i6 = i7;
                        i6++;
                    }
                } else {
    ...
    public final void zzb(java.lang.CharSequence r20, java.nio.ByteBuffer r21) {
        /*
            ...
            r0 = r20
            r1 = r21
            long r2 = com.google.android.gms.internal.ads.zzdqz.zzn(r21)
            int r4 = r21.position()
            long r4 = (long) r4
            long r4 = r4 + r2
            int r6 = r21.limit()
        ...
        L_0x0020:
            ...
            long r10 = r4 + r11
            byte r12 = (byte) r13
            com.google.android.gms.internal.ads.zzdqz.zza((long) r4, (byte) r12)
            int r9 = r9 + 1
            r4 = r10
            goto L_0x0020
        L_0x0036:
        ...
        L_0x003e:
            ...
            long r14 = r4 + r11
            byte r13 = (byte) r13
            com.google.android.gms.internal.ads.zzdqz.zza((long) r4, (byte) r13)
        L_0x0050:
            r4 = r11
        L_0x0051:
        ...
        L_0x0055:
            ...
            byte r10 = (byte) r10
            com.google.android.gms.internal.ads.zzdqz.zza((long) r4, (byte) r10)
            long r4 = r14 + r11
            r10 = r13 & 63
            r13 = 128(0x80, float:1.794E-43)
            r10 = r10 | r13
            byte r10 = (byte) r10
            com.google.android.gms.internal.ads.zzdqz.zza((long) r14, (byte) r10)
            r14 = r4
            goto L_0x0050
        L_0x0078:
        ...
        L_0x00b1:
            ...
            byte r15 = (byte) r15
            com.google.android.gms.internal.ads.zzdqz.zza((long) r4, (byte) r15)
            long r4 = r13 + r11
            int r15 = r9 >>> 12
            r15 = r15 & 63
            r11 = 128(0x80, float:1.794E-43)
            ...
            byte r12 = (byte) r12
            com.google.android.gms.internal.ads.zzdqz.zza((long) r13, (byte) r12)
            r12 = 1
            long r14 = r4 + r12
            int r16 = r9 >>> 6
            r12 = r16 & 63
            ...
            r9 = r9 | r11
            byte r9 = (byte) r9
            com.google.android.gms.internal.ads.zzdqz.zza((long) r14, (byte) r9)
            r9 = r10
            r14 = r12
        L_0x00ff:
            int r9 = r9 + 1
        ...
        L_0x0107:
            r9 = r10
        L_0x0108:
            com.google.android.gms.internal.ads.zzdrf r0 = new com.google.android.gms.internal.ads.zzdrf
            int r9 = r9 + -1
            r0.<init>(r9, r8)
            throw r0
        L_0x0110:
        ...
        L_0x0150:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdrg.zzb(java.lang.CharSequence, java.nio.ByteBuffer):void");
    }
