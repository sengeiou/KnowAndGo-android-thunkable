...
public class zzal {
    ...
    public static java.lang.String zza(android.content.ContentResolver r10, java.lang.String r11, java.lang.String r12) {
        /*
            ...
            monitor-enter(r12)
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzex     // Catch:{ all -> 0x00f5 }
            r1 = 1
            r2 = 0
            r3 = 0
            if (r0 != 0) goto L_0x002a
            java.util.concurrent.atomic.AtomicBoolean r0 = zzew     // Catch:{ all -> 0x00f5 }
            r0.set(r2)     // Catch:{ all -> 0x00f5 }
            java.util.HashMap r0 = new java.util.HashMap     // Catch:{ all -> 0x00f5 }
            r0.<init>()     // Catch:{ all -> 0x00f5 }
            zzex = r0     // Catch:{ all -> 0x00f5 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f5 }
            r0.<init>()     // Catch:{ all -> 0x00f5 }
            zzfc = r0     // Catch:{ all -> 0x00f5 }
            zzfd = r2     // Catch:{ all -> 0x00f5 }
            android.net.Uri r0 = CONTENT_URI     // Catch:{ all -> 0x00f5 }
            com.google.android.gms.internal.vision.zzao r4 = new com.google.android.gms.internal.vision.zzao     // Catch:{ all -> 0x00f5 }
        ...
        L_0x002a:
            ...
            java.util.HashMap<java.lang.String, java.lang.Boolean> r0 = zzey     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Integer> r0 = zzez     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Long> r0 = zzfa     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Float> r0 = zzfb     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f5 }
            r0.<init>()     // Catch:{ all -> 0x00f5 }
            zzfc = r0     // Catch:{ all -> 0x00f5 }
            zzfd = r2     // Catch:{ all -> 0x00f5 }
        L_0x0054:
            java.lang.Object r0 = zzfc     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.String> r4 = zzex     // Catch:{ all -> 0x00f5 }
            boolean r4 = r4.containsKey(r11)     // Catch:{ all -> 0x00f5 }
            if (r4 == 0) goto L_0x006c
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zzex     // Catch:{ all -> 0x00f5 }
        ...
        L_0x006a:
            ...
            return r10
        L_0x006c:
            java.lang.String[] r4 = zzfe     // Catch:{ all -> 0x00f5 }
        ...
        L_0x0070:
            ...
            boolean r0 = zzfd     // Catch:{ all -> 0x00f5 }
            if (r0 == 0) goto L_0x0086
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzex     // Catch:{ all -> 0x00f5 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00f5 }
            if (r0 == 0) goto L_0x00a9
        L_0x0086:
            java.lang.String[] r0 = zzfe     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.String> r2 = zzex     // Catch:{ all -> 0x00f5 }
            java.util.Map r10 = zza(r10, r0)     // Catch:{ all -> 0x00f5 }
            r2.putAll(r10)     // Catch:{ all -> 0x00f5 }
            zzfd = r1     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zzex     // Catch:{ all -> 0x00f5 }
