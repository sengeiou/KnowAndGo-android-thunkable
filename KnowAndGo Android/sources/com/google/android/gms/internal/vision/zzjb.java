...
final class zzjb implements Comparable<zzjb>, Map.Entry<K, V> {
    private V value;
    private final /* synthetic */ zziw zzaab;
    private final K zzaaf;

    zzjb(zziw zziw, Map.Entry<K, V> entry) {
    ...
    public final int hashCode() {
        int i = 0;
        int hashCode = this.zzaaf == null ? 0 : this.zzaaf.hashCode();
        if (this.value != null) {
