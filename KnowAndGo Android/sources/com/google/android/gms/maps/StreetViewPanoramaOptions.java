...
public final class StreetViewPanoramaOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getPanoramaId", mo22648id = 3)
    private String panoId;
    @SafeParcelable.Field(getter = "getPosition", mo22648id = 4)
    private LatLng position;
    @SafeParcelable.Field(getter = "getUseViewLifecycleInFragmentForParcel", mo22648id = 10, type = "byte")
    private Boolean zzak;
    @SafeParcelable.Field(getter = "getZoomGesturesEnabledForParcel", mo22648id = 7, type = "byte")
    private Boolean zzap = true;
    @SafeParcelable.Field(getter = "getStreetViewPanoramaCamera", mo22648id = 2)
    private StreetViewPanoramaCamera zzbx;
    @SafeParcelable.Field(getter = "getRadius", mo22648id = 5)
    private Integer zzby;
    @SafeParcelable.Field(getter = "getUserNavigationEnabledForParcel", mo22648id = 6, type = "byte")
    private Boolean zzbz = true;
    @SafeParcelable.Field(getter = "getPanningGesturesEnabledForParcel", mo22648id = 8, type = "byte")
    private Boolean zzca = true;
    @SafeParcelable.Field(getter = "getStreetNamesEnabledForParcel", mo22648id = 9, type = "byte")
    private Boolean zzcb = true;
    @SafeParcelable.Field(getter = "getSource", mo22648id = 11)
    private StreetViewSource zzcc = StreetViewSource.DEFAULT;

    @SafeParcelable.Constructor
    StreetViewPanoramaOptions(@SafeParcelable.Param(mo22651id = 2) StreetViewPanoramaCamera streetViewPanoramaCamera, @SafeParcelable.Param(mo22651id = 3) String str, @SafeParcelable.Param(mo22651id = 4) LatLng latLng, @SafeParcelable.Param(mo22651id = 5) Integer num, @SafeParcelable.Param(mo22651id = 6) byte b, @SafeParcelable.Param(mo22651id = 7) byte b2, @SafeParcelable.Param(mo22651id = 8) byte b3, @SafeParcelable.Param(mo22651id = 9) byte b4, @SafeParcelable.Param(mo22651id = 10) byte b5, @SafeParcelable.Param(mo22651id = 11) StreetViewSource streetViewSource) {
