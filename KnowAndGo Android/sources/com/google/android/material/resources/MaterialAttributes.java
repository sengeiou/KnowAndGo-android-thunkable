...
public class MaterialAttributes {
    ...
    public static int resolveMinimumAccessibleTouchTarget(@NonNull Context context) {
        return resolveDimension(context, C1641R.attr.minTouchTargetSize, C1641R.dimen.mtrl_min_touch_target_size);
    }
    ...
    public static int resolveDimension(@NonNull Context context, @AttrRes int i, @DimenRes int i2) {
        ...
        return (int) resolve.getDimension(context.getResources().getDisplayMetrics());
    }
}
