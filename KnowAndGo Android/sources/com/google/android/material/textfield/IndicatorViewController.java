...
final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C1641R.dimen.design_textinput_caption_translate_y));
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (captionViewFromDisplayState != null) {
                        ...
                        if (captionViewFromDisplayState2 != null) {
                            captionViewFromDisplayState2.setTranslationY(0.0f);
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            ...
            if (z) {
                ...
                this.errorView.setId(C1641R.C1645id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                this.helperTextView.setId(C1641R.C1645id.textinput_helper_text);
                if (this.typeface != null) {
