...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f216x = f;
        float unused2 = pathLineOperation.f217y = f2;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f217y - this.startY), (double) (this.operation.f216x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f217y - this.startY) / (this.operation.f216x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            ...
            path.lineTo(this.f216x, this.f217y);
