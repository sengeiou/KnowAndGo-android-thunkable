...
class FloatingActionButtonImpl {
    ...
    public void setRippleColor(@Nullable ColorStateList colorStateList) {
        if (this.rippleDrawable != null) {
            DrawableCompat.setTintList(this.rippleDrawable, RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        }
    }
    ...
    public final void setShapeAppearance(@NonNull ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (this.rippleDrawable instanceof Shapeable) {
            ((Shapeable) this.rippleDrawable).setShapeAppearanceModel(shapeAppearanceModel);
        }
        if (this.borderDrawable != null) {
    ...
    public void updateShapeElevation(float f) {
        if (this.shapeDrawable != null) {
            this.shapeDrawable.setElevation(f);
        }
    }
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1641R.C1642animator.design_fab_show_motion_spec);
        }
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1641R.C1642animator.design_fab_hide_motion_spec);
        }
    ...
    private abstract class ShadowAnimatorImpl extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
            ...
            FloatingActionButtonImpl.this.updateShapeElevation((float) ((int) (this.shadowSizeStart + ((this.shadowSizeEnd - this.shadowSizeStart) * valueAnimator.getAnimatedFraction()))));
        }
