...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull OnSelectionChangedListener<Long> onSelectionChangedListener) {
        View inflate = layoutInflater.inflate(C1641R.layout.mtrl_picker_text_input_date, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(C1641R.C1645id.mtrl_picker_text_input_date);
        ...
        if (this.selectedItem != null) {
            editText.setText(textInputFormat.format(this.selectedItem));
        }
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C1641R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        if (this.selectedItem == null) {
            return resources.getString(C1641R.string.mtrl_picker_date_header_unselected);
        }
        String yearMonthDay = DateStrings.getYearMonthDay(this.selectedItem.longValue());
        return resources.getString(C1641R.string.mtrl_picker_date_header_selected, new Object[]{yearMonthDay});
    }

    public int getDefaultTitleResId() {
        return C1641R.string.mtrl_picker_date_header_title;
    }
