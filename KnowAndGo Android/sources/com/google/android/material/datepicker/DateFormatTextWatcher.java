...
abstract class DateFormatTextWatcher implements TextWatcher {
    ...
    DateFormatTextWatcher(String str, DateFormat dateFormat2, @NonNull TextInputLayout textInputLayout2, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout2.getContext().getString(C1641R.string.mtrl_picker_out_of_range);
    }
    ...
    public void onTextChanged(@NonNull CharSequence charSequence, int i, int i2, int i3) {
        ...
        try {
            ...
            String string = this.textInputLayout.getContext().getString(C1641R.string.mtrl_picker_invalid_format);
            String format = String.format(this.textInputLayout.getContext().getString(C1641R.string.mtrl_picker_invalid_format_use), new Object[]{this.formatHint});
            String format2 = String.format(this.textInputLayout.getContext().getString(C1641R.string.mtrl_picker_invalid_format_example), new Object[]{this.dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))});
