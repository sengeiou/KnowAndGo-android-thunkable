...
class TextureViewPreview extends PreviewImpl {
    ...
    TextureViewPreview(Context context, ViewGroup viewGroup) {
        this.mTextureView = (TextureView) View.inflate(context, C1463R.layout.texture_view, viewGroup).findViewById(C1463R.C1466id.texture_view);
    ...
    public void configureTransform() {
        ...
        if (this.mDisplayOrientation % RotationOptions.ROTATE_180 == 90) {
