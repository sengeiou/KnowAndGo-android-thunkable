...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f1051FS = '\u001c';

    /* renamed from: GS */
    private static final char f1052GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f1053NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f1054RS = '\u001e';
        ...
        switch (i) {
            ...
            case 3:
                ...
                if (!sb.toString().startsWith("[)>\u001e01\u001d")) {
                    sb.insert(0, str + f1052GS + format + f1052GS + format2 + f1052GS);
                    break;
                } else {
                    sb.insert(9, str + f1052GS + format + f1052GS + format2 + f1052GS);
                    break;
                }
            case 4:
