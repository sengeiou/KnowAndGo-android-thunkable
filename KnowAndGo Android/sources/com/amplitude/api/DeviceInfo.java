...
public class DeviceInfo {
    ...
    private class CachedInfo {
        ...
        private String getCountry() {
            ...
            if (!C0767Utils.isEmptyString(countryFromLocation)) {
                return countryFromLocation;
            }
            String countryFromNetwork = getCountryFromNetwork();
            if (!C0767Utils.isEmptyString(countryFromNetwork)) {
        ...
        private String getAndCacheAmazonAdvertisingId() {
            ...
            this.advertisingId = Settings.Secure.getString(contentResolver, DeviceInfo.SETTING_ADVERTISING_ID);
        ...
        private String getAndCacheGoogleAdvertisingId() {
            try {
                ...
                AmplitudeLog.getLogger().mo10507w(DeviceInfo.TAG, "Google Play Services SDK not found!");
                Diagnostics.getLogger().logError("Failed to get ADID", e);
            } catch (InvocationTargetException e2) {
                AmplitudeLog.getLogger().mo10507w(DeviceInfo.TAG, "Google Play Services not available");
                Diagnostics.getLogger().logError("Failed to get ADID", e2);
            } catch (Exception e3) {
                AmplitudeLog.getLogger().mo10497e(DeviceInfo.TAG, "Encountered an error connecting to Google Play Services", e3);
        ...
        private boolean checkGPSEnabled() {
            try {
                ...
                AmplitudeLog.getLogger().mo10507w(DeviceInfo.TAG, "Google Play Services Util not found!");
                ...
                logger.mo10507w(DeviceInfo.TAG, "Error when checking for Google Play Services: " + e6);
    ...
    public Location getMostRecentLocation() {
        ...
        for (String lastKnownLocation : list) {
            try {
                ...
                AmplitudeLog.getLogger().mo10507w(TAG, "Failed to get most recent location");
