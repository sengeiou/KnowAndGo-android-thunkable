...
public class Identify {
    ...
    public Identify clearAll() {
        if (this.userPropertiesOperations.length() > 0) {
            if (!this.userProperties.contains(Constants.AMP_OP_CLEAR_ALL)) {
                AmplitudeLog.getLogger().mo10507w(TAG, String.format("Need to send $clearAll on its own Identify object without any other operations, ignoring $clearAll", new Object[0]));
            }
            return this;
        }
        try {
            ...
            AmplitudeLog.getLogger().mo10496e(TAG, e.toString());
        }
        return this;
    }

    private void addToUserProperties(String str, String str2, Object obj) {
        if (C0767Utils.isEmptyString(str2)) {
            AmplitudeLog.getLogger().mo10507w(TAG, String.format("Attempting to perform operation %s with a null or empty string property, ignoring", new Object[]{str}));
        } else if (obj == null) {
            AmplitudeLog.getLogger().mo10507w(TAG, String.format("Attempting to perform operation %s with null value for property %s, ignoring", new Object[]{str, str2}));
        } else if (this.userPropertiesOperations.has(Constants.AMP_OP_CLEAR_ALL)) {
            AmplitudeLog.getLogger().mo10507w(TAG, String.format("This Identify already contains a $clearAll operation, ignoring operation %s", new Object[]{str}));
        } else if (this.userProperties.contains(str2)) {
            AmplitudeLog.getLogger().mo10507w(TAG, String.format("Already used property %s in previous operation, ignoring operation %s", new Object[]{str2, str}));
        } else {
            try {
    ...
    private JSONArray floatArrayToJSONArray(float[] fArr) {
        ...
        for (float f : fArr) {
            try {
                ...
                AmplitudeLog.getLogger().mo10496e(TAG, String.format("Error converting float %f to JSON: %s", new Object[]{Float.valueOf(f), e.toString()}));
            }
        }
        return jSONArray;
    }
    ...
    private JSONArray doubleArrayToJSONArray(double[] dArr) {
        ...
        for (double d : dArr) {
            try {
                ...
                AmplitudeLog.getLogger().mo10496e(TAG, String.format("Error converting double %d to JSON: %s", new Object[]{Double.valueOf(d), e.toString()}));
            }
        }
        return jSONArray;
    }
    ...
    public Identify setOnce(String str, Object obj) {
        AmplitudeLog.getLogger().mo10507w(TAG, "This version of setOnce is deprecated. Please use one with a different signature.");
        return this;
    }

    public Identify set(String str, Object obj) {
        AmplitudeLog.getLogger().mo10507w(TAG, "This version of set is deprecated. Please use one with a different signature.");
        return this;
    }
