    ...
    protected static class SSLContextBuilder {
        ...
        public SSLContext build() {
            try {
                ...
                PinnedAmplitudeClient.logger.mo10497e(PinnedAmplitudeClient.TAG, e.getMessage(), e);
                return null;
            } catch (IOException e2) {
                PinnedAmplitudeClient.logger.mo10497e(PinnedAmplitudeClient.TAG, e2.getMessage(), e2);
                return null;
            }
        }
    }
            ...
            public void run() {
                if (!this.initializedSSLSocketFactory) {
                    ...
                    if (pinnedCertSslSocketFactory != null) {
                        ...
                        PinnedAmplitudeClient.logger.mo10496e(PinnedAmplitudeClient.TAG, "Unable to pin SSL as requested. Will send data without SSL pinning.");
                    }
    ...
    public SSLSocketFactory getPinnedCertSslSocketFactory(SSLContextBuilder sSLContextBuilder) {
        ...
        if (this.sslSocketFactory == null) {
            try {
                ...
                logger.mo10499i(TAG, "Pinning SSL session using Comodo CA Cert");
            } catch (Exception e) {
                logger.mo10497e(TAG, e.getMessage(), e);
            }
        }
