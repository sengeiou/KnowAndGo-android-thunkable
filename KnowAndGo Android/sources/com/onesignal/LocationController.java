...
class LocationController {
    ...
    static class LocationPoint {
        ...
        public String toString() {
            return "LocationPoint{lat=" + this.lat + ", log=" + this.log + ", accuracy=" + this.accuracy + ", type=" + this.type + ", bg=" + this.f1081bg + ", timeStamp=" + this.timeStamp + '}';
        }
    }
    ...
    protected static void fireCompleteForLocation(Location location) {
        ...
        locationPoint.f1081bg = Boolean.valueOf(OneSignal.isForeground() ^ true);
