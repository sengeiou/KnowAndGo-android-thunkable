...
class OneSignalPrefs {
    ...
    public static void saveStringSet(@NonNull String str, @NonNull String str2, @NonNull Set<String> set) {
        save(str, str2, set);
    }
    ...
    @Nullable
    public static Set<String> getStringSet(@NonNull String str, @NonNull String str2, @Nullable Set<String> set) {
