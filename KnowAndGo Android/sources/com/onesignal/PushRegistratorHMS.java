...
class PushRegistratorHMS implements PushRegistrator {
    ...
    public synchronized void getHMSTokenTask(@androidx.annotation.NonNull android.content.Context r4, @androidx.annotation.NonNull com.onesignal.PushRegistrator.RegisteredHandler r5) throws com.huawei.hms.common.ApiException {
        /*
            r3 = this;
            monitor-enter(r3)
