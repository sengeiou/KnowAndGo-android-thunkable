...
abstract class UserState {
    ...
    public void setLocation(LocationController.LocationPoint locationPoint) {
        try {
            ...
            this.dependValues.put("loc_bg", locationPoint.f1081bg);
    ...
    public void persistStateAfterSync(JSONObject jSONObject, JSONObject jSONObject2) {
        if (jSONObject != null) {
            generateJsonDiff(this.dependValues, jSONObject, this.dependValues, (Set<String>) null);
        }
        if (jSONObject2 != null) {
            generateJsonDiff(this.syncValues, jSONObject2, this.syncValues, (Set<String>) null);
    ...
    public void mergeTags(org.json.JSONObject r7, org.json.JSONObject r8) {
        ...
        L_0x0064:
            ...
            org.json.JSONObject r7 = r6.syncValues     // Catch:{ Throwable -> 0x007f }
