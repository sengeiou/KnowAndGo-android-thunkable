...
public class RNGestureHandlerButtonViewManager extends ViewGroupManager<ButtonViewGroup> {
    ...
    static class ButtonViewGroup extends ViewGroup {
        ...
        private Drawable createSelectableDrawable() {
            ...
            getContext().getTheme().resolveAttribute(getResources().getIdentifier((!this.mUseBorderless || i < 21) ? "selectableItemBackground" : "selectableItemBackgroundBorderless", "attr", DeviceInfo.OS_NAME), sResolveOutValue, true);
            if (i >= 21) {
