...
public class RNFetchBlobUtils {
    ...
    public static void emitWarningEvent(String str) {
        ...
        ((DeviceEventManagerModule.RCTDeviceEventEmitter) C0623RNFetchBlob.RCTContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)).emit(RNFetchBlobConst.EVENT_MESSAGE, createMap);
    }

    public static OkHttpClient.Builder getUnsafeOkHttpClient(OkHttpClient okHttpClient) {
        try {
            C06441 r0 = new X509TrustManager() {
