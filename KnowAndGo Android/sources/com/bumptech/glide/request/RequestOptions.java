...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, mo1047to = 1.0d) float f) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, mo1065to = 100) int i) {
