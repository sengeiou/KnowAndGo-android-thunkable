...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0051, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r4, r1.f79cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004b:
            ...
            com.bumptech.glide.request.ResourceCallback r1 = r1.f79cb
            r3.<init>(r1)
            r2.execute(r3)
            goto L_0x004b
        L_0x0064:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r4, r1.f79cb));
     */
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f77cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f77cb = resourceCallback;
        }

        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f77cb)) {
                    EngineJob.this.callCallbackOnLoadFailed(this.f77cb);
                }
    ...
    private class CallResourceReady implements Runnable {
        ...
        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f78cb)) {
                    EngineJob.this.engineResource.acquire();
                    EngineJob.this.callCallbackOnResourceReady(this.f78cb);
                    EngineJob.this.removeCallback(this.f78cb);
                }
                EngineJob.this.decrementPendingCallbacks();
            }
        }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f79cb.equals(((ResourceCallbackAndExecutor) obj).f79cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f79cb.hashCode();
        }
    }
