...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f67CR = 13;

    /* renamed from: LF */
    private static final byte f68LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f69in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f69in) {
            if (this.buf != null) {
                ...
                C08581 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        int read = this.f69in.read(this.buf, 0, this.buf.length);
        if (read != -1) {
            this.pos = 0;
            this.end = read;
            return;
