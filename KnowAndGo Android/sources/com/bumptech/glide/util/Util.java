...
public final class Util {
    ...
    private static int getBytesPerPixel(@Nullable Bitmap.Config config) {
        ...
        switch (C09051.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
                return 1;
            case 2:
            case 3:
    ...
    static /* synthetic */ class C09051 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C09051.<clinit>():void");
        }
    }
