...
public class ImageResizerModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void createResizedImage(String str, int i, int i2, String str2, int i3, int i4, String str3, boolean z, Callback callback, Callback callback2) {
        ...
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                try {
                    ImageResizerModule.this.createResizedImageWithExceptions(str4, i5, i6, str5, i7, i8, str6, z2, callback3, callback4);
                } catch (IOException e) {
    ...
    public void createResizedImageWithExceptions(String str, int i, int i2, String str2, int i3, int i4, String str3, boolean z, Callback callback, Callback callback2) throws IOException {
        String str4 = str3;
        Bitmap.CompressFormat valueOf = Bitmap.CompressFormat.valueOf(str2);
        Uri parse = Uri.parse(str);
        Bitmap createResizedImage = ImageResizer.createResizedImage(this.context, parse, i, i2, i3, i4);
        if (createResizedImage != null) {
            ...
            int i5 = i3;
            File saveImage = ImageResizer.saveImage(createResizedImage, cacheDir, Long.toString(new Date().getTime()), valueOf, i3);
            if (saveImage.isFile()) {
