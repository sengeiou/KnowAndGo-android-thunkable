...
public class Status implements Serializable {
    ...
    public Status() {
        errorDescriptions.put(Integer.valueOf(StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB), "Some required parameter is missing or has wrong value. Details will be in the errorDetails field.");
        errorTypes.put(Integer.valueOf(StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB), "bad_request");
