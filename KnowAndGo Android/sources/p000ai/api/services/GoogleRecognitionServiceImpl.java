...
public class GoogleRecognitionServiceImpl extends AIService {
    ...
    public static final String TAG = "ai.api.services.GoogleRecognitionServiceImpl";
    /* access modifiers changed from: private */
    public final Map<Integer, String> errorMessages = new HashMap();
    ...
    public GoogleRecognitionServiceImpl(Context context, AIConfiguration aIConfiguration) {
        ...
        if (this.versionConfig.isAutoStopRecognizer()) {
    ...
    public void initializeRecognizer() {
        if (this.speechRecognizer == null) {
            synchronized (this.speechRecognizerLock) {
                ...
                this.speechRecognizer = SpeechRecognizer.createSpeechRecognizer(this.context, RecognizerChecker.findGoogleRecognizer(this.context));
    ...
    /* access modifiers changed from: private */
    public void sendRequest(@NonNull AIRequest aIRequest, @Nullable final RequestExtras requestExtras2) {
        if (aIRequest != null) {
    ...
    public void onPartialResults(List<String> list) {
        if (this.partialResultsListener != null) {
            this.partialResultsListener.onPartialResults(list);
        }
    }
