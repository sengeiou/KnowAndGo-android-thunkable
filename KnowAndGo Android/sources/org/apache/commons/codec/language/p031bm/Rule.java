package org.apache.commons.codec.language.p031bm;
...
import org.apache.commons.codec.language.p031bm.Languages;
                ...
                if (nextLine.startsWith("/*")) {
                    ...
                    if (trim.length() == 0) {
                        ...
                        if (!trim2.contains(StringUtils.SPACE)) {
                            ...
                            hashMap.putAll(parseRules(createScanner, str2 + "->" + trim2));
                        } else {
                            throw new IllegalArgumentException("Malformed import statement '" + nextLine + "' in " + str2);
                        }
                    } else {
                        ...
                        if (split.length == 4) {
                            try {
                                ...
                                C39202 r1 = new Rule(stripQuotes, stripQuotes2, stripQuotes3, parsePhonemeExpr(stripQuotes(split[3]))) {
                                ...
                                throw new IllegalStateException("Problem parsing line '" + i3 + "' in " + str2, e);
                            }
                        } else {
                            throw new IllegalArgumentException("Malformed rule statement split into " + split.length + " parts: " + nextLine + " in " + str2);
                        }
                    }
                }
                i2 = i3;
