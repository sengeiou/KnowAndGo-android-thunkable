...
public class QuotedPrintableCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
    ...
    /* renamed from: CR */
    private static final byte f3021CR = 13;
    private static final byte ESCAPE_CHAR = 61;

    /* renamed from: LF */
    private static final byte f3022LF = 10;
    ...
    public static final byte[] decodeQuotedPrintable(byte[] bArr) throws DecoderException {
        ...
        while (i < bArr.length) {
            ...
            if (b == 61) {
                ...
                try {
                    if (bArr[i] != 13) {
                        int digit16 = C3929Utils.digit16(bArr[i]);
                        i++;
                        byteArrayOutputStream.write((char) ((digit16 << 4) + C3929Utils.digit16(bArr[i])));
                    }
