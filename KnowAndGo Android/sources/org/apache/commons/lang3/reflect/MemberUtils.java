...
abstract class MemberUtils {
    ...
    static int compareConstructorFit(Constructor<?> constructor, Constructor<?> constructor2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m2500of(constructor), Executable.m2500of(constructor2), clsArr);
    }

    static int compareMethodFit(Method method, Method method2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m2501of(method), Executable.m2501of(method2), clsArr);
    }
    ...
    static boolean isMatchingMethod(Method method, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m2501of(method), clsArr);
    }

    static boolean isMatchingConstructor(Constructor<?> constructor, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m2500of(constructor), clsArr);
    }
    ...
    private static final class Executable {
        ...
        /* renamed from: of */
        public static Executable m2501of(Method method) {
            return new Executable(method);
        }

        /* access modifiers changed from: private */
        /* renamed from: of */
        public static Executable m2500of(Constructor<?> constructor) {
