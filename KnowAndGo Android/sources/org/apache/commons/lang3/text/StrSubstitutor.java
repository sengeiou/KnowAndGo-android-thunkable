...
public class StrSubstitutor {
    ...
    private int substitute(StrBuilder strBuilder, int i, int i2, List<String> list) {
        ...
        int i9 = 0;
        while (i7 < i6) {
            int isMatch2 = variablePrefixMatcher.isMatch(cArr, i7, i4, i6);
            if (isMatch2 != 0) {
                if (i7 > i4) {
                    int i10 = i7 - 1;
                ...
                while (true) {
                    if (i12 >= i6) {
                        ...
                        i7 = i12;
                        break;
                    } else if (!isEnableSubstitutionInVariables || (isMatch = variablePrefixMatcher.isMatch(cArr, i12, i4, i6)) == 0) {
                        ...
                        if (isMatch3 == 0) {
                            ...
                            strMatcher2 = variableSuffixMatcher;
                            c = escapeChar2;
                            String str2 = new String(cArr, i11, (i12 - i7) - isMatch2);
                            if (isEnableSubstitutionInVariables) {
                                StrBuilder strBuilder3 = new StrBuilder(str2);
                                substitute(strBuilder3, 0, strBuilder3.length());
                                str2 = strBuilder3.toString();
                            }
                            int i15 = i12 + isMatch3;
                            if (valueDelimiterMatcher2 != null) {
                                char[] charArray = str2.toCharArray();
                                i3 = i8;
                                int i16 = 0;
                                while (i16 < charArray.length && (isEnableSubstitutionInVariables || variablePrefixMatcher.isMatch(charArray, i16, i16, charArray.length) == 0)) {
                                    int isMatch4 = valueDelimiterMatcher2.isMatch(charArray, i16);
                                    if (isMatch4 != 0) {
                                        strMatcher = variablePrefixMatcher;
                                        String substring = str2.substring(0, i16);
                                        str = str2.substring(i16 + isMatch4);
                                        str2 = substring;
                                        break;
                                    }
                                    i16++;
                            ...
                            list2.add(str2);
                            String resolveVariable = resolveVariable(str2, strBuilder2, i7, i15);
                            if (resolveVariable == null) {
                                resolveVariable = str;
                            }
                            if (resolveVariable != null) {
                                int length = resolveVariable.length();
                                strBuilder2.replace(i7, i15, resolveVariable);
                                int substitute = (substitute(strBuilder2, i7, length, list2) + length) - (i15 - i7);
                                i15 += substitute;
                                i6 += substitute;
                                i9 += substitute;
                                cArr = strBuilder2.buffer;
