...
public class StringUtils {
    ...
    /* renamed from: CR */
    public static final String f3031CR = "\r";
    public static final String EMPTY = "";
    public static final int INDEX_NOT_FOUND = -1;

    /* renamed from: LF */
    public static final String f3032LF = "\n";
    ...
    private static int ordinalIndexOf(java.lang.CharSequence r3, java.lang.CharSequence r4, int r5, boolean r6) {
        ...
        L_0x001c:
            ...
            int r0 = r0 + -1
            int r0 = org.apache.commons.lang3.CharSequenceUtils.lastIndexOf((java.lang.CharSequence) r3, (java.lang.CharSequence) r4, (int) r0)
            goto L_0x002b
        L_0x0025:
            int r0 = r0 + 1
            int r0 = org.apache.commons.lang3.CharSequenceUtils.indexOf((java.lang.CharSequence) r3, (java.lang.CharSequence) r4, (int) r0)
        L_0x002b:
    ...
    public static int getLevenshteinDistance(CharSequence charSequence, CharSequence charSequence2, int i) {
        ...
        if (charSequence == null || charSequence2 == null) {
            ...
            if (length == 0) {
                ...
                return -1;
            } else if (Math.abs(length - length2) > i3) {
                return -1;
            } else {
                if (length > length2) {
                ...
                while (i8 <= length2) {
                    ...
                    iArr4[c] = i8;
                    int max = Math.max(1, i8 - i3);
                    if (i8 > i7 - i3) {
                        i2 = length;
                    } else {
                        i2 = Math.min(length, i8 + i3);
                    }
                    if (max > i2) {
                        return -1;
                    }
                    ...
                    while (max <= i2) {
                        ...
                        if (charSequence3.charAt(i9) == charAt) {
                            ...
                            iArr4[max] = Math.min(Math.min(iArr4[i9], iArr3[max]), iArr3[i9]) + 1;
                        }
                        max++;
                    }
                    i8++;
    ...
    public static String normalizeSpace(String str) {
        ...
        return new String(cArr, 0, i3 - i).trim();
    }
