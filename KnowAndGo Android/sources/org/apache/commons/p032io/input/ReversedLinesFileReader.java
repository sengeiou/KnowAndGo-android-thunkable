...
import org.apache.commons.p032io.Charsets;
...
public class ReversedLinesFileReader implements Closeable {
    ...
    private class FilePart {
        ...
        public FilePart rollOver() throws IOException {
            ...
            } else if (this.f3028no > 1) {
                return new FilePart(this.f3028no - 1, ReversedLinesFileReader.this.blockSize, this.leftOver);
            } else {
