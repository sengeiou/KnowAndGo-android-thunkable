...
public interface Package {
    ...
    public final /* synthetic */ class CC {
        public static List $default$createInternalModules(Package packageR, Context context) {
            return Collections.emptyList();
        }

        public static List $default$createExportedModules(Package packageR, Context context) {
            return Collections.emptyList();
        }

        public static List $default$createViewManagers(Package packageR, Context context) {
            return Collections.emptyList();
        }

        public static List $default$createSingletonModules(Package packageR, Context context) {
            return Collections.emptyList();
        }
    }
}
