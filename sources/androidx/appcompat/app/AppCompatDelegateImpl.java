...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
        ...
        if (obtainStyledAttributes.hasValue(C0064R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0064R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0064R.layout.abc_screen_simple, (ViewGroup) null);
                }
                ...
                this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0064R.C0067id.decor_content_parent);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(@androidx.annotation.NonNull androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x0016:
            ...
            if (r0 != 0) goto L_0x0026
            androidx.appcompat.app.AppCompatCallback r0 = r7.mAppCompatCallback     // Catch:{ AbstractMethodError -> 0x0026 }
            androidx.appcompat.view.ActionMode r0 = r0.onWindowStartingSupportActionMode(r8)     // Catch:{ AbstractMethodError -> 0x0026 }
            goto L_0x0027
        L_0x0026:
            r0 = r1
        L_0x0027:
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        View decorView;
        boolean z = true;
        if (((this.mHost instanceof KeyEventDispatcher.Component) || (this.mHost instanceof AppCompatDialog)) && (decorView = this.mWindow.getDecorView()) != null && KeyEventDispatcher.dispatchBeforeHierarchy(decorView, keyEvent)) {
            return true;
        }
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0064R.C0065color.abc_input_method_navigation_guard));
    ...
    private boolean updateForNightMode(int i, boolean z) {
        ...
        boolean z2 = false;
        if ((sAlwaysOverrideConfiguration || i2 != i3) && !isActivityManifestHandlingUiMode && Build.VERSION.SDK_INT >= 17 && !this.mBaseContextAttached && (this.mHost instanceof android.view.ContextThemeWrapper)) {
        ...
        if (!z2 && i4 != i2 && z && !isActivityManifestHandlingUiMode && this.mBaseContextAttached && ((Build.VERSION.SDK_INT >= 17 || this.mCreated) && (this.mHost instanceof Activity))) {
            ActivityCompat.recreate((Activity) this.mHost);
            z2 = true;
        }
        if (!z2 && i4 != i2) {
            updateResourcesConfigurationForNightMode(i2, isActivityManifestHandlingUiMode);
            z2 = true;
        }
        if (z2 && (this.mHost instanceof AppCompatActivity)) {
            ((AppCompatActivity) this.mHost).onNightModeChanged(i);
        }
        return z2;
    }
    ...
    protected static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0064R.layout.abc_list_menu_item_layout);
