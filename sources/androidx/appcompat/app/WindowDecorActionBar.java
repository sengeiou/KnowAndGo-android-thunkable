...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0064R.C0067id.decor_content_parent);
        ...
        this.mContainerView = (ActionBarContainer) view.findViewById(C0064R.C0067id.action_bar_container);
