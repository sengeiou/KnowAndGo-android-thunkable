...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0064R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        }
        ...
        this.mActivityChooserContent = findViewById(C0064R.C0067id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0064R.C0067id.default_activity_button);
        ...
        FrameLayout frameLayout = (FrameLayout) findViewById(C0064R.C0067id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0064R.C0067id.image);
