...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0064R.layout.abc_tooltip, (ViewGroup) null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0064R.C0067id.message);
