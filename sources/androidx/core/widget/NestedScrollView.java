...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
            ...
            case 2:
                ...
                if (findPointerIndex != -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        dispatchNestedScroll(0, scrollY2, 0, i3 - scrollY2, this.mScrollOffset, 0, this.mScrollConsumed);
                        ...
                        if (z2) {
                            ...
                            int i6 = scrollY + i5;
                            if (i6 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, ((float) i5) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i6 > i4) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) i5) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
    ...
    public void computeScroll() {
        if (!this.mScroller.isFinished()) {
            ...
            boolean z = false;
            this.mScrollConsumed[1] = 0;
            dispatchNestedPreScroll(0, i, this.mScrollConsumed, (int[]) null, 1);
