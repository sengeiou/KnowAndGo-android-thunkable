...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public boolean perform(android.view.View r6, android.os.Bundle r7) {
            /*
                ...
                java.lang.Class<? extends androidx.core.view.accessibility.AccessibilityViewCommand$CommandArguments> r2 = r5.mViewCommandArgumentClass     // Catch:{ Exception -> 0x0022 }
                java.lang.Class[] r3 = new java.lang.Class[r1]     // Catch:{ Exception -> 0x0022 }
                java.lang.reflect.Constructor r2 = r2.getDeclaredConstructor(r3)     // Catch:{ Exception -> 0x0022 }
                java.lang.Object[] r1 = new java.lang.Object[r1]     // Catch:{ Exception -> 0x0022 }
                java.lang.Object r1 = r2.newInstance(r1)     // Catch:{ Exception -> 0x0022 }
                androidx.core.view.accessibility.AccessibilityViewCommand$CommandArguments r1 = (androidx.core.view.accessibility.AccessibilityViewCommand.CommandArguments) r1     // Catch:{ Exception -> 0x0022 }
                r1.setBundle(r7)     // Catch:{ Exception -> 0x001f }
                r0 = r1
                goto L_0x0046
            L_0x001f:
                r7 = move-exception
            ...
            L_0x0022:
                r7 = move-exception
            L_0x0023:
                java.lang.Class<? extends androidx.core.view.accessibility.AccessibilityViewCommand$CommandArguments> r1 = r5.mViewCommandArgumentClass
            ...
            L_0x0046:
                androidx.core.view.accessibility.AccessibilityViewCommand r7 = r5.mCommand
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT >= 19 && Build.VERSION.SDK_INT < 26) {
            ...
            if (clickableSpans != null && clickableSpans.length > 0) {
                getExtras().putInt(SPANS_ACTION_ID_KEY, C0199R.C0202id.accessibility_action_clickable_span);
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        view.setTag(C0199R.C0202id.tag_accessibility_clickable_spans, sparseArray);
        return sparseArray;
    }

    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C0199R.C0202id.tag_accessibility_clickable_spans);
    }
