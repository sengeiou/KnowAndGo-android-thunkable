...
public final class FragmentContainerView extends FrameLayout {
    ...
    FragmentContainerView(@NonNull Context context, @NonNull AttributeSet attributeSet, @NonNull FragmentManager fragmentManager) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0270R.styleable.FragmentContainerView);
        classAttribute = classAttribute == null ? obtainStyledAttributes.getString(C0270R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string = obtainStyledAttributes.getString(C0270R.styleable.FragmentContainerView_android_tag);
    ...
    private void addDisappearingFragmentView(@NonNull View view) {
        if (view.getAnimation() != null || (this.mTransitioningFragmentViews != null && this.mTransitioningFragmentViews.contains(view))) {
