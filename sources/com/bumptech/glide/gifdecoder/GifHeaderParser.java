...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f72ix = readShort();
        this.header.currentFrame.f73iy = readShort();
        this.header.currentFrame.f71iw = readShort();
        this.header.currentFrame.f70ih = readShort();
        int read = read();
        boolean z = false;
