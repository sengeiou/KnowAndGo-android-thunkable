...
public final class RoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f88ID = "com.bumptech.glide.load.resource.bitmap.RoundedCorners";
    ...
    public int hashCode() {
        return Util.hashCode(f88ID.hashCode(), Util.hashCode(this.roundingRadius));
    }
