...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        ...
        switch (C08741.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C08741 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C08741.<clinit>():void");
        }
    }
}
