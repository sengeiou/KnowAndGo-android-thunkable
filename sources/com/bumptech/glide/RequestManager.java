...
public class RequestManager implements LifecycleListener, ModelTypes<RequestBuilder<Drawable>> {
    ...
    public RequestBuilder<Bitmap> asBitmap() {
        return mo11420as(Bitmap.class).apply((BaseRequestOptions<?>) DECODE_TYPE_BITMAP);
    }

    @CheckResult
    @NonNull
    public RequestBuilder<GifDrawable> asGif() {
        return mo11420as(GifDrawable.class).apply((BaseRequestOptions<?>) DECODE_TYPE_GIF);
    }

    @CheckResult
    @NonNull
    public RequestBuilder<Drawable> asDrawable() {
        return mo11420as(Drawable.class);
    }
    ...
    public RequestBuilder<File> downloadOnly() {
        return mo11420as(File.class).apply((BaseRequestOptions<?>) DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    public RequestBuilder<File> asFile() {
        return mo11420as(File.class).apply((BaseRequestOptions<?>) RequestOptions.skipMemoryCacheOf(true));
    }

    @CheckResult
    @NonNull
    /* renamed from: as */
    public <ResourceType> RequestBuilder<ResourceType> mo11420as(@NonNull Class<ResourceType> cls) {
