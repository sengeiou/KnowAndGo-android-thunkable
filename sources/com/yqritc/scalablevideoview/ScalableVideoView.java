...
public class ScalableVideoView extends TextureView implements TextureView.SurfaceTextureListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public ScalableVideoView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null && (obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C3360R.styleable.scaleStyle, 0, 0)) != null) {
            int i2 = obtainStyledAttributes.getInt(C3360R.styleable.scaleStyle_scalableType, ScalableType.NONE.ordinal());
