...
public class C0623RNFetchBlob extends ReactContextBaseJavaModule {
    ...
    public C0623RNFetchBlob(ReactApplicationContext reactApplicationContext) {
        ...
        reactApplicationContext.addActivityEventListener(new ActivityEventListener() {
            ...
            public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
                if (i == RNFetchBlobConst.GET_CONTENT_INTENT.intValue() && i2 == -1) {
                    ((Promise) C0623RNFetchBlob.promiseTable.get(RNFetchBlobConst.GET_CONTENT_INTENT.intValue())).resolve(intent.getData().toString());
                    C0623RNFetchBlob.promiseTable.remove(RNFetchBlobConst.GET_CONTENT_INTENT.intValue());
                }
            }
        });
    }
    ...
    public void actionViewIntent(String str, String str2, final Promise promise) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                dataAndType.addFlags(C1470C.ENCODING_PCM_MU_LAW);
                ...
                getReactApplicationContext().startActivity(intent.setDataAndType(Uri.parse("file://" + str), str2).setFlags(C1470C.ENCODING_PCM_MU_LAW));
            }
            ...
            RCTContext.addLifecycleEventListener(new LifecycleEventListener() {
                ...
                public void onHostResume() {
                    if (C0623RNFetchBlob.ActionViewVisible) {
                        promise.resolve((Object) null);
                    }
                    C0623RNFetchBlob.RCTContext.removeLifecycleEventListener(this);
                }
            });
        } catch (Exception e) {
    ...
    @ReactMethod
    /* renamed from: cp */
    public void mo9300cp(final String str, final String str2, final Callback callback) {
        threadPool.execute(new Runnable() {
            public void run() {
    ...
    @ReactMethod
    /* renamed from: mv */
    public void mo9316mv(String str, String str2, Callback callback) {
        RNFetchBlobFS.m17mv(str, str2, callback);
    }

    @ReactMethod
    /* renamed from: ls */
    public void mo9313ls(String str, Promise promise) {
    ...
    @ReactMethod
    /* renamed from: df */
    public void mo9303df(final Callback callback) {
        fsThreadPool.execute(new Runnable() {
            public void run() {
