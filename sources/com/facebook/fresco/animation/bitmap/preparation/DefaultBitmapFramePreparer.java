...
public class DefaultBitmapFramePreparer implements BitmapFramePreparer {
    ...
    public boolean prepareFrame(BitmapFrameCache bitmapFrameCache, AnimationBackend animationBackend, int i) {
        ...
        synchronized (this.mPendingFrameDecodeJobs) {
            if (this.mPendingFrameDecodeJobs.get(uniqueId) != null) {
                FLog.m83v(TAG, "Already scheduled decode job for frame %d", (Object) Integer.valueOf(i));
                return true;
            } else if (bitmapFrameCache.contains(i)) {
                FLog.m83v(TAG, "Frame %d is cached already.", (Object) Integer.valueOf(i));
                return true;
            } else {
    ...
    private class FrameDecodeRunnable implements Runnable {
        ...
        public void run() {
            try {
                if (this.mBitmapFrameCache.contains(this.mFrameNumber)) {
                    FLog.m83v((Class<?>) DefaultBitmapFramePreparer.TAG, "Frame %d is cached already.", (Object) Integer.valueOf(this.mFrameNumber));
                ...
                if (prepareFrameAndCache(this.mFrameNumber, 1)) {
                    FLog.m83v((Class<?>) DefaultBitmapFramePreparer.TAG, "Prepared frame frame %d.", (Object) Integer.valueOf(this.mFrameNumber));
                } else {
                    FLog.m60e((Class<?>) DefaultBitmapFramePreparer.TAG, "Could not prepare frame %d.", Integer.valueOf(this.mFrameNumber));
                }
                synchronized (DefaultBitmapFramePreparer.this.mPendingFrameDecodeJobs) {
                    DefaultBitmapFramePreparer.this.mPendingFrameDecodeJobs.remove(this.mHashCode);
                }
            ...
            switch (i2) {
                ...
                case 2:
                    try {
                        ...
                        FLog.m99w((Class<?>) DefaultBitmapFramePreparer.TAG, "Failed to create frame bitmap", (Throwable) e);
        ...
        private boolean renderFrameAndCache(int i, CloseableReference<Bitmap> closeableReference, int i2) {
            ...
            FLog.m83v((Class<?>) DefaultBitmapFramePreparer.TAG, "Frame %d ready.", (Object) Integer.valueOf(this.mFrameNumber));
            synchronized (DefaultBitmapFramePreparer.this.mPendingFrameDecodeJobs) {
