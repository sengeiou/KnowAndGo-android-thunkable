    ...
    static /* synthetic */ class C11161 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imageutils.BitmapUtil.C11161.<clinit>():void");
        }
    }

    public static int getPixelSizeForBitmapConfig(Bitmap.Config config) {
        switch (C11161.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
                return 4;
            case 2:
                return 1;
