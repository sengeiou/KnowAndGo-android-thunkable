...
public class HeifExifUtil {
    ...
    public static int getOrientation(InputStream inputStream) {
        ...
        FLog.m50d(TAG, "Trying to read Heif Exif information before Android N -> ignoring");
        return 0;
    }
    ...
    private static class HeifExifUtilAndroidN {
        ...
        static int getOrientation(InputStream inputStream) {
            try {
                ...
                FLog.m55d(HeifExifUtil.TAG, "Failed reading Heif Exif orientation -> ignoring", (Throwable) e);
                return 0;
            }
        }
    }
