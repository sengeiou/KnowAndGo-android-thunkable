...
public class ProducerSequenceFactory {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:29:0x0067 A[FINALLY_INSNS] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public com.facebook.imagepipeline.producers.Producer<com.facebook.common.references.CloseableReference<com.facebook.common.memory.PooledByteBuffer>> getEncodedImageProducerSequence(com.facebook.imagepipeline.request.ImageRequest r4) {
        /*
            r3 = this;
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()     // Catch:{ all -> 0x0060 }
            if (r0 == 0) goto L_0x000b
            java.lang.String r0 = "ProducerSequenceFactory#getEncodedImageProducerSequence"
            com.facebook.imagepipeline.systrace.FrescoSystrace.beginSection(r0)     // Catch:{ all -> 0x0060 }
        L_0x000b:
            validateEncodedImageRequest(r4)     // Catch:{ all -> 0x0060 }
            android.net.Uri r0 = r4.getSourceUri()     // Catch:{ all -> 0x0060 }
            int r4 = r4.getSourceUriType()     // Catch:{ all -> 0x0060 }
        ...
        L_0x001b:
            java.lang.IllegalArgumentException r4 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x0060 }
            ...
            java.lang.String r0 = getShortenedUriString(r0)     // Catch:{ all -> 0x0060 }
        ...
        L_0x0036:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getLocalContentUriFetchEncodedImageProducerSequence()     // Catch:{ all -> 0x0060 }
        ...
        L_0x0043:
            return r4
        L_0x0044:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getLocalFileFetchEncodedImageProducerSequence()     // Catch:{ all -> 0x0060 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
        ...
        L_0x0051:
            return r4
        L_0x0052:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getNetworkFetchEncodedImageProducerSequence()     // Catch:{ all -> 0x0060 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
