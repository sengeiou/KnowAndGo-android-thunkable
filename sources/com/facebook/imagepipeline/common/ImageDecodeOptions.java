...
public class ImageDecodeOptions {
    ...
    public int hashCode() {
        int i = 0;
        int ordinal = ((((((((((((((((this.minDecodeIntervalMs * 31) + this.maxDimensionPx) * 31) + (this.decodePreviewFrame ? 1 : 0)) * 31) + (this.useLastFrameForPreview ? 1 : 0)) * 31) + (this.decodeAllFrames ? 1 : 0)) * 31) + (this.forceStaticImage ? 1 : 0)) * 31) + this.bitmapConfig.ordinal()) * 31) + (this.customImageDecoder != null ? this.customImageDecoder.hashCode() : 0)) * 31) + (this.bitmapTransformation != null ? this.bitmapTransformation.hashCode() : 0)) * 31;
        if (this.colorSpace != null) {
            i = this.colorSpace.hashCode();
        }
        return ordinal + i;
    }
