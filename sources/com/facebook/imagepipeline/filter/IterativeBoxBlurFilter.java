...
public abstract class IterativeBoxBlurFilter {
    ...
    public static void boxBlurBitmapInPlace(Bitmap bitmap, int i, int i2) {
        ...
        try {
            ...
            FLog.m62e(TAG, String.format((Locale) null, "OOM: %d iterations on %dx%d with %d radius", new Object[]{Integer.valueOf(i), Integer.valueOf(bitmap.getWidth()), Integer.valueOf(bitmap.getHeight()), Integer.valueOf(i2)}));
            throw e;
        }
    }
