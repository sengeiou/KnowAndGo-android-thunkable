...
public abstract class CloseableReference<T> implements Cloneable, Closeable {
    ...
    private static final LeakHandler DEFAULT_LEAK_HANDLER = new LeakHandler() {
        ...
        public void reportLeak(SharedReference<Object> sharedReference, @Nullable Throwable th) {
            FLog.m100w((Class<?>) CloseableReference.TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(sharedReference)), sharedReference.get().getClass().getName());
        }
    };
    ...
    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m126of(@PropagatesNullable T t) {
        return m128of(t, DEFAULT_CLOSEABLE_RELEASER);
    }

    /* renamed from: of */
    public static <T> CloseableReference<T> m128of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser) {
        return m129of(t, resourceReleaser, DEFAULT_LEAK_HANDLER);
    }

    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m127of(@PropagatesNullable T t, LeakHandler leakHandler) {
        Throwable th = null;
        if (t == null) {
            return null;
        }
        ...
        return m130of(t, resourceReleaser, leakHandler, th);
    }

    /* renamed from: of */
    public static <T> CloseableReference<T> m129of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler) {
        Throwable th = null;
        if (t == null) {
            return null;
        }
    ...
    /* renamed from: of */
    public static <T> CloseableReference<T> m130of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler, @Nullable Throwable th) {
        if (t == null) {
            return null;
        }
