...
public class DraweeHolder<DH extends DraweeHierarchy> implements VisibilityCallback {
    ...
    public void onDraw() {
        if (!this.mIsControllerAttached) {
            FLog.m100w((Class<?>) DraweeEventTracker.class, "%x: Draw requested for a non-attached controller %x. %s", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(this.mController)), toString());
            this.mIsHolderAttached = true;
