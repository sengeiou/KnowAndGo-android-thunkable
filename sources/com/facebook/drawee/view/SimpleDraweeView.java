...
import com.facebook.drawee.C0970R;
    ...
    private void init(Context context, @Nullable AttributeSet attributeSet) {
        ...
        try {
            ...
            if (attributeSet != null) {
                obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0970R.styleable.SimpleDraweeView);
                if (obtainStyledAttributes.hasValue(C0970R.styleable.SimpleDraweeView_actualImageUri)) {
                    setImageURI(Uri.parse(obtainStyledAttributes.getString(C0970R.styleable.SimpleDraweeView_actualImageUri)), (Object) null);
                } else if (obtainStyledAttributes.hasValue(C0970R.styleable.SimpleDraweeView_actualImageResource) && (resourceId = obtainStyledAttributes.getResourceId(C0970R.styleable.SimpleDraweeView_actualImageResource, -1)) != -1) {
                    if (isInEditMode()) {
