...
public class ForwardingControllerListener<INFO> implements ControllerListener<INFO>, OnDrawControllerListener<INFO> {
    ...
    /* renamed from: of */
    public static <INFO> ForwardingControllerListener<INFO> m131of(ControllerListener<? super INFO> controllerListener) {
    ...
    /* renamed from: of */
    public static <INFO> ForwardingControllerListener<INFO> m132of(ControllerListener<? super INFO> controllerListener, ControllerListener<? super INFO> controllerListener2) {
        ForwardingControllerListener<INFO> create = create();
        create.addListener(controllerListener);
