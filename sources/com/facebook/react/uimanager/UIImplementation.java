...
public class UIImplementation {
    ...
    public void updateRootView(int i, int i2, int i3) {
        ...
        if (node == null) {
            FLog.m102w(ReactConstants.TAG, "Tried to update non-existent root tag: " + i);
            return;
        }
    ...
    public void updateNodeSize(int i, int i2, int i3) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            FLog.m102w(ReactConstants.TAG, "Tried to update size of non-existent tag: " + i);
            return;
        }
    ...
    public void setViewLocalData(int i, Object obj) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            FLog.m102w(ReactConstants.TAG, "Attempt to set local data for view with unknown tag: " + i);
            return;
        }
    ...
    public int resolveRootTagFromReactTag(int i) {
        ...
        FLog.m102w(ReactConstants.TAG, "Warning : attempted to resolve a non-existent react shadow node. reactTag=" + i);
        return 0;
    }
