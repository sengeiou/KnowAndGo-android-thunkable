...
public class ImageEditingManager extends ReactContextBaseJavaModule {
    ...
    private static class CropTask extends GuardedAsyncTask<Void, Void> {
        ...
        private Bitmap crop(BitmapFactory.Options options) throws IOException {
            ...
            try {
                return newInstance.decodeRegion(new Rect(this.f113mX, this.f114mY, this.f113mX + this.mWidth, this.f114mY + this.mHeight), options);
            } finally {
        ...
        private Bitmap cropAndResize(int i, int i2, BitmapFactory.Options options) throws IOException {
            ...
            try {
                ...
                if (((float) this.mWidth) / ((float) this.mHeight) > f8) {
                    ...
                    f2 = ((float) this.f113mX) + ((((float) this.mWidth) - f5) / 2.0f);
                    f = (float) this.f114mY;
                    f3 = f7 / ((float) this.mHeight);
                } else {
                    f5 = (float) this.mWidth;
                    float f9 = ((float) this.mWidth) / f8;
                    f2 = (float) this.f113mX;
                    f = ((float) this.f114mY) + ((((float) this.mHeight) - f9) / 2.0f);
                    float f10 = f9;
    ...
    public static void copyExif(Context context, Uri uri, File file) throws IOException {
        ...
        if (fileFromUri == null) {
            FLog.m102w(ReactConstants.TAG, "Couldn't get real path for uri: " + uri);
            return;
        }
