...
public class HeadlessJsTaskSupportModule extends ReactContextBaseJavaModule {
    ...
    public void notifyTaskRetry(int i, Promise promise) {
        ...
        FLog.m100w((Class<?>) HeadlessJsTaskSupportModule.class, "Tried to retry non-active task with id %d. Did it time out?", Integer.valueOf(i));
    ...
    public void notifyTaskFinished(int i) {
        ...
        FLog.m100w((Class<?>) HeadlessJsTaskSupportModule.class, "Tried to finish non-active task with id %d. Did it time out?", Integer.valueOf(i));
    }
}
