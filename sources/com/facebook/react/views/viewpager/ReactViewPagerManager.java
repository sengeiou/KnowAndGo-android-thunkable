...
public class ReactViewPagerManager extends ViewGroupManager<ReactViewPager> implements AndroidViewPagerManagerInterface<ReactViewPager> {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m140of(PageScrollEvent.EVENT_NAME, MapBuilder.m138of("registrationName", "onPageScroll"), PageScrollStateChangedEvent.EVENT_NAME, MapBuilder.m138of("registrationName", "onPageScrollStateChanged"), PageSelectedEvent.EVENT_NAME, MapBuilder.m138of("registrationName", "onPageSelected"));
    }

    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m139of("setPage", 1, "setPageWithoutAnimation", 2);
    }
