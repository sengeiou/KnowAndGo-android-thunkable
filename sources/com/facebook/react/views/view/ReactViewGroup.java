...
public class ReactViewGroup extends ViewGroup implements ReactInterceptingViewGroup, ReactClippingViewGroup, ReactPointerEventsView, ReactHitSlopView, ReactZIndexedViewGroup {
    ...
    public void dispatchProvideStructure(ViewStructure viewStructure) {
        try {
            ...
            FLog.m63e(ReactConstants.TAG, "NullPointerException when executing dispatchProvideStructure", (Throwable) e);
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        try {
            ...
            FLog.m63e(ReactConstants.TAG, "NullPointerException when executing ViewGroup.dispatchDraw method", (Throwable) e);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:78:0x013c, code lost:
        if (com.facebook.yoga.YogaConstants.isUndefined(r10) == false) goto L_0x010e;
     */
