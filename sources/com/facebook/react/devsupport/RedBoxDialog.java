    ...
    private static class StackAdapter extends BaseAdapter {
        ...
        private static class FrameViewHolder {
            ...
            private FrameViewHolder(View view) {
                this.mMethodView = (TextView) view.findViewById(C1129R.C1132id.rn_frame_method);
                this.mFileView = (TextView) view.findViewById(C1129R.C1132id.rn_frame_file);
            }
        }
        ...
        public android.view.View getView(int r3, android.view.View r4, android.view.ViewGroup r5) {
            ...
            L_0x0008:
                ...
                int r4 = com.facebook.react.C1129R.layout.redbox_item_title
            ...
            L_0x002e:
                ...
                int r1 = com.facebook.react.C1129R.layout.redbox_item_frame
    ...
    private static class OpenStackFrameTask extends AsyncTask<StackFrame, Void, Void> {
        ...
        public Void doInBackground(StackFrame... stackFrameArr) {
            try {
                ...
                FLog.m63e(ReactConstants.TAG, "Could not open stack frame", (Throwable) e);
            }
            return null;
        }

        private static JSONObject stackFrameToJson(StackFrame stackFrame) {
            return new JSONObject(MapBuilder.m141of(UriUtil.LOCAL_FILE_SCHEME, stackFrame.getFile(), "methodName", stackFrame.getMethod(), StackTraceHelper.LINE_NUMBER_KEY, Integer.valueOf(stackFrame.getLine()), StackTraceHelper.COLUMN_KEY, Integer.valueOf(stackFrame.getColumn())));
        }
    }

    protected RedBoxDialog(Context context, DevSupportManager devSupportManager, @Nullable RedBoxHandler redBoxHandler) {
        super(context, C1129R.style.Theme_Catalyst_RedBox);
        requestWindowFeature(1);
        setContentView(C1129R.layout.redbox_view);
        this.mDevSupportManager = devSupportManager;
        this.mDoubleTapReloadRecognizer = new DoubleTapReloadRecognizer();
        this.mRedBoxHandler = redBoxHandler;
        this.mStackView = (ListView) findViewById(C1129R.C1132id.rn_redbox_stack);
        this.mStackView.setOnItemClickListener(this);
        this.mReloadJsButton = (Button) findViewById(C1129R.C1132id.rn_redbox_reload_button);
        this.mReloadJsButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                RedBoxDialog.this.mDevSupportManager.handleReloadJS();
            }
        });
        this.mDismissButton = (Button) findViewById(C1129R.C1132id.rn_redbox_dismiss_button);
        ...
        if (this.mRedBoxHandler != null && this.mRedBoxHandler.isReportEnabled()) {
            this.mLoadingIndicator = (ProgressBar) findViewById(C1129R.C1132id.rn_redbox_loading_indicator);
            this.mLineSeparator = findViewById(C1129R.C1132id.rn_redbox_line_separator);
            this.mReportTextView = (TextView) findViewById(C1129R.C1132id.rn_redbox_report_label);
            this.mReportTextView.setMovementMethod(LinkMovementMethod.getInstance());
            this.mReportTextView.setHighlightColor(0);
            this.mReportButton = (Button) findViewById(C1129R.C1132id.rn_redbox_report_button);
