...
class DebugOverlayController {
    ...
    public static void requestPermission(Context context) {
        if (Build.VERSION.SDK_INT >= 23 && !Settings.canDrawOverlays(context)) {
            ...
            FLog.m102w(ReactConstants.TAG, "Overlay permissions needs to be granted in order for react native apps to run in dev mode");
    ...
    private static boolean hasPermission(Context context, String str) {
        try {
            ...
            FLog.m63e(ReactConstants.TAG, "Error while retrieving package info", (Throwable) e);
        }
        return false;
    }
        ...
        UiThreadUtil.runOnUiThread(new Runnable() {
            public void run() {
                if (!z || DebugOverlayController.this.mFPSDebugViewContainer != null) {
                    ...
                    FLog.m50d(ReactConstants.TAG, "Wait for overlay permission to be set");
                } else {
