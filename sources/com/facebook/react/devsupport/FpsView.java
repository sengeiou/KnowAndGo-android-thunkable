...
public class FpsView extends FrameLayout {
    ...
    private final TextView mTextView = ((TextView) findViewById(C1129R.C1132id.fps_text));

    public FpsView(ReactContext reactContext) {
        super(reactContext);
        inflate(reactContext, C1129R.layout.fps_view, this);
    ...
    public void setCurrentFPS(double d, double d2, int i, int i2) {
        ...
        FLog.m50d(ReactConstants.TAG, format);
    }
