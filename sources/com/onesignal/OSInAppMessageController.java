...
class OSInAppMessageController implements OSDynamicTriggerController.OSDynamicTriggerControllerObserver, OSSystemConditionController.OSSystemConditionObserver {
    ...
    public void showAlertDialogMessage(final OSInAppMessage oSInAppMessage, final List<OSInAppMessagePrompt> list) {
        String string = OneSignal.appContext.getString(C2463R.string.location_not_available_title);
        new AlertDialog.Builder(ActivityLifecycleHandler.curActivity).setTitle(string).setMessage(OneSignal.appContext.getString(C2463R.string.location_not_available_message)).setPositiveButton(17039370, new DialogInterface.OnClickListener() {
    ...
    public void dismissCurrentMessage(@androidx.annotation.Nullable com.onesignal.OSInAppMessage r6) {
        /*
            r5 = this;
