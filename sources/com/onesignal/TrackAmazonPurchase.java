...
class TrackAmazonPurchase {
    ...
    TrackAmazonPurchase(Context context2) {
        ...
        try {
            ...
            this.osPurchasingListener = new OSPurchasingListener(this, (C24671) null);
    ...
    private class OSPurchasingListener implements PurchasingListener {
        ...
        /* synthetic */ OSPurchasingListener(TrackAmazonPurchase trackAmazonPurchase, C24671 r2) {
            this();
        }
        ...
        public void onProductDataResponse(ProductDataResponse productDataResponse) {
            if (this.lastRequestId != null && this.lastRequestId.toString().equals(productDataResponse.getRequestId().toString())) {
                try {
                    if (C24671.f1087x4eb80c9f[productDataResponse.getRequestStatus().ordinal()] == 1) {
    ...
    static /* synthetic */ class C24671 {
        ...
        static final /* synthetic */ int[] f1087x4eb80c9f = new int[ProductDataResponse.RequestStatus.values().length];

        static {
            try {
                f1087x4eb80c9f[ProductDataResponse.RequestStatus.SUCCESSFUL.ordinal()] = 1;
