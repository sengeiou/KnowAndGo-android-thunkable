...
class TrackGooglePurchase {
    ...
    public void sendPurchases(ArrayList<String> arrayList, final ArrayList<String> arrayList2) {
        try {
            ...
            if (bundle2.getInt(BillingHelper.RESPONSE_CODE) == 0) {
                ArrayList<String> stringArrayList = bundle2.getStringArrayList(BillingHelper.RESPONSE_GET_SKU_DETAILS_LIST);
