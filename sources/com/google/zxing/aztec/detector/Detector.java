...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        if (this.nbCenterLayers == 5 || this.nbCenterLayers == 7) {
            ...
            return expandSquare(new ResultPoint[]{new ResultPoint(((float) point.getX()) + 0.5f, ((float) point.getY()) - 0.5f), new ResultPoint(((float) point2.getX()) + 0.5f, ((float) point2.getY()) + 0.5f), new ResultPoint(((float) point3.getX()) - 0.5f, ((float) point3.getY()) + 0.5f), new ResultPoint(((float) point4.getX()) - 0.5f, ((float) point4.getY()) - 0.5f)}, (this.nbCenterLayers * 2) - 3, this.nbCenterLayers * 2);
        }
        throw NotFoundException.getNotFoundInstance();
    }
    ...
    static final class Point {
        ...
        public String toString() {
            return "<" + this.f1047x + ' ' + this.f1048y + Typography.greater;
        }
    }
}
