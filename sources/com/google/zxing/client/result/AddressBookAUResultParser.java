...
public final class AddressBookAUResultParser extends ResultParser {
    public AddressBookParsedResult parse(Result result) {
        ...
        String matchSinglePrefixedField = matchSinglePrefixedField("NAME1:", massagedText, CharUtils.f3029CR, true);
        String matchSinglePrefixedField2 = matchSinglePrefixedField("NAME2:", massagedText, CharUtils.f3029CR, true);
        ...
        String matchSinglePrefixedField3 = matchSinglePrefixedField("MEMORY:", massagedText, CharUtils.f3029CR, false);
        String matchSinglePrefixedField4 = matchSinglePrefixedField("ADD:", massagedText, CharUtils.f3029CR, true);
    ...
    private static String[] matchMultipleValuePrefix(String str, int i, String str2, boolean z) {
        ...
        for (int i2 = 1; i2 <= i; i2++) {
            String matchSinglePrefixedField = matchSinglePrefixedField(str + i2 + ':', str2, CharUtils.f3029CR, z);
