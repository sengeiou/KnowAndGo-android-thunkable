...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo22648id = 2)
    private final ArrayList<zal> zaqw;
    @SafeParcelable.Field(getter = "getRootClassName", mo22648id = 3)
    private final String zaqx;

    @SafeParcelable.Constructor
    zak(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) ArrayList<zal> arrayList, @SafeParcelable.Param(mo22651id = 3) String str) {
        this.zalf = i;
        this.zaqw = null;
