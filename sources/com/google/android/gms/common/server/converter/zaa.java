...
public final class zaa extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", mo22648id = 2)
    private final StringToIntConverter zapl;

    @SafeParcelable.Constructor
    zaa(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) StringToIntConverter stringToIntConverter) {
        this.zalf = i;
