...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", mo22648id = 1)
    private final int zzh;
    @SafeParcelable.Field(getter = "getPendingIntent", mo22648id = 3)
    @Nullable
    private final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getStatusMessage", mo22648id = 2)
    @Nullable
    private final String zzj;

    @SafeParcelable.Constructor
    @KeepForSdk
    Status(@SafeParcelable.Param(mo22651id = 1000) int i, @SafeParcelable.Param(mo22651id = 1) int i2, @SafeParcelable.Param(mo22651id = 2) @Nullable String str, @SafeParcelable.Param(mo22651id = 3) @Nullable PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
