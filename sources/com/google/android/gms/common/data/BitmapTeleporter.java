...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    BitmapTeleporter(@SafeParcelable.Param(mo22651id = 1) int i, @SafeParcelable.Param(mo22651id = 2) ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(mo22651id = 3) int i2) {
        this.zalf = i;
    ...
    private final FileOutputStream zabz() {
        if (this.zalj != null) {
            try {
                File createTempFile = File.createTempFile("teleporter", DefaultDiskStorage.FileType.TEMP, this.zalj);
                try {
                    FileOutputStream fileOutputStream = new FileOutputStream(createTempFile);
                    this.zalg = ParcelFileDescriptor.open(createTempFile, C1470C.ENCODING_PCM_MU_LAW);
