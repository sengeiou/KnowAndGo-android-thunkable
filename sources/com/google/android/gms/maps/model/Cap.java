...
public class Cap extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWrappedBitmapDescriptorImplBinder", mo22648id = 3, type = "android.os.IBinder")
    @Nullable
    private final BitmapDescriptor bitmapDescriptor;
    @SafeParcelable.Field(getter = "getType", mo22648id = 2)
    private final int type;
    @SafeParcelable.Field(getter = "getBitmapRefWidth", mo22648id = 4)
    @Nullable
    ...
    Cap(@com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo22651id = 2) int r2, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo22651id = 3) @androidx.annotation.Nullable android.os.IBinder r3, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo22651id = 4) @androidx.annotation.Nullable java.lang.Float r4) {
        /*
            r1 = this;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        if (this.bitmapDescriptor == null) {
            ...
            iBinder = this.bitmapDescriptor.zzb().asBinder();
        }
