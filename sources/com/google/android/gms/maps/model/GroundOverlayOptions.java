...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBearing", mo22648id = 7)
    private float bearing;
    @SafeParcelable.Field(getter = "getHeight", mo22648id = 5)
    private float height;
    @SafeParcelable.Field(getter = "getWidth", mo22648id = 4)
    private float width;
    @SafeParcelable.Field(getter = "getZIndex", mo22648id = 8)
    private float zzcs;
    @SafeParcelable.Field(getter = "isVisible", mo22648id = 9)
    private boolean zzct = true;
    @SafeParcelable.Field(getter = "isClickable", mo22648id = 13)
    private boolean zzcu = false;
    @SafeParcelable.Field(getter = "getWrappedImageDescriptorImplBinder", mo22648id = 2, type = "android.os.IBinder")
    @NonNull
    private BitmapDescriptor zzcx;
    @SafeParcelable.Field(getter = "getLocation", mo22648id = 3)
    private LatLng zzcy;
    @SafeParcelable.Field(getter = "getBounds", mo22648id = 6)
    private LatLngBounds zzcz;
    @SafeParcelable.Field(getter = "getTransparency", mo22648id = 10)
    private float zzda = 0.0f;
    @SafeParcelable.Field(getter = "getAnchorU", mo22648id = 11)
    private float zzdb = 0.5f;
    @SafeParcelable.Field(getter = "getAnchorV", mo22648id = 12)
    private float zzdc = 0.5f;

    @SafeParcelable.Constructor
    GroundOverlayOptions(@SafeParcelable.Param(mo22651id = 2) IBinder iBinder, @SafeParcelable.Param(mo22651id = 3) LatLng latLng, @SafeParcelable.Param(mo22651id = 4) float f, @SafeParcelable.Param(mo22651id = 5) float f2, @SafeParcelable.Param(mo22651id = 6) LatLngBounds latLngBounds, @SafeParcelable.Param(mo22651id = 7) float f3, @SafeParcelable.Param(mo22651id = 8) float f4, @SafeParcelable.Param(mo22651id = 9) boolean z, @SafeParcelable.Param(mo22651id = 10) float f5, @SafeParcelable.Param(mo22651id = 11) float f6, @SafeParcelable.Param(mo22651id = 12) float f7, @SafeParcelable.Param(mo22651id = 13) boolean z2) {
