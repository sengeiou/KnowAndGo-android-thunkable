...
public class zzaf {
    ...
    private final android.os.Bundle zzk(android.os.Bundle r9) throws java.io.IOException {
        /*
            ...
            monitor-enter(r2)
            java.util.Map<java.lang.String, java.lang.Object> r3 = r8.zzcz     // Catch:{ all -> 0x01e1 }
            r3.put(r1, r0)     // Catch:{ all -> 0x01e1 }
        ...
        L_0x0186:
            ...
            monitor-enter(r9)
            java.util.Map<java.lang.String, java.lang.Object> r0 = r8.zzcz     // Catch:{ all -> 0x01d6 }
            java.lang.Object r0 = r0.remove(r1)     // Catch:{ all -> 0x01d6 }
            boolean r1 = r0 instanceof android.os.Bundle     // Catch:{ all -> 0x01d6 }
            if (r1 == 0) goto L_0x019e
            android.os.Bundle r0 = (android.os.Bundle) r0     // Catch:{ all -> 0x01d6 }
            monitor-exit(r9)     // Catch:{ all -> 0x01d6 }
            return r0
        L_0x019e:
            boolean r1 = r0 instanceof java.lang.String     // Catch:{ all -> 0x01d6 }
            if (r1 == 0) goto L_0x01aa
            java.io.IOException r1 = new java.io.IOException     // Catch:{ all -> 0x01d6 }
            java.lang.String r0 = (java.lang.String) r0     // Catch:{ all -> 0x01d6 }
        ...
        L_0x01aa:
            ...
            java.lang.String r2 = java.lang.String.valueOf(r0)     // Catch:{ all -> 0x01d6 }
            int r2 = r2.length()     // Catch:{ all -> 0x01d6 }
            int r2 = r2 + 12
            ...
            r3.append(r2)     // Catch:{ all -> 0x01d6 }
            r3.append(r0)     // Catch:{ all -> 0x01d6 }
            java.lang.String r0 = r3.toString()     // Catch:{ all -> 0x01d6 }
            android.util.Log.w(r1, r0)     // Catch:{ all -> 0x01d6 }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x01d6 }
