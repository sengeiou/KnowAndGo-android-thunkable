...
public final class CredentialPickerConfig extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "shouldShowCancelButton", mo22648id = 2)
    private final boolean mShowCancelButton;
    @SafeParcelable.Field(mo22648id = 1000)
    private final int zzu;
    @SafeParcelable.Field(getter = "shouldShowAddAccountButton", mo22648id = 1)
    private final boolean zzv;
    @SafeParcelable.Field(getter = "isForNewAccount", mo22648id = 3)
    @Deprecated
    private final boolean zzw;
    @SafeParcelable.Field(getter = "getPromptInternalId", mo22648id = 4)
    ...
    CredentialPickerConfig(@com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo22651id = 1000) int r2, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo22651id = 1) boolean r3, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo22651id = 2) boolean r4, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo22651id = 3) boolean r5, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo22651id = 4) int r6) {
        /*
            r1 = this;
            r1.<init>()
            r1.zzu = r2
