...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountTypes", mo22648id = 2)
    private final String[] zzaa;
    @SafeParcelable.Field(getter = "getCredentialPickerConfig", mo22648id = 3)
    private final CredentialPickerConfig zzab;
    @SafeParcelable.Field(getter = "getCredentialHintPickerConfig", mo22648id = 4)
    private final CredentialPickerConfig zzac;
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo22648id = 5)
    private final boolean zzad;
    @SafeParcelable.Field(getter = "getServerClientId", mo22648id = 6)
    private final String zzae;
    @SafeParcelable.Field(getter = "getIdTokenNonce", mo22648id = 7)
    private final String zzaf;
    @SafeParcelable.Field(getter = "getRequireUserMediation", mo22648id = 8)
    private final boolean zzag;
    @SafeParcelable.Field(mo22648id = 1000)
    private final int zzu;
    @SafeParcelable.Field(getter = "isPasswordLoginSupported", mo22648id = 1)
    private final boolean zzz;

    @SafeParcelable.Constructor
    CredentialRequest(@SafeParcelable.Param(mo22651id = 1000) int i, @SafeParcelable.Param(mo22651id = 1) boolean z, @SafeParcelable.Param(mo22651id = 2) String[] strArr, @SafeParcelable.Param(mo22651id = 3) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(mo22651id = 4) CredentialPickerConfig credentialPickerConfig2, @SafeParcelable.Param(mo22651id = 5) boolean z2, @SafeParcelable.Param(mo22651id = 6) String str, @SafeParcelable.Param(mo22651id = 7) String str2, @SafeParcelable.Param(mo22651id = 8) boolean z3) {
        this.zzu = i;
        this.zzz = z;
