...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", mo22648id = 1)
    private final List<ActivityTransitionEvent> zzn;

    @SafeParcelable.Constructor
    public ActivityTransitionResult(@SafeParcelable.Param(mo22651id = 1) List<ActivityTransitionEvent> list) {
