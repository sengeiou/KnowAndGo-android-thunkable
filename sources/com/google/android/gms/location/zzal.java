...
public final class zzal extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "", getter = "getTag", mo22648id = 3)
    private final String tag;
    @SafeParcelable.Field(getter = "getGeofenceIds", mo22648id = 1)
    private final List<String> zzbu;
    @SafeParcelable.Field(getter = "getPendingIntent", mo22648id = 2)
    private final PendingIntent zzbv;

    @SafeParcelable.Constructor
    zzal(@SafeParcelable.Param(mo22651id = 1) @Nullable List<String> list, @SafeParcelable.Param(mo22651id = 2) @Nullable PendingIntent pendingIntent, @SafeParcelable.Param(mo22651id = 3) String str) {
