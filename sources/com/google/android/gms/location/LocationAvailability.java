...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo22648id = 1)
    @Deprecated
    private int zzar;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo22648id = 2)
    @Deprecated
    private int zzas;
    @SafeParcelable.Field(defaultValueUnchecked = "0", mo22648id = 3)
    private long zzat;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo22648id = 4)
    private int zzau;
    @SafeParcelable.Field(mo22648id = 5)
    private zzaj[] zzav;

    @SafeParcelable.Constructor
    LocationAvailability(@SafeParcelable.Param(mo22651id = 4) int i, @SafeParcelable.Param(mo22651id = 1) int i2, @SafeParcelable.Param(mo22651id = 2) int i3, @SafeParcelable.Param(mo22651id = 3) long j, @SafeParcelable.Param(mo22651id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;
