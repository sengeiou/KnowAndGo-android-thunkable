...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(mo22651id = 1) List<DetectedActivity> list, @SafeParcelable.Param(mo22651id = 2) long j, @SafeParcelable.Param(mo22651id = 3) long j2, @SafeParcelable.Param(mo22651id = 4) int i, @SafeParcelable.Param(mo22651id = 5) Bundle bundle) {
        boolean z = true;
