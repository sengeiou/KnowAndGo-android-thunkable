...
public final class zzjm {
    ...
    public final void zzb(int i, Object obj) {
        if (this.zzrj) {
            if (this.count == this.zzaak.length) {
                int i2 = this.count + (this.count < 4 ? 8 : this.count >> 1);
                this.zzaak = Arrays.copyOf(this.zzaak, i2);
                this.zzyv = Arrays.copyOf(this.zzyv, i2);
            }
            this.zzaak[this.count] = i;
            this.zzyv[this.count] = obj;
            this.count++;
            return;
        }
