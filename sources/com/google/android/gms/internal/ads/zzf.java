...
final class zzf implements zzt {
    ...
    public final void zza(zzr<?> zzr, zzy<?> zzy) {
        List<zzr> remove;
        if (zzy.zzbh == null || zzy.zzbh.isExpired()) {
            zza(zzr);
            return;
        }
        String zze = zzr.zze();
        ...
        if (remove != null) {
            if (zzag.DEBUG) {
                zzag.m185v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(remove.size()), zze);
            }
            for (zzr zzb : remove) {
                this.zzq.zzk.zzb(zzb, zzy);
            }
        }
    }
    ...
    public final synchronized void zza(zzr<?> zzr) {
        String zze = zzr.zze();
        List remove = this.zzp.remove(zze);
        if (remove != null && !remove.isEmpty()) {
            if (zzag.DEBUG) {
                zzag.m185v("%d waiting requests for cacheKey=%s; resend to network", Integer.valueOf(remove.size()), zze);
            }
            ...
            try {
                ...
                zzag.m184e("Couldn't add request to queue. %s", e.toString());
    ...
    public final synchronized boolean zzb(com.google.android.gms.internal.ads.zzr<?> r6) {
        ...
        L_0x001e:
            ...
            com.google.android.gms.internal.ads.zzag.m183d(r6, r1)     // Catch:{ all -> 0x0052 }
        L_0x0038:
            monitor-exit(r5)
            return r2
        L_0x003a:
