...
public final class zzvj extends zzva {
    ...
    public final byte[] zzbl(java.lang.String r9) {
        /*
            r8 = this;
            java.lang.Object r0 = r8.mLock
            monitor-enter(r0)
            java.security.MessageDigest r1 = r8.zznf()     // Catch:{ all -> 0x006c }
            r8.zzbwc = r1     // Catch:{ all -> 0x006c }
            java.security.MessageDigest r1 = r8.zzbwc     // Catch:{ all -> 0x006c }
            r2 = 0
        ...
        L_0x0012:
            ...
            java.security.MessageDigest r9 = r8.zzbwc     // Catch:{ all -> 0x006c }
            byte[] r9 = r9.digest()     // Catch:{ all -> 0x006c }
            int r1 = r9.length     // Catch:{ all -> 0x006c }
            int r3 = r8.zzbwe     // Catch:{ all -> 0x006c }
            if (r1 <= r3) goto L_0x0034
            int r1 = r8.zzbwe     // Catch:{ all -> 0x006c }
            goto L_0x0035
        L_0x0034:
            int r1 = r9.length     // Catch:{ all -> 0x006c }
        L_0x0035:
            ...
            int r9 = r8.zzbwf     // Catch:{ all -> 0x006c }
            r3 = 8
            int r9 = r9 % r3
        ...
        L_0x0053:
            ...
            int r9 = 8 - r9
            long r4 = r4 >>> r9
            int r9 = r8.zzbwe     // Catch:{ all -> 0x006c }
            int r9 = r9 + -1
        L_0x005d:
            if (r9 < 0) goto L_0x006a
        ...
        L_0x006c:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzvj.zzbl(java.lang.String):byte[]");
    }
}
