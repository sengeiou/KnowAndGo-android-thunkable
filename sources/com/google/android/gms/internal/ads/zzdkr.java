...
public final class zzdkr {
    ...
    public static ECParameterSpec zza(zzdkt zzdkt) throws NoSuchAlgorithmException {
        switch (zzdks.zzgzz[zzdkt.ordinal()]) {
            case 1:
    ...
    public static ECPublicKey zza(zzdkt zzdkt, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec zza = zza(zzdkt);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        zza(eCPoint, zza.getCurve());
        return (ECPublicKey) zzdkx.zzhav.zzgt("EC").generatePublic(new ECPublicKeySpec(eCPoint, zza));
    }

    public static ECPrivateKey zza(zzdkt zzdkt, byte[] bArr) throws GeneralSecurityException {
        return (ECPrivateKey) zzdkx.zzhav.zzgt("EC").generatePrivate(new ECPrivateKeySpec(new BigInteger(1, bArr), zza(zzdkt)));
    }

    public static KeyPair zza(ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        KeyPairGenerator zzgt = zzdkx.zzhau.zzgt("EC");
        zzgt.initialize(eCParameterSpec);
        return zzgt.generateKeyPair();
    }
    ...
    public static byte[] zza(ECPrivateKey eCPrivateKey, ECPoint eCPoint) throws GeneralSecurityException {
        ...
        KeyAgreement zzgt = zzdkx.zzhat.zzgt("ECDH");
        zzgt.init(eCPrivateKey);
        try {
            zzgt.doPhase(generatePublic, true);
            byte[] generateSecret = zzgt.generateSecret();
