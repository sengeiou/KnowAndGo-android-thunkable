...
public class zzbiz extends WebViewClient {
    ...
    public void zza(zzbja zzbja) {
    }

    public void zzb(zzbja zzbja) {
    }

    public boolean zzc(zzbja zzbja) {
        return false;
    }

    @Nullable
    public WebResourceResponse zzd(zzbja zzbja) {
        return null;
    }

    /* access modifiers changed from: package-private */
    public final void zza(zzbje zzbje) {
        this.zzemq = zzbje;
    }
