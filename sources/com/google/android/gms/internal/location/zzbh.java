...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @SafeParcelable.Field(getter = "getRequestId", mo22648id = 1)
    private final String zzad;
    @SafeParcelable.Field(getter = "getTransitionTypes", mo22648id = 7)
    private final int zzae;
    @SafeParcelable.Field(getter = "getType", mo22648id = 3)
    private final short zzag;
    @SafeParcelable.Field(getter = "getLatitude", mo22648id = 4)
    private final double zzah;
    @SafeParcelable.Field(getter = "getLongitude", mo22648id = 5)
    private final double zzai;
    @SafeParcelable.Field(getter = "getRadius", mo22648id = 6)
    private final float zzaj;
    @SafeParcelable.Field(defaultValue = "0", getter = "getNotificationResponsiveness", mo22648id = 8)
    private final int zzak;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getLoiteringDelay", mo22648id = 9)
    private final int zzal;
    @SafeParcelable.Field(getter = "getExpirationTime", mo22648id = 2)
    private final long zzdo;

    @SafeParcelable.Constructor
    public zzbh(@SafeParcelable.Param(mo22651id = 1) String str, @SafeParcelable.Param(mo22651id = 7) int i, @SafeParcelable.Param(mo22651id = 3) short s, @SafeParcelable.Param(mo22651id = 4) double d, @SafeParcelable.Param(mo22651id = 5) double d2, @SafeParcelable.Param(mo22651id = 6) float f, @SafeParcelable.Param(mo22651id = 2) long j, @SafeParcelable.Param(mo22651id = 8) int i2, @SafeParcelable.Param(mo22651id = 9) int i3) {
