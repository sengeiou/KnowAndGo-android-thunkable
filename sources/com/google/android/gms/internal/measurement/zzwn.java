...
final class zzwn {
    ...
    static int zzy(List<Long> list) {
        ...
        if (list instanceof zzvj) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zztv.zzaw(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzz(List<Long> list) {
        ...
        if (list instanceof zzvj) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zztv.zzax(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzaa(List<Long> list) {
        ...
        if (list instanceof zzvj) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zztv.zzay(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzab(List<Integer> list) {
        ...
        if (list instanceof zzup) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zztv.zzbj(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzac(List<Integer> list) {
        ...
        if (list instanceof zzup) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zztv.zzbe(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzad(List<Integer> list) {
        ...
        if (list instanceof zzup) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zztv.zzbf(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzae(List<Integer> list) {
        ...
        if (list instanceof zzup) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zztv.zzbg(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
