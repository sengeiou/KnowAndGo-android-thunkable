...
final class zzuf<FieldDescriptorType extends zzuh<FieldDescriptorType>> {
    ...
    private final void zza(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        this.zzbvj.put(fielddescriptortype, obj);
    }
    ...
    public final boolean isInitialized() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzc : this.zzbvj.zzyd()) {
            if (!zzc(zzc)) {
                return false;
            }
        }
    ...
    public final void zza(zzuf<FieldDescriptorType> zzuf) {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzd : zzuf.zzbvj.zzyd()) {
            zzd(zzd);
        }
    }
    ...
    public final int zzvx() {
        ...
        for (int i2 = 0; i2 < this.zzbvj.zzyc(); i2++) {
            ...
            i += zzb((zzuh<?>) (zzuh) zzbx.getKey(), zzbx.getValue());
        }
        for (Map.Entry next : this.zzbvj.zzyd()) {
            i += zzb((zzuh<?>) (zzuh) next.getKey(), next.getValue());
        }
        return i;
    }
    ...
    public final int zzvy() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zze : this.zzbvj.zzyd()) {
            i += zze(zze);
        }
        return i;
    }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (Map.Entry next : this.zzbvj.zzyd()) {
            zzuf.zza((zzuh) next.getKey(), next.getValue());
        }
