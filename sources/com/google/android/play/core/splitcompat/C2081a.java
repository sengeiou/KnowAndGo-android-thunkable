...
final class C2081a {
    ...
    /* renamed from: b */
    static final synchronized void m869b(Context context, Set<File> set) {
        synchronized (C2081a.class) {
            AssetManager assets = context.getAssets();
            for (File path : set) {
                int intValue = ((Integer) C2020bq.m680a((Object) assets, "addAssetPath", Integer.class, String.class, path.getPath())).intValue();
    ...
    public final synchronized boolean mo33680a(android.content.Context r5, java.util.Set<java.lang.String> r6) {
        /*
            r4 = this;
            monitor-enter(r4)
        ...
        L_0x0022:
            ...
            com.google.android.play.core.splitcompat.c r3 = r4.f825a     // Catch:{ Exception -> 0x0045 }
            java.io.File r2 = r3.mo33687b((java.lang.String) r2)     // Catch:{ Exception -> 0x0045 }
            r1.add(r2)     // Catch:{ Exception -> 0x0045 }
            goto L_0x0022
        L_0x0038:
            m869b(r5, r1)     // Catch:{ Exception -> 0x0045 }
        ...
        L_0x005b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.splitcompat.C2081a.mo33680a(android.content.Context, java.util.Set):boolean");
    }
}
