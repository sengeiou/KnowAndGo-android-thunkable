...
public class TrackSelectionView extends LinearLayout {
    ...
    public static Pair<AlertDialog, TrackSelectionView> getDialog(Activity activity, CharSequence charSequence, DefaultTrackSelector defaultTrackSelector, int i) {
        ...
        View inflate = LayoutInflater.from(builder.getContext()).inflate(C1581R.layout.exo_track_selection_dialog, (ViewGroup) null);
        TrackSelectionView trackSelectionView = (TrackSelectionView) inflate.findViewById(C1581R.C1584id.exo_track_selection_view);
    ...
    public TrackSelectionView(Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        this.disableView.setText(C1581R.string.exo_track_selection_none);
        ...
        addView(this.inflater.inflate(C1581R.layout.exo_list_divider, this, false));
        ...
        this.defaultView.setText(C1581R.string.exo_track_selection_auto);
