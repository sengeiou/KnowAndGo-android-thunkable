...
public abstract class MediaCodecRenderer extends BaseRenderer {
        ...
        if (this.codec == null && this.format != null) {
            ...
            try {
                if (initCodecWithFallback(mediaCrypto, z)) {
                    ...
                    this.codecHotswapDeadlineMs = getState() == 2 ? SystemClock.elapsedRealtime() + 1000 : C1470C.TIME_UNSET;
                    resetInputBuffer();
                    resetOutputBuffer();
    ...
    public void releaseCodec() {
        this.codecHotswapDeadlineMs = C1470C.TIME_UNSET;
        resetInputBuffer();
        resetOutputBuffer();
        ...
        if (!this.availableCodecInfos.isEmpty()) {
            do {
                ...
                try {
                    ...
                    Log.m158w(TAG, "Failed to initialize decoder: " + peekFirst, e2);
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (decoderInfos.isEmpty() && z) {
            ...
            if (!decoderInfos.isEmpty()) {
                Log.m157w(TAG, "Drm session requires secure decoder for " + this.format.sampleMimeType + ", but no secure decoder available. Trying to proceed with " + decoderInfos + ".");
            }
        }
        return decoderInfos;
    }
    ...
    private void initCodec(com.google.android.exoplayer2.mediacodec.MediaCodecInfo r13, android.media.MediaCrypto r14) throws java.lang.Exception {
        ...
        L_0x0010:
            r2 = 0
            long r3 = android.os.SystemClock.elapsedRealtime()     // Catch:{ Exception -> 0x006d }
            ...
            r5.append(r6)     // Catch:{ Exception -> 0x006d }
            r5.append(r1)     // Catch:{ Exception -> 0x006d }
            java.lang.String r5 = r5.toString()     // Catch:{ Exception -> 0x006d }
            com.google.android.exoplayer2.util.TraceUtil.beginSection(r5)     // Catch:{ Exception -> 0x006d }
            android.media.MediaCodec r5 = android.media.MediaCodec.createByCodecName(r1)     // Catch:{ Exception -> 0x006d }
            com.google.android.exoplayer2.util.TraceUtil.endSection()     // Catch:{ Exception -> 0x006b }
            java.lang.String r2 = "configureCodec"
            com.google.android.exoplayer2.util.TraceUtil.beginSection(r2)     // Catch:{ Exception -> 0x006b }
            com.google.android.exoplayer2.Format r9 = r12.format     // Catch:{ Exception -> 0x006b }
            if (r0 == 0) goto L_0x003d
            float r2 = r12.codecOperatingRate     // Catch:{ Exception -> 0x006b }
            r11 = r2
            goto L_0x0041
        L_0x003d:
        ...
        L_0x0041:
            ...
            r8 = r5
            r10 = r14
            r6.configureCodec(r7, r8, r9, r10, r11)     // Catch:{ Exception -> 0x006b }
            r12.codecConfiguredWithOperatingRate = r0     // Catch:{ Exception -> 0x006b }
            com.google.android.exoplayer2.util.TraceUtil.endSection()     // Catch:{ Exception -> 0x006b }
            java.lang.String r14 = "startCodec"
            com.google.android.exoplayer2.util.TraceUtil.beginSection(r14)     // Catch:{ Exception -> 0x006b }
            r5.start()     // Catch:{ Exception -> 0x006b }
            com.google.android.exoplayer2.util.TraceUtil.endSection()     // Catch:{ Exception -> 0x006b }
            long r6 = android.os.SystemClock.elapsedRealtime()     // Catch:{ Exception -> 0x006b }
            r12.getCodecBuffers(r5)     // Catch:{ Exception -> 0x006b }
            r12.codec = r5
            r12.codecInfo = r13
            long r4 = r6 - r3
            r0 = r12
    ...
    public boolean isReady() {
        return this.format != null && !this.waitingForKeys && (isSourceReady() || hasOutputBuffer() || (this.codecHotswapDeadlineMs != C1470C.TIME_UNSET && SystemClock.elapsedRealtime() < this.codecHotswapDeadlineMs));
    }
