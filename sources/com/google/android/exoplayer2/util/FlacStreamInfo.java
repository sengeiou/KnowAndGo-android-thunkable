...
public final class FlacStreamInfo {
    ...
    public long getApproxBytesPerFrame() {
        ...
        return (((((this.minBlockSize != this.maxBlockSize || this.minBlockSize <= 0) ? PlaybackStateCompat.ACTION_SKIP_TO_QUEUE_ITEM : (long) this.minBlockSize) * ((long) this.channels)) * ((long) this.bitsPerSample)) / 8) + 64;
    }
}
