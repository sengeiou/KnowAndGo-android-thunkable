...
public final class ParsableByteArray {
    ...
    public short readLittleEndianShort() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        return (short) (b | ((bArr2[i2] & UByte.MAX_VALUE) << 8));
    }
    ...
    public int readUnsignedInt24() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        byte b = ((bArr[i] & UByte.MAX_VALUE) << 16) | ((bArr2[i2] & UByte.MAX_VALUE) << 8);
        byte[] bArr3 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        return b | (bArr3[i3] & UByte.MAX_VALUE);
    }
    ...
    public int readInt24() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        byte b = (((bArr[i] & UByte.MAX_VALUE) << 24) >> 8) | ((bArr2[i2] & UByte.MAX_VALUE) << 8);
        byte[] bArr3 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        return b | (bArr3[i3] & UByte.MAX_VALUE);
    ...
    public int readLittleEndianInt24() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        byte b2 = b | ((bArr2[i2] & UByte.MAX_VALUE) << 8);
        byte[] bArr3 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        return b2 | ((bArr3[i3] & UByte.MAX_VALUE) << 16);
    }
    ...
    public int readLittleEndianInt() {
        ...
        int i3 = this.position;
        this.position = i3 + 1;
        byte b3 = b2 | ((bArr3[i3] & UByte.MAX_VALUE) << 16);
        byte[] bArr4 = this.data;
        int i4 = this.position;
        this.position = i4 + 1;
        return b3 | ((bArr4[i4] & UByte.MAX_VALUE) << 24);
    }
