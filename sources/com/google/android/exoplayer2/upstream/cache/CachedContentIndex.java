...
class CachedContentIndex {
    ...
    public void maybeRemove(String str) {
        ...
        if (cachedContent != null && cachedContent.isEmpty() && !cachedContent.isLocked()) {
            ...
            this.idToKey.remove(cachedContent.f166id);
            this.changed = true;
        }
    }
    ...
    private boolean readFile() {
        /*
            ...
            int r1 = r3.readInt()     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            if (r1 < 0) goto L_0x008d
            r4 = 2
            if (r1 <= r4) goto L_0x001d
            goto L_0x008d
        L_0x001d:
            int r5 = r3.readInt()     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r6 = 1
            r5 = r5 & r6
            if (r5 == 0) goto L_0x0055
            javax.crypto.Cipher r5 = r9.cipher     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            if (r5 != 0) goto L_0x002d
            com.google.android.exoplayer2.util.Util.closeQuietly((java.io.Closeable) r3)
            return r0
        L_0x002d:
            r5 = 16
            byte[] r5 = new byte[r5]     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r3.readFully(r5)     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            javax.crypto.spec.IvParameterSpec r7 = new javax.crypto.spec.IvParameterSpec     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r7.<init>(r5)     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            ...
            java.io.DataInputStream r4 = new java.io.DataInputStream     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            javax.crypto.CipherInputStream r5 = new javax.crypto.CipherInputStream     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            javax.crypto.Cipher r7 = r9.cipher     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r5.<init>(r2, r7)     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r4.<init>(r5)     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r3 = r4
            goto L_0x005b
        L_0x004e:
            r1 = move-exception
            java.lang.IllegalStateException r2 = new java.lang.IllegalStateException     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r2.<init>(r1)     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            throw r2     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
        L_0x0055:
            boolean r2 = r9.encrypt     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            if (r2 == 0) goto L_0x005b
            r9.changed = r6     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
        L_0x005b:
            int r2 = r3.readInt()     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r4 = 0
            r5 = 0
        L_0x0061:
            if (r4 >= r2) goto L_0x0072
            com.google.android.exoplayer2.upstream.cache.CachedContent r7 = com.google.android.exoplayer2.upstream.cache.CachedContent.readFromStream(r1, r3)     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r9.add(r7)     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            int r7 = r7.headerHashCode(r1)     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            int r5 = r5 + r7
            int r4 = r4 + 1
            goto L_0x0061
        L_0x0072:
            int r1 = r3.readInt()     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            int r2 = r3.read()     // Catch:{ IOException -> 0x0093, all -> 0x0091 }
            r4 = -1
    ...
    private void add(CachedContent cachedContent) {
        ...
        this.idToKey.put(cachedContent.f166id, cachedContent.key);
    }
