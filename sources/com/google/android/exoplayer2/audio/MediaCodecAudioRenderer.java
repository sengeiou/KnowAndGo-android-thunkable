...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    public void onStreamChanged(Format[] formatArr, long j) throws ExoPlaybackException {
        ...
        if (this.lastInputTimeUs != C1470C.TIME_UNSET) {
            if (this.pendingStreamChangeCount == this.pendingStreamChangeTimesUs.length) {
                Log.m157w(TAG, "Too many stream changes, so dropping change at " + this.pendingStreamChangeTimesUs[this.pendingStreamChangeCount - 1]);
            } else {
    ...
    public boolean processOutputBuffer(long j, long j2, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i, int i2, long j3, boolean z, Format format) throws ExoPlaybackException {
        if (this.codecNeedsEosBufferTimestampWorkaround && j3 == 0 && (i2 & 4) != 0 && this.lastInputTimeUs != C1470C.TIME_UNSET) {
