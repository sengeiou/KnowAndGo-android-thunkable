...
public final class FragmentedMp4Extractor implements Extractor {
    ...
    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster2, @Nullable Track track, @Nullable DrmInitData drmInitData, List<Format> list, @Nullable TrackOutput trackOutput) {
        ...
        this.pendingSeekTimeUs = C1470C.TIME_UNSET;
        this.segmentIndexEarliestPresentationTimeUs = C1470C.TIME_UNSET;
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        while (i5 < size2) {
            ...
            if (containerAtom3.type == Atom.TYPE_trak) {
                ...
                if (parseTrak != null) {
                    sparseArray2.put(parseTrak.f138id, parseTrak);
                }
            } else {
                i = i5;
                i2 = size2;
        ...
        if (this.trackBundles.size() == 0) {
            while (i3 < size3) {
                ...
                trackBundle.init(track, getDefaultSampleValues(sparseArray, track.f138id));
                this.trackBundles.put(track.f138id, trackBundle);
        ...
        while (i3 < size3) {
            ...
            this.trackBundles.get(track2.f138id).init(track2, getDefaultSampleValues(sparseArray, track2.f138id));
            i3++;
        }
    }
    ...
    private void onMoofContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.pendingSeekTimeUs != C1470C.TIME_UNSET) {
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        if (this.emsgTrackOutputs != null && this.emsgTrackOutputs.length != 0) {
            ...
            if (this.segmentIndexEarliestPresentationTimeUs != C1470C.TIME_UNSET) {
