...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    public DefaultHlsPlaylistTracker(HlsDataSourceFactory hlsDataSourceFactory, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, HlsPlaylistParserFactory hlsPlaylistParserFactory) {
        ...
        this.initialStartTimeUs = C1470C.TIME_UNSET;
    }
    ...
    public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2, IOException iOException, int i) {
        ...
        boolean z = retryDelayMsFor == C1470C.TIME_UNSET;
    ...
    private final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>>, Runnable {
        ...
        public boolean isSnapshotValid() {
            ...
            long elapsedRealtime = SystemClock.elapsedRealtime();
            long max = Math.max(30000, C1470C.usToMs(this.playlistSnapshot.durationUs));
        ...
        public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2, IOException iOException, int i) {
            ...
            boolean z = blacklistDurationMsFor != C1470C.TIME_UNSET;
            ...
            if (z2) {
                ...
                loadErrorAction = retryDelayMsFor != C1470C.TIME_UNSET ? Loader.createRetryAction(false, retryDelayMsFor) : Loader.DONT_RETRY_FATAL;
            } else {
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, long j) {
            ...
            if (this.playlistSnapshot != hlsMediaPlaylist3) {
                ...
                if (hlsMediaPlaylist2.mediaSequence + ((long) hlsMediaPlaylist2.segments.size()) < this.playlistSnapshot.mediaSequence) {
                    ...
                    boolean unused = DefaultHlsPlaylistTracker.this.notifyPlaylistError(this.playlistUrl, C1470C.TIME_UNSET);
                } else if (((double) (elapsedRealtime - this.lastSnapshotChangeMs)) > ((double) C1470C.usToMs(this.playlistSnapshot.targetDurationUs)) * DefaultHlsPlaylistTracker.PLAYLIST_STUCK_TARGET_DURATION_COEFFICIENT) {
                    ...
                    if (blacklistDurationMsFor != C1470C.TIME_UNSET) {
                        blacklistPlaylist(blacklistDurationMsFor);
                    }
                }
            }
            this.earliestNextLoadTimeMs = elapsedRealtime + C1470C.usToMs(this.playlistSnapshot != hlsMediaPlaylist3 ? this.playlistSnapshot.targetDurationUs : this.playlistSnapshot.targetDurationUs / 2);
