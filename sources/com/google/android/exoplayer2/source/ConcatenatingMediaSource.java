...
public class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> implements PlayerMessage.Target {
    ...
    public final synchronized void setShuffleOrder(ShuffleOrder shuffleOrder2, @Nullable Runnable runnable) {
    ...
    public MediaSource.MediaPeriodId getMediaPeriodIdForChildMediaPeriodId(MediaSourceHolder mediaSourceHolder, MediaSource.MediaPeriodId mediaPeriodId) {
        for (int i = 0; i < mediaSourceHolder.activeMediaPeriods.size(); i++) {
            if (mediaSourceHolder.activeMediaPeriods.get(i).f152id.windowSequenceNumber == mediaPeriodId.windowSequenceNumber) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void updateMediaSourceInternal(com.google.android.exoplayer2.source.ConcatenatingMediaSource.MediaSourceHolder r11, com.google.android.exoplayer2.Timeline r12) {
        /*
            r10 = this;
            if (r11 == 0) goto L_0x00b3
            com.google.android.exoplayer2.source.ConcatenatingMediaSource$DeferredTimeline r1 = r11.timeline
            com.google.android.exoplayer2.Timeline r2 = r1.getTimeline()
            if (r2 != r12) goto L_0x000b
            return
        L_0x000b:
        ...
        L_0x0029:
            ...
            com.google.android.exoplayer2.source.ConcatenatingMediaSource$DeferredTimeline r1 = r1.cloneWithUpdatedTimeline(r12)
            r11.timeline = r1
            goto L_0x00ad
        L_0x0036:
            ...
            com.google.android.exoplayer2.source.ConcatenatingMediaSource$DeferredTimeline r1 = com.google.android.exoplayer2.source.ConcatenatingMediaSource.DeferredTimeline.createWithRealTimeline(r12, r1)
            r11.timeline = r1
            goto L_0x00ad
        L_0x0047:
            java.util.List<com.google.android.exoplayer2.source.DeferredMediaPeriod> r1 = r11.activeMediaPeriods
            int r1 = r1.size()
        ...
        L_0x007d:
            ...
            com.google.android.exoplayer2.source.ConcatenatingMediaSource$DeferredTimeline r1 = com.google.android.exoplayer2.source.ConcatenatingMediaSource.DeferredTimeline.createWithRealTimeline(r12, r2)
            r11.timeline = r1
            if (r9 == 0) goto L_0x00ad
            r9.overridePreparePositionUs(r3)
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r1 = r9.f152id
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r2 = r9.f152id
    ...
    private static final class DummyTimeline extends Timeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, boolean z, long j) {
            return window.set((Object) null, C1470C.TIME_UNSET, C1470C.TIME_UNSET, false, true, 0, C1470C.TIME_UNSET, 0, 0, 0);
        }

        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            return period.set(0, DeferredTimeline.DUMMY_ID, 0, C1470C.TIME_UNSET, 0);
        }
