    ...
    public static class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            if (this.initializationTemplate != null) {
                return new RangedUri(this.initializationTemplate.buildUri(representation.format.f133id, 0, representation.format.bitrate, 0), 0, -1);
            }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            long j3 = j2;
            return new RangedUri(this.mediaTemplate.buildUri(representation2.format.f133id, j, representation2.format.bitrate, j3), 0, -1);
        }
