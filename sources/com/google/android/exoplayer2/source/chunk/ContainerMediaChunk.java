    ...
    public final void load() throws IOException, InterruptedException {
        ...
        try {
            ...
            if (this.nextLoadPosition == 0) {
                ...
                long j3 = j == C1470C.TIME_UNSET ? -9223372036854775807L : this.clippedStartTimeUs - this.sampleOffsetUs;
                if (this.clippedEndTimeUs != C1470C.TIME_UNSET) {
                    j2 = this.clippedEndTimeUs - this.sampleOffsetUs;
                }
                chunkExtractorWrapper.init(output, j3, j2);
            }
