...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    private void processManifest() {
        ...
        if (j2 == Long.MAX_VALUE) {
            ...
            if (this.manifest.dvrWindowLengthUs != C1470C.TIME_UNSET && this.manifest.dvrWindowLengthUs > 0) {
                j2 = Math.max(j2, j - this.manifest.dvrWindowLengthUs);
            }
            long j3 = j2;
            long j4 = j - j3;
            long msToUs = j4 - C1470C.msToUs(this.livePresentationDelayMs);
            if (msToUs < MIN_LIVE_DEFAULT_START_POSITION_US) {
                msToUs = Math.min(MIN_LIVE_DEFAULT_START_POSITION_US, j4 / 2);
            }
            singlePeriodTimeline = new SinglePeriodTimeline(C1470C.TIME_UNSET, j4, j3, msToUs, true, true, this.tag);
        } else {
            long j5 = this.manifest.durationUs != C1470C.TIME_UNSET ? this.manifest.durationUs : j - j2;
