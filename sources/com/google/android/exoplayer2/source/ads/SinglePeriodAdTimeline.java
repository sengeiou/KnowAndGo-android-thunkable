...
public final class SinglePeriodAdTimeline extends ForwardingTimeline {
    ...
    public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
        ...
        period.set(period.f135id, period.uid, period.windowIndex, period.durationUs, period.getPositionInWindowUs(), this.adPlaybackState);
        return period;
    }

    public Timeline.Window getWindow(int i, Timeline.Window window, boolean z, long j) {
        Timeline.Window window2 = super.getWindow(i, window, z, j);
        if (window2.durationUs == C1470C.TIME_UNSET) {
