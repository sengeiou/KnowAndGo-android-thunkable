...
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() {
        ...
        public boolean tryCaptureView(View view, int i) {
            return (this.activePointerId == -1 || this.activePointerId == i) && SwipeDismissBehavior.this.canSwipeDismissView(view);
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:20:0x0034 A[RETURN, SYNTHETIC] */
        ...
        private boolean shouldDismiss(@androidx.annotation.NonNull android.view.View r7, float r8) {
            ...
            L_0x005a:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.behavior.SwipeDismissBehavior.C16551.shouldDismiss(android.view.View, float):boolean");
        }
