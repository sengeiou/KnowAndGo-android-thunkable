...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1641R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C1641R.C1644drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C1641R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1641R.C1645id.icon);
        this.smallLabel = (TextView) findViewById(C1641R.C1645id.smallLabel);
        this.largeLabel = (TextView) findViewById(C1641R.C1645id.largeLabel);
            ...
            this.icon.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    if (BottomNavigationItemView.this.icon.getVisibility() == 0) {
                        BottomNavigationItemView.this.tryUpdateBadgeBounds(BottomNavigationItemView.this.icon);
                    }
                }
            });
        }
