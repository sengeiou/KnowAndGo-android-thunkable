...
public class LottieCompositionFactory {
    ...
    private static LottieResult<LottieComposition> fromJsonInputStreamSync(InputStream inputStream, @Nullable String str, boolean z) {
        try {
            return fromJsonReaderSync(JsonReader.m18of(Okio.buffer(Okio.source(inputStream))), str);
        } finally {
            if (z) {
                C0744Utils.closeQuietly(inputStream);
            }
        }
    }
    ...
    public static LottieResult<LottieComposition> fromJsonStringSync(String str, @Nullable String str2) {
        return fromJsonReaderSync(JsonReader.m18of(Okio.buffer(Okio.source((InputStream) new ByteArrayInputStream(str.getBytes())))), str2);
    }
    ...
    private static LottieResult<LottieComposition> fromJsonReaderSyncInternal(JsonReader jsonReader, @Nullable String str, boolean z) {
        try {
            ...
            if (z) {
                C0744Utils.closeQuietly(jsonReader);
            }
            return lottieResult;
        } catch (Exception e) {
    ...
    public static LottieResult<LottieComposition> fromZipStreamSync(ZipInputStream zipInputStream, @Nullable String str) {
        try {
            ...
            C0744Utils.closeQuietly(zipInputStream);
        }
    }
        ...
        try {
            ...
            while (nextEntry != null) {
                ...
                if (name.contains("__MACOSX")) {
                    ...
                    lottieComposition = fromJsonReaderSyncInternal(JsonReader.m18of(Okio.buffer(Okio.source((InputStream) zipInputStream))), (String) null, false).getValue();
                } else {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                if (findImageAssetForFileName != null) {
                    findImageAssetForFileName.setBitmap(C0744Utils.resizeBitmapIfNeeded((Bitmap) entry.getValue(), findImageAssetForFileName.getWidth(), findImageAssetForFileName.getHeight()));
                }
            }
