...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public void draw(@NonNull Canvas canvas) {
        this.isDirty = false;
        C0687L.beginSection("Drawable#draw");
        if (this.safeMode) {
            try {
                drawInternal(canvas);
            } catch (Throwable th) {
        ...
        C0687L.endSection("Drawable#draw");
    }
    ...
    public void setMaxProgress(@FloatRange(from = 0.0d, mo1047to = 1.0d) final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxProgress(@FloatRange(from = 0.0d, mo1047to = 1.0d) final float f, @FloatRange(from = 0.0d, mo1047to = 1.0d) final float f2) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
    ...
    public void setProgress(@FloatRange(from = 0.0d, mo1047to = 1.0d) final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
