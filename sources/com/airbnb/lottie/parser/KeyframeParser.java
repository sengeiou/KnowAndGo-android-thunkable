...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.m19of("t", "s", "e", NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST, "i", "h", "to", "ti");
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v5, resolved type: android.view.animation.Interpolator} */
    ...
    private static <T> com.airbnb.lottie.value.Keyframe<T> parseKeyframe(com.airbnb.lottie.LottieComposition r16, com.airbnb.lottie.parser.moshi.JsonReader r17, float r18, com.airbnb.lottie.parser.ValueParser<T> r19) throws java.io.IOException {
        ...
        L_0x0061:
            ...
            float r3 = r8.x
            float r6 = r8.y
            int r2 = com.airbnb.lottie.utils.C0744Utils.hashFor(r0, r2, r3, r6)
        ...
        L_0x00ed:
            ...
            goto L_0x00eb
        L_0x00f3:
            java.lang.ref.WeakReference r0 = new java.lang.ref.WeakReference     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00fb }
            r0.<init>(r5)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00fb }
            putInterpolator(r2, r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00fb }
        L_0x00fb:
            r11 = r5
            goto L_0x0100
        L_0x00fd:
