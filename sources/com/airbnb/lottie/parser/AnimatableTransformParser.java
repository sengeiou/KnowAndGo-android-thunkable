...
public class AnimatableTransformParser {
    private static JsonReader.Options ANIMATABLE_NAMES = JsonReader.Options.m19of("k");
    private static JsonReader.Options NAMES = JsonReader.Options.m19of(NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY, "p", "s", "rz", "r", NotificationBundleProcessor.PUSH_MINIFIED_BUTTONS_LIST, "so", "eo", "sk", "sa");
