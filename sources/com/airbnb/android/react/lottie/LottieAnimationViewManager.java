...
class LottieAnimationViewManager extends SimpleViewManager<LottieAnimationView> {
    ...
    public Map getExportedCustomBubblingEventTypeConstants() {
        return MapBuilder.builder().put("animationFinish", MapBuilder.m138of("phasedRegistrationNames", MapBuilder.m138of("bubbled", "onAnimationFinish"))).build();
    }

    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m141of("play", 1, "reset", 2, "pause", 3, "resume", 4);
    }
