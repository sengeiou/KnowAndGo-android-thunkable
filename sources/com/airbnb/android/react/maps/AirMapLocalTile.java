...
public class AirMapLocalTile extends AirMapFeature {
    ...
    class AIRMapLocalTileProvider implements TileProvider {
        ...
        public Tile getTile(int i, int i2, int i3) {
            ...
            return readTileImage == null ? TileProvider.NO_TILE : new Tile(this.tileSize, this.tileSize, readTileImage);
        }
        ...
        private byte[] readTileImage(int r7, int r8, int r9) {
            ...
            L_0x0024:
                ...
                byte[] r0 = r9.toByteArray()     // Catch:{ IOException -> 0x0034, OutOfMemoryError -> 0x0032 }
