...
public class AirMapManager extends ViewGroupManager<AirMapView> {
    ...
    private final Map<String, Integer> MAP_TYPES = MapBuilder.m142of("standard", 1, "satellite", 2, SecureStoreModule.HybridAESEncrypter.NAME, 4, "terrain", 3, ViewProps.NONE, 0);
    ...
    public void setMapPadding(AirMapView airMapView, @Nullable ReadableMap readableMap) {
        ...
        int i4 = 0;
        if (readableMap != null) {
            i3 = readableMap.hasKey("left") ? (int) (readableMap.getDouble("left") * d) : 0;
            i2 = readableMap.hasKey(ViewProps.TOP) ? (int) (readableMap.getDouble(ViewProps.TOP) * d) : 0;
            i = readableMap.hasKey("right") ? (int) (readableMap.getDouble("right") * d) : 0;
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        Map of = MapBuilder.m144of("onMapReady", MapBuilder.m138of("registrationName", "onMapReady"), "onPress", MapBuilder.m138of("registrationName", "onPress"), "onLongPress", MapBuilder.m138of("registrationName", "onLongPress"), "onMarkerPress", MapBuilder.m138of("registrationName", "onMarkerPress"), "onMarkerSelect", MapBuilder.m138of("registrationName", "onMarkerSelect"), "onMarkerDeselect", MapBuilder.m138of("registrationName", "onMarkerDeselect"), "onCalloutPress", MapBuilder.m138of("registrationName", "onCalloutPress"));
        of.putAll(MapBuilder.m144of("onUserLocationChange", MapBuilder.m138of("registrationName", "onUserLocationChange"), "onMarkerDragStart", MapBuilder.m138of("registrationName", "onMarkerDragStart"), "onMarkerDrag", MapBuilder.m138of("registrationName", "onMarkerDrag"), "onMarkerDragEnd", MapBuilder.m138of("registrationName", "onMarkerDragEnd"), "onPanDrag", MapBuilder.m138of("registrationName", "onPanDrag"), "onKmlReady", MapBuilder.m138of("registrationName", "onKmlReady"), "onPoiClick", MapBuilder.m138of("registrationName", "onPoiClick")));
        of.putAll(MapBuilder.m141of("onIndoorLevelActivated", MapBuilder.m138of("registrationName", "onIndoorLevelActivated"), "onIndoorBuildingFocused", MapBuilder.m138of("registrationName", "onIndoorBuildingFocused"), "onDoublePress", MapBuilder.m138of("registrationName", "onDoublePress"), "onMapLoaded", MapBuilder.m138of("registrationName", "onMapLoaded")));
        return of;
    }
    ...
    public Map<String, Integer> getCommandsMap() {
        ...
        CreateMap.putAll(MapBuilder.m139of("setMapBoundaries", 8, "setIndoorActiveLevelIndex", 10));
        return CreateMap;
    }
