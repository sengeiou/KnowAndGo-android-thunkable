...
public class ReplayRelay<T> extends Relay<T, T> {
        ...
        relaySubscriptionManager.onAdded = new Action1<RelaySubscriptionManager.RelayObserver<T>>() {
            ...
            public void call(com.jakewharton.rxrelay.RelaySubscriptionManager.RelayObserver<T> r7) {
                ...
                L_0x0055:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.jakewharton.rxrelay.ReplayRelay.C23232.call(com.jakewharton.rxrelay.RelaySubscriptionManager$RelayObserver):void");
            }
        };
        ...
        relaySubscriptionManager.onAdded = new Action1<RelaySubscriptionManager.RelayObserver<T>>() {
            ...
            public void call(com.jakewharton.rxrelay.RelaySubscriptionManager.RelayObserver<T> r7) {
                ...
                L_0x0051:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.jakewharton.rxrelay.ReplayRelay.C23243.call(com.jakewharton.rxrelay.RelaySubscriptionManager$RelayObserver):void");
            }
        };
    ...
    private static final class DefaultOnAdd<T> implements Action1<RelaySubscriptionManager.RelayObserver<T>> {
        ...
        public void call(RelaySubscriptionManager.RelayObserver<T> relayObserver) {
            relayObserver.index(this.state.replayObserverFromIndex(this.state.head(), relayObserver));
        }
    }
    ...
    private static final class TimedOnAdd<T> implements Action1<RelaySubscriptionManager.RelayObserver<T>> {
        ...
        public void call(RelaySubscriptionManager.RelayObserver<T> relayObserver) {
            ...
            if (!this.state.terminated) {
                node = this.state.replayObserverFromIndexTest(this.state.head(), relayObserver, this.scheduler.now());
            } else {
                node = this.state.replayObserverFromIndex(this.state.head(), relayObserver);
            }
