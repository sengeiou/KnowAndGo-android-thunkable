...
final class RelaySubscriptionManager<T> extends AtomicReference<State<T>> implements Observable.OnSubscribe<T> {
    ...
    static final class State<T> {
        ...
        public State add(RelayObserver relayObserver) {
            ...
            RelayObserver[] relayObserverArr = new RelayObserver[(length + 1)];
            System.arraycopy(this.observers, 0, relayObserverArr, 0, length);
            relayObserverArr[length] = relayObserver;
            return new State(relayObserverArr);
        }

        /* access modifiers changed from: package-private */
        public State remove(RelayObserver relayObserver) {
            RelayObserver[] relayObserverArr;
            RelayObserver[] relayObserverArr2 = this.observers;
            if (r1 == 1 && relayObserverArr2[0] == relayObserver) {
                return EMPTY;
            }
            if (r1 == 0) {
                return this;
            ...
            int i2 = 0;
            for (RelayObserver relayObserver2 : relayObserverArr2) {
