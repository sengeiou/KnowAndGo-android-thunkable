...
public class AdvertisementData {
    ...
    private static UUID parseUUID(ByteBuffer byteBuffer, int i) {
        long j;
        long j2 = BLUETOOTH_BASE_UUID_LSB;
        if (i == 2) {
            j = ((((long) byteBuffer.getShort()) & 65535) << 32) + PlaybackStateCompat.ACTION_SKIP_TO_QUEUE_ITEM;
        } else if (i == 4) {
            j = (((long) byteBuffer.getInt()) << 32) + PlaybackStateCompat.ACTION_SKIP_TO_QUEUE_ITEM;
        } else if (i != 16) {
