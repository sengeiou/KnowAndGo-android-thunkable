...
public class BleModule implements BleAdapter {
    ...
    public void connectToDevice(String str, ConnectionOptions connectionOptions, OnSuccessCallback<Device> onSuccessCallback, OnEventCallback<ConnectionState> onEventCallback, OnErrorCallback onErrorCallback) {
        if (this.rxBleClient != null) {
            ...
            boolean booleanValue = connectionOptions.getAutoConnect().booleanValue();
            int requestMTU = connectionOptions.getRequestMTU();
            RefreshGattMoment refreshGattMoment = connectionOptions.getRefreshGattMoment();
            safeConnectToDevice(bleDevice, booleanValue, requestMTU, refreshGattMoment, connectionOptions.getTimeoutInMillis(), connectionOptions.getConnectionPriority(), onSuccessCallback, onEventCallback, onErrorCallback);
            return;
        }
    ...
    private Descriptor getDescriptor(@NonNull String str, @NonNull String str2, @NonNull String str3, @NonNull String str4) throws BleError {
    ...
    private Descriptor getDescriptor(int i, @NonNull String str, @NonNull String str2) throws BleError {
    ...
    private Descriptor getDescriptor(int i, @NonNull String str) throws BleError {
        UUID convert = UUIDConverter.convert(str);
        if (convert != null) {
            Characteristic characteristic = this.discoveredCharacteristics.get(i);
            if (characteristic != null) {
    ...
    public void setLogLevel(String str) {
        ...
        RxBleLog.setLogLevel(this.currentLogLevel);
    }
    ...
    @NonNull
    private Device getDeviceById(@NonNull String str) throws BleError {
        Device device = this.connectedDevices.get(str);
        if (device != null) {
            return device;
        }
    ...
    @Nullable
    private RxBleConnection getConnectionOrEmitError(@NonNull String str, @NonNull OnErrorCallback onErrorCallback) {
    ...
    @Nullable
    private Characteristic getCharacteristicOrEmitError(@NonNull String str, @NonNull String str2, @NonNull String str3, @NonNull OnErrorCallback onErrorCallback) {
        UUID[] convert = UUIDConverter.convert(str2, str3);
        if (convert == null) {
    ...
    @Nullable
    private Characteristic getCharacteristicOrEmitError(int i, @NonNull String str, @NonNull OnErrorCallback onErrorCallback) {
        UUID convert = UUIDConverter.convert(str);
        if (convert == null) {
    ...
    @Nullable
    private Characteristic getCharacteristicOrEmitError(int i, @NonNull OnErrorCallback onErrorCallback) {
        Characteristic characteristic = this.discoveredCharacteristics.get(i);
        if (characteristic != null) {
