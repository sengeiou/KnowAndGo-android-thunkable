...
public class Characteristic {
    ...
    public Characteristic(@NonNull Service service, @NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        ...
        this.f1088id = IdGenerator.getIdForKey(new IdGeneratorKey(this.deviceID, bluetoothGattCharacteristic.getUuid(), bluetoothGattCharacteristic.getInstanceId()));
    }

    public Characteristic(int i, @NonNull Service service, BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        this.f1088id = i;
        this.deviceID = service.getDeviceID();
        this.serviceUUID = service.getUuid();
        this.serviceID = service.getId();
    ...
    public Characteristic(Characteristic characteristic) {
        this.f1088id = characteristic.f1088id;
        ...
        if (characteristic.value != null) {
            this.value = (byte[]) characteristic.value.clone();
        }
    ...
    public void logValue(String str, byte[] bArr) {
        ...
        RxBleLog.m1090v(str + " Characteristic(uuid: " + this.gattCharacteristic.getUuid().toString() + ", id: " + this.f1088id + ", value: " + bytesToHex + ")", new Object[0]);
    }
}
