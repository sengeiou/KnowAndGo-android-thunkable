...
public class RxBleDeviceServices {
    ...
    public Observable<BluetoothGattService> getService(@NonNull final UUID uuid) {
    ...
    public Observable<BluetoothGattCharacteristic> getCharacteristic(@NonNull UUID uuid, @NonNull final UUID uuid2) {
