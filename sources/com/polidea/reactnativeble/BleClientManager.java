...
public class BleClientManager extends ReactContextBaseJavaModule {
    ...
    public BleClientManager(ReactApplicationContext reactApplicationContext) {
        ...
        this.bleAdapter = new BleModule(reactApplicationContext);
    }
    ...
    public void createClient(String str) {
        this.bleAdapter.createClient(str, new OnEventCallback<String>() {
    ...
    public void startDeviceScan(@androidx.annotation.Nullable com.facebook.react.bridge.ReadableArray r9, @androidx.annotation.Nullable com.facebook.react.bridge.ReadableMap r10) {
        /*
            r8 = this;
            r0 = 0
            r1 = 1
            ...
            java.lang.String r2 = "scanMode"
            com.facebook.react.bridge.ReadableType r2 = r10.getType(r2)
    ...
    public void connectToDevice(String str, @Nullable ReadableMap readableMap, Promise promise) {
        ...
        if (readableMap2 != null) {
            z = (!readableMap2.hasKey(ConnectionComponent.NamedBooleans.AUTO_CONNECT) || readableMap2.getType(ConnectionComponent.NamedBooleans.AUTO_CONNECT) != ReadableType.Boolean) ? false : readableMap2.getBoolean(ConnectionComponent.NamedBooleans.AUTO_CONNECT);
