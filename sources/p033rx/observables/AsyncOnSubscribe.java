    ...
    static final class AsyncOuterManager<S, T> implements Producer, Subscription, Observer<Observable<? extends T>> {
        ...
        public void request(long r5) {
            ...
            L_0x0064:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.observables.AsyncOnSubscribe.AsyncOuterManager.request(long):void");
        }
        ...
        public void requestRemaining(long r4) {
            ...
            L_0x005c:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.observables.AsyncOnSubscribe.AsyncOuterManager.requestRemaining(long):void");
        }
        ...
        private void subscribeBufferToObservable(Observable<? extends T> observable) {
            ...
            final C43131 r3 = new Subscriber<T>() {
                long remaining = j;
