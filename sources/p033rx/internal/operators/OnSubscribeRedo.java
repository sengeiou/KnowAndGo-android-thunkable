...
import p033rx.subjects.BehaviorSubject;
import p033rx.subjects.SerializedSubject;
...
public final class OnSubscribeRedo<T> implements Observable.OnSubscribe<T> {
    ...
    public void call(Subscriber<? super T> subscriber) {
        ...
        C41502 r1 = new Action0() {
            public void call() {
                if (!subscriber2.isUnsubscribed()) {
                    C41511 r0 = new Subscriber<T>() {
                        boolean done;
                        ...
                        private void decrementConsumerCapacity() {
                            /*
                                r5 = this;
                            L_0x0000:
                                rx.internal.operators.OnSubscribeRedo$2 r0 = p033rx.internal.operators.OnSubscribeRedo.C41502.this
                                java.util.concurrent.atomic.AtomicLong r0 = r6
                                long r0 = r0.get()
                                r2 = 9223372036854775807(0x7fffffffffffffff, double:NaN)
                                int r2 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
                                if (r2 == 0) goto L_0x001f
                                rx.internal.operators.OnSubscribeRedo$2 r2 = p033rx.internal.operators.OnSubscribeRedo.C41502.this
                            ...
                            L_0x001f:
                                return
                            */
                            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OnSubscribeRedo.C41502.C41511.decrementConsumerCapacity():void");
                        }
