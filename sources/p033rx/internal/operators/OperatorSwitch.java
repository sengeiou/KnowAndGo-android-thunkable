...
public final class OperatorSwitch<T> implements Observable.Operator<T, Observable<? extends T>> {
    ...
    static final class SwitchSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        public void emit(T t, InnerSubscriber<T> innerSubscriber) {
            synchronized (this) {
                if (this.index.get() == innerSubscriber.f3068id) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x0054, code lost:
            r2 = p033rx.internal.operators.NotificationLite.getValue(r9.poll());
         */
        /* JADX WARNING: Code restructure failed: missing block: B:28:0x006c, code lost:
            if (r10.get() != p033rx.internal.operators.OperatorSwitch.InnerSubscriber.access$000((p033rx.internal.operators.OperatorSwitch.InnerSubscriber) r9.poll())) goto L_0x0032;
         */
        ...
        public void drain() {
            ...
            L_0x0054:
                ...
                rx.internal.operators.OperatorSwitch$InnerSubscriber r1 = (p033rx.internal.operators.OperatorSwitch.InnerSubscriber) r1
                java.lang.Object r2 = r9.poll()
                java.lang.Object r2 = p033rx.internal.operators.NotificationLite.getValue(r2)
                long r3 = r10.get()
                long r5 = r1.f3068id
            ...
            L_0x00c8:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorSwitch.SwitchSubscriber.drain():void");
        }
    ...
    static final class InnerSubscriber<T> extends Subscriber<T> {
        ...
        public void setProducer(Producer producer) {
            this.parent.innerProducer(producer, this.f3068id);
        }
        ...
        public void onError(Throwable th) {
            this.parent.error(th, this.f3068id);
        }

        public void onCompleted() {
            this.parent.complete(this.f3068id);
        }
    }
}
