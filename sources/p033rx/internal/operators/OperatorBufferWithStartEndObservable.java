...
public final class OperatorBufferWithStartEndObservable<T, TOpening, TClosing> implements Observable.Operator<List<T>, T> {
    ...
    public Subscriber<? super T> call(Subscriber<? super List<T>> subscriber) {
        ...
        C41721 r1 = new Subscriber<TOpening>() {
    ...
    final class BufferingSubscriber extends Subscriber<T> {
        ...
        public void onCompleted() {
            ...
            L_0x0039:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorBufferWithStartEndObservable.BufferingSubscriber.onCompleted():void");
        }
            ...
            synchronized (this) {
                if (!this.done) {
                    ...
                    try {
                        ...
                        C41731 r1 = new Subscriber<TClosing>() {
        ...
        public void endBuffer(java.util.List<T> r3) {
            ...
            L_0x002a:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorBufferWithStartEndObservable.BufferingSubscriber.endBuffer(java.util.List):void");
        }
    }
}
