...
public final class OperatorDebounceWithTime<T> implements Observable.Operator<T, T> {
        ...
        return new Subscriber<T>(subscriber) {
            ...
            public void onNext(T t) {
                ...
                serialSubscription.set(createWorker.schedule(new Action0() {
                    public void call() {
                        C41791.this.state.emit(next, serializedSubscriber, C41791.this.self);
                    }
    ...
    static final class DebounceState<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:28:0x002f, code lost:
            p033rx.exceptions.Exceptions.throwOrReport(r4, (p033rx.Observer<?>) r5, (java.lang.Object) r3);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:29:0x0032, code lost:
            return;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void emit(int r3, p033rx.Subscriber<T> r4, p033rx.Subscriber<?> r5) {
            /*
                r2 = this;
                monitor-enter(r2)
            ...
            L_0x002e:
                r4 = move-exception
                p033rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r4, (p033rx.Observer<?>) r5, (java.lang.Object) r3)
                return
            L_0x0033:
                monitor-exit(r2)     // Catch:{ all -> 0x0035 }
                return
            L_0x0035:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorDebounceWithTime.DebounceState.emit(int, rx.Subscriber, rx.Subscriber):void");
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x001e, code lost:
            p033rx.exceptions.Exceptions.throwOrReport(r5, (p033rx.Observer<?>) r6, (java.lang.Object) r0);
         */
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void emitAndComplete(p033rx.Subscriber<T> r5, p033rx.Subscriber<?> r6) {
            /*
                r4 = this;
                monitor-enter(r4)
            ...
            L_0x001d:
                r5 = move-exception
                p033rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r5, (p033rx.Observer<?>) r6, (java.lang.Object) r0)
                return
            L_0x0022:
                r5.onCompleted()
                return
            L_0x0026:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorDebounceWithTime.DebounceState.emitAndComplete(rx.Subscriber, rx.Subscriber):void");
        }
