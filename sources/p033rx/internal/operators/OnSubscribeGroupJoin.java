...
import p033rx.subscriptions.RefCountSubscription;
        ...
        final class LeftDurationObserver extends Subscriber<D1> {
            ...
            public void onCompleted() {
                ...
                if (this.once) {
                    this.once = false;
                    synchronized (ResultManager.this) {
                        observer = (Observer) ResultManager.this.leftMap().remove(Integer.valueOf(this.f3059id));
                    }
                    if (observer != null) {
        ...
        final class RightDurationObserver extends Subscriber<D2> {
            ...
            public void onCompleted() {
                if (this.once) {
                    this.once = false;
                    synchronized (ResultManager.this) {
                        ResultManager.this.rightMap.remove(Integer.valueOf(this.f3060id));
                    }
                    ResultManager.this.group.remove(this);
                }
            }
