    ...
    static final class EagerOuterSubscriber<T, R> extends Subscriber<T> {
        ...
        public void onNext(T r4) {
            /*
                ...
                rx.Observable r0 = (p033rx.Observable) r0     // Catch:{ Throwable -> 0x0032 }
            ...
            L_0x0032:
                ...
                p033rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r0, (p033rx.Observer<?>) r1, (java.lang.Object) r4)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.internal.operators.OperatorEagerConcatMap.EagerOuterSubscriber.onNext(java.lang.Object):void");
        }
