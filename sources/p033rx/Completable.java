...
import p033rx.internal.operators.CompletableFromEmitter;
import p033rx.internal.operators.CompletableOnSubscribeConcat;
import p033rx.internal.operators.CompletableOnSubscribeConcatArray;
import p033rx.internal.operators.CompletableOnSubscribeConcatIterable;
import p033rx.internal.operators.CompletableOnSubscribeMerge;
import p033rx.internal.operators.CompletableOnSubscribeMergeArray;
import p033rx.internal.operators.CompletableOnSubscribeMergeDelayErrorArray;
import p033rx.internal.operators.CompletableOnSubscribeMergeDelayErrorIterable;
import p033rx.internal.operators.CompletableOnSubscribeMergeIterable;
import p033rx.internal.operators.CompletableOnSubscribeTimeout;
...
import p033rx.observers.SafeCompletableSubscriber;
...
import p033rx.subscriptions.MultipleAssignmentSubscription;
...
public class Completable {
    ...
    public static Completable amb(final Completable... completableArr) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                C40521 r2 = new CompletableSubscriber() {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                try {
                    ...
                    final AtomicBoolean atomicBoolean = new AtomicBoolean();
                    C40651 r3 = new CompletableSubscriber() {
                        public void onCompleted() {
                            if (atomicBoolean.compareAndSet(false, true)) {
                                compositeSubscription.unsubscribe();
                                completableSubscriber.onCompleted();
    ...
    public static Completable fromObservable(final Observable<?> observable) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C40151 r0 = new Subscriber<Object>() {
    ...
    public static Completable fromSingle(final Single<?> single) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C40171 r0 = new SingleSubscriber<Object>() {
                    public void onError(Throwable th) {
                        completableSubscriber.onError(th);
                    }
    ...
    public final Completable compose(Transformer transformer) {
        return (Completable) mo47379to(transformer);
    }
    ...
    /* renamed from: to */
    public final <R> R mo47379to(Func1<? super Completable, R> func1) {
