...
import p033rx.internal.util.atomic.SpscLinkedAtomicQueue;
import p033rx.internal.util.atomic.SpscUnboundedAtomicArrayQueue;
import p033rx.internal.util.unsafe.SpscLinkedQueue;
...
public final class UnicastSubject<T> extends Subject<T, T> {
    ...
    static final class State<T> extends AtomicLong implements Producer, Observer<T>, Observable.OnSubscribe<T>, Subscription {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:0x0055, code lost:
            r12 = p033rx.internal.operators.NotificationLite.getValue(r13);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:35:0x0062, code lost:
            ...
            r3.onError(p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r12));
         */
        ...
        public void replay() {
            ...
            L_0x0011:
                ...
                rx.Subscriber r3 = (p033rx.Subscriber) r3
                r4 = 0
            ...
            L_0x0052:
                ...
                goto L_0x0070
            L_0x0055:
                java.lang.Object r12 = p033rx.internal.operators.NotificationLite.getValue(r13)
            ...
            L_0x0061:
                ...
                r0.clear()
                p033rx.exceptions.Exceptions.throwIfFatal(r1)
                java.lang.Throwable r0 = p033rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r12)
                r3.onError(r0)
                return
            L_0x0070:
            ...
            L_0x0097:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p033rx.subjects.UnicastSubject.State.replay():void");
        }
