...
import p033rx.internal.operators.CompletableFlatMapSingleToCompletable;
import p033rx.internal.operators.SingleDelay;
import p033rx.internal.operators.SingleDoAfterTerminate;
import p033rx.internal.operators.SingleDoOnEvent;
import p033rx.internal.operators.SingleDoOnSubscribe;
import p033rx.internal.operators.SingleDoOnUnsubscribe;
import p033rx.internal.operators.SingleFromCallable;
import p033rx.internal.operators.SingleFromEmitter;
import p033rx.internal.operators.SingleFromFuture;
import p033rx.internal.operators.SingleFromObservable;
import p033rx.internal.operators.SingleLiftObservableOperator;
import p033rx.internal.operators.SingleObserveOn;
import p033rx.internal.operators.SingleOnErrorReturn;
import p033rx.internal.operators.SingleOnSubscribeDelaySubscriptionOther;
import p033rx.internal.operators.SingleOnSubscribeMap;
import p033rx.internal.operators.SingleOnSubscribeUsing;
import p033rx.internal.operators.SingleOperatorCast;
import p033rx.internal.operators.SingleOperatorOnErrorResumeNext;
import p033rx.internal.operators.SingleOperatorZip;
import p033rx.internal.operators.SingleTakeUntilCompletable;
import p033rx.internal.operators.SingleTakeUntilObservable;
import p033rx.internal.operators.SingleTakeUntilSingle;
import p033rx.internal.operators.SingleTimeout;
import p033rx.internal.operators.SingleToObservable;
import p033rx.internal.util.ScalarSynchronousSingle;
...
import p033rx.singles.BlockingSingle;
...
public class Single<T> {
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> single) {
        ...
        return create(new OnSubscribe<T>(single) {
            ...
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                C40881 r0 = new SingleSubscriber<Single<? extends T>>() {
        ...
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                ...
                createWorker.schedule(new Action0() {
                    public void call() {
                        C40771 r0 = new SingleSubscriber<T>() {
                            public void onSuccess(T t) {
                                try {
    ...
    /* renamed from: to */
    public final <R> R mo47763to(Func1<? super Single<T>, R> func1) {
    ...
    public final Single<T> unsubscribeOn(final Scheduler scheduler) {
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                final C40841 r0 = new SingleSubscriber<T>() {
                    public void onSuccess(T t) {
                        singleSubscriber.onSuccess(t);
                    }
