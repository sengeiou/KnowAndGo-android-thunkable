...
public class ReactAdapterPackage extends BasePackage {
    public List<InternalModule> createInternalModules(Context context) {
        ...
        return Arrays.asList(new InternalModule[]{new CookieManagerModule(reactContext), new UIManagerModuleWrapper(reactContext), new EventEmitterModule(reactContext), new FontManagerModule(), new RuntimeEnvironmentModule()});
    }
}
