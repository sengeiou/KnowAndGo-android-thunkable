...
public class DateFormatUtils {
    ...
    public static final FastDateFormat ISO_8601_EXTENDED_DATE_FORMAT = FastDateFormat.getInstance(ParametersConverter.PROTOCOL_DATE_FORMAT);
    public static final FastDateFormat ISO_8601_EXTENDED_TIME_FORMAT = FastDateFormat.getInstance(ParametersConverter.PROTOCOL_TIME_FORMAT);
