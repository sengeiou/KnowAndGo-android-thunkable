...
public class DateUtils {
    ...
    public static java.util.Iterator<java.util.Calendar> iterator(java.util.Calendar r7, int r8) {
        ...
        L_0x000a:
            ...
            throw r7
        L_0x0026:
            java.util.Calendar r7 = truncate((java.util.Calendar) r7, (int) r1)
        ...
        L_0x003c:
            ...
            goto L_0x0065
        L_0x0041:
            java.util.Calendar r5 = truncate((java.util.Calendar) r7, (int) r2)
            java.util.Calendar r6 = truncate((java.util.Calendar) r7, (int) r2)
            switch(r8) {
