...
public class MessageFormatMessage implements Message {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.messagePattern == null ? messageFormatMessage.messagePattern == null : this.messagePattern.equals(messageFormatMessage.messagePattern)) {
    ...
    public int hashCode() {
        ...
        if (this.serializedParameters != null) {
            i = Arrays.hashCode(this.serializedParameters);
        }
        return hashCode + i;
    }
