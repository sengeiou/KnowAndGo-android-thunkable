...
import expo.modules.p020av.progress.AndroidLooperTimeMachine;
import expo.modules.p020av.progress.ProgressLooper;
...
public abstract class PlayerData implements AudioEventHandler {
    ...
    private void callStatusUpdateListenerWithStatus(Bundle bundle) {
        if (this.mStatusUpdateListener != null) {
            this.mStatusUpdateListener.onStatusUpdate(bundle);
        }
    }
        ...
        if (!shouldContinueUpdatingProgress()) {
            ...
            this.mProgressUpdater.loop((long) this.mProgressUpdateIntervalMillis, new Function0() {
                public final Object invoke() {
                    return PlayerData.this.callStatusUpdateListener();
                }
            });
        }
    }
    ...
    public final void setStatusWithListener(Bundle bundle, SetStatusCompletionListener setStatusCompletionListener) {
        if (bundle.containsKey(STATUS_PROGRESS_UPDATE_INTERVAL_MILLIS_KEY_PATH)) {
