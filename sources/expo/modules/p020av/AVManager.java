...
import expo.modules.p020av.video.VideoView;
import expo.modules.p020av.video.VideoViewWrapper;
import java.io.File;
...
public class AVManager implements LifecycleEventListener, AudioManager.OnAudioFocusChangeListener, MediaRecorder.OnInfoListener, AVManagerInterface, InternalModule {
    ...
    public AVManager(Context context) {
        ...
        this.mNoisyAudioStreamReceiver = new BroadcastReceiver() {
    ...
    public void sendEvent(String str, Bundle bundle) {
        ...
        if (this.mModuleRegistry != null && (eventEmitter = (EventEmitter) this.mModuleRegistry.getModule(EventEmitter.class)) != null) {
    ...
    public void setAudioMode(ReadableArguments readableArguments) {
        this.mShouldDuckAudio = readableArguments.getBoolean(AUDIO_MODE_SHOULD_DUCK_KEY);
        if (!this.mShouldDuckAudio) {
            this.mIsDuckingAudio = false;
            updateDuckStatusForAllPlayersPlaying();
        }
        if (readableArguments.containsKey(AUDIO_MODE_PLAY_THROUGH_EARPIECE)) {
            this.mShouldRouteThroughEarpiece = readableArguments.getBoolean(AUDIO_MODE_PLAY_THROUGH_EARPIECE);
    ...
    private void tryRunWithVideoView(Integer num, final VideoViewCallback videoViewCallback, final Promise promise) {
        UIManager uIManager;
        if (this.mModuleRegistry != null && (uIManager = (UIManager) this.mModuleRegistry.getModule(UIManager.class)) != null) {
