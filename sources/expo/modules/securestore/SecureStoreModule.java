...
public class SecureStoreModule extends ExportedModule {
    ...
    public SecureStoreModule(Context context) {
        super(context);
        this.mHybridAESEncrypter = new HybridAESEncrypter(context, this.mAESEncrypter);
    }
        ...
        if (str2 != null) {
            try {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    jSONObject = this.mAESEncrypter.createEncryptedItem(str2, keyStore, (KeyStore.SecretKeyEntry) getKeyEntry(KeyStore.SecretKeyEntry.class, this.mAESEncrypter, readableArguments));
