package p024io.nlopez.smartlocation.activity.providers;
...
import p024io.nlopez.smartlocation.activity.ActivityStore;
...
public class ActivityGooglePlayServicesProvider implements ActivityProvider, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<Status> {
        ...
        this.activityReceiver = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                if (ActivityGooglePlayServicesProvider.BROADCAST_INTENT_ACTION.equals(intent.getAction()) && intent.hasExtra(ActivityGooglePlayServicesProvider.DETECTED_ACTIVITY_EXTRA_ID)) {
                    ActivityGooglePlayServicesProvider.this.logger.mo39738d("sending new activity", new Object[0]);
    ...
    public void init(@NonNull Context context2, Logger logger2) {
        this.context = context2;
        this.logger = logger2;
        this.activityStore = new ActivityStore(context2);
        if (!this.shouldStart) {
            this.client = new GoogleApiClient.Builder(context2).addApi(ActivityRecognition.API).addConnectionCallbacks(this).addOnConnectionFailedListener(this).build();
            this.client.connect();
            return;
        }
    ...
    public void start(OnActivityUpdatedListener onActivityUpdatedListener, @NonNull ActivityParams activityParams2) {
    ...
    public void stop() {
        ...
        try {
            ...
            this.logger.mo39738d("Silenced 'receiver not registered' stuff (calling stop more times than necessary did this)", new Object[0]);
        }
        this.shouldStart = false;
        this.stopped = true;
    }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        this.logger.mo39738d("onConnectionFailed", new Object[0]);
        if (this.googlePlayServicesListener != null) {
    ...
    public void onResult(@NonNull Status status) {
        if (status.isSuccess()) {
            this.logger.mo39738d("Activity update request successful", new Object[0]);
            ...
            this.logger.mo39746w("Unable to register, but we can solve this - will startActivityForResult expecting result code 10002 (if received, please try again)", new Object[0]);
            try {
