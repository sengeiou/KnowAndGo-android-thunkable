package p024io.nlopez.smartlocation.location.config;
...
public class LocationParams {
    ...
    public int hashCode() {
        return (((((int) (this.interval ^ (this.interval >>> 32))) * 31) + (this.distance != 0.0f ? Float.floatToIntBits(this.distance) : 0)) * 31) + this.accuracy.hashCode();
    }
