...
import p024io.nlopez.smartlocation.activity.ActivityProvider;
...
import p024io.nlopez.smartlocation.geocoding.GeocodingProvider;
import p024io.nlopez.smartlocation.geocoding.providers.AndroidGeocodingProvider;
import p024io.nlopez.smartlocation.geofencing.GeofencingProvider;
...
import p024io.nlopez.smartlocation.location.providers.LocationGooglePlayServicesWithFallbackProvider;
import p024io.nlopez.smartlocation.location.utils.LocationState;
import p024io.nlopez.smartlocation.utils.Logger;
import p024io.nlopez.smartlocation.utils.LoggerFactory;
...
public class SmartLocation {
    ...
    public static class LocationControl {
        ...
        public LocationControl(@NonNull SmartLocation smartLocation2, @NonNull LocationProvider locationProvider) {
    ...
    public static class GeocodingControl {
        ...
        public GeocodingControl(@NonNull SmartLocation smartLocation2, @NonNull GeocodingProvider geocodingProvider) {
            this.smartLocation = smartLocation2;
            if (!MAPPING.containsKey(smartLocation2.context)) {
        ...
        public void start(OnGeocodingListener onGeocodingListener, OnReverseGeocodingListener onReverseGeocodingListener) {
            if (this.provider != null) {
                if (this.directAdded && onGeocodingListener == null) {
                    this.smartLocation.logger.mo39746w("Some places were added for geocoding but the listener was not specified!", new Object[0]);
                }
                if (this.reverseAdded && onReverseGeocodingListener == null) {
                    this.smartLocation.logger.mo39746w("Some places were added for reverse geocoding but the listener was not specified!", new Object[0]);
                }
    ...
    public static class ActivityRecognitionControl {
        ...
        public ActivityRecognitionControl(@NonNull SmartLocation smartLocation2, @NonNull ActivityProvider activityProvider) {
            this.smartLocation = smartLocation2;
            if (!MAPPING.containsKey(smartLocation2.context)) {
    ...
    public static class GeofencingControl {
        ...
        public GeofencingControl(@NonNull SmartLocation smartLocation2, @NonNull GeofencingProvider geofencingProvider) {
            this.smartLocation = smartLocation2;
            if (!MAPPING.containsKey(smartLocation2.context)) {
