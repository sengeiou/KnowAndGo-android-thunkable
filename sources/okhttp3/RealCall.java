...
final class RealCall implements Call {
    ...
    public C3873Response execute() throws IOException {
        synchronized (this) {
            if (!this.executed) {
                this.executed = true;
            } else {
        ...
        try {
            ...
            C3873Response responseWithInterceptorChain = getResponseWithInterceptorChain();
    ...
    final class AsyncCall extends NamedRunnable {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:17:0x006a A[Catch:{ all -> 0x003d }] */
    ...
    /* access modifiers changed from: package-private */
    public C3873Response getResponseWithInterceptorChain() throws IOException {
