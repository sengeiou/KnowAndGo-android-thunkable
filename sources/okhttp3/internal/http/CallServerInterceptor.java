...
public final class CallServerInterceptor implements Interceptor {
    ...
    public C3873Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        C3873Response.Builder builder = null;
        ...
        C3873Response build = builder.request(request).handshake(streamAllocation.connection().handshake()).sentRequestAtMillis(currentTimeMillis).receivedResponseAtMillis(System.currentTimeMillis()).build();
        int code = build.code();
        if (code == 100) {
