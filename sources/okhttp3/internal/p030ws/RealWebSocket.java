...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m2491of(bArr).base64();
            this.writerRunnable = new Runnable() {
                public void run() {
                    do {
                        try {
                        } catch (IOException e) {
                            RealWebSocket.this.failWebSocket(e, (C3873Response) null);
                            return;
                        }
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        this.call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException iOException) {
                RealWebSocket.this.failWebSocket(iOException, (C3873Response) null);
            }
        });
    }

    /* access modifiers changed from: package-private */
    public void checkResponse(C3873Response response) throws ProtocolException {
    ...
    public boolean processNextFrame() throws IOException {
        try {
            ...
            failWebSocket(e, (C3873Response) null);
            return false;
        }
    }
    ...
    public synchronized void onReadPing(okio.ByteString r2) {
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p030ws.RealWebSocket.onReadPing(okio.ByteString):void");
    }
    ...
    private synchronized boolean send(okio.ByteString r7, int r8) {
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p030ws.RealWebSocket.send(okio.ByteString, int):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x005a, code lost:
        if ((r5 instanceof okhttp3.internal.p030ws.RealWebSocket.Message) == false) goto L_0x0088;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x005c, code lost:
        r1 = ((okhttp3.internal.p030ws.RealWebSocket.Message) r5).data;
        r0 = okio.Okio.buffer(r0.newMessageSink(((okhttp3.internal.p030ws.RealWebSocket.Message) r5).formatOpcode, (long) r1.size()));
        r0.write(r1);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:39:0x008a, code lost:
        if ((r5 instanceof okhttp3.internal.p030ws.RealWebSocket.Close) == false) goto L_0x00a1;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x008c, code lost:
        r5 = (okhttp3.internal.p030ws.RealWebSocket.Close) r5;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p030ws.RealWebSocket.Close     // Catch:{ all -> 0x00ab }
        ...
        L_0x0031:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p030ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00ab }
        ...
        L_0x0056:
            ...
            goto L_0x00a7
        L_0x0058:
            boolean r2 = r5 instanceof okhttp3.internal.p030ws.RealWebSocket.Message     // Catch:{ all -> 0x0056 }
            if (r2 == 0) goto L_0x0088
            r1 = r5
            okhttp3.internal.ws.RealWebSocket$Message r1 = (okhttp3.internal.p030ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x0056 }
            okio.ByteString r1 = r1.data     // Catch:{ all -> 0x0056 }
            okhttp3.internal.ws.RealWebSocket$Message r5 = (okhttp3.internal.p030ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x0056 }
        ...
        L_0x0088:
            boolean r2 = r5 instanceof okhttp3.internal.p030ws.RealWebSocket.Close     // Catch:{ all -> 0x0056 }
            if (r2 == 0) goto L_0x00a1
            okhttp3.internal.ws.RealWebSocket$Close r5 = (okhttp3.internal.p030ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x0056 }
        ...
        L_0x00ab:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p030ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x001e, code lost:
        failWebSocket(new java.net.SocketTimeoutException("sent ping but didn't receive pong within " + r7.pingIntervalMillis + "ms (after " + (r1 - 1) + " successful ping/pongs)"), (okhttp3.C3873Response) null);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x004f, code lost:
        failWebSocket(r0, (okhttp3.C3873Response) null);
     */
    ...
    public void writePingFrame() {
        ...
        L_0x0053:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p030ws.RealWebSocket.writePingFrame():void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void failWebSocket(java.lang.Exception r4, @javax.annotation.Nullable okhttp3.C3873Response r5) {
        /*
            r3 = this;
            monitor-enter(r3)
        ...
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p030ws.RealWebSocket.failWebSocket(java.lang.Exception, okhttp3.Response):void");
    }
