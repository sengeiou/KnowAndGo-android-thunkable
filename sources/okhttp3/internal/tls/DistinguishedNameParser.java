...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f3018dn;
    private int end;
    private final int length = this.f3018dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal x500Principal) {
        this.f3018dn = x500Principal.getName("RFC2253");
    }
        ...
        if (this.pos < this.length) {
            ...
            if (this.chars[this.pos] == ' ') {
                ...
                if (this.chars[this.pos] != '=' || this.pos == this.length) {
                    throw new IllegalStateException("Unexpected end of DN: " + this.f3018dn);
                }
            }
            this.pos++;
            while (this.pos < this.length && this.chars[this.pos] == ' ') {
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f3018dn);
            } else {
                i2 = c - '7';
            }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f3018dn.toCharArray();
