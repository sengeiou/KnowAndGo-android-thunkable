...
public final class CacheStrategy {
    @Nullable
    public final C3873Response cacheResponse;
    @Nullable
    public final Request networkRequest;

    CacheStrategy(Request request, C3873Response response) {
    ...
    public static boolean isCacheable(okhttp3.C3873Response r3, okhttp3.Request r4) {
        /*
            int r0 = r3.code()
            r1 = 0
            switch(r0) {
    ...
    public static class Factory {
        ...
        public Factory(long j, Request request2, C3873Response response) {
            this.nowMillis = j;
        ...
        public CacheStrategy get() {
            ...
            return (candidate.networkRequest == null || !this.request.cacheControl().onlyIfCached()) ? candidate : new CacheStrategy((Request) null, (C3873Response) null);
        }
        ...
        private CacheStrategy getCandidate() {
            ...
            if (this.cacheResponse == null) {
                return new CacheStrategy(this.request, (C3873Response) null);
            }
            ...
            if (!cacheControl2.noCache()) {
                ...
                if (j2 < j + computeFreshnessLifetime) {
                    C3873Response.Builder newBuilder = this.cacheResponse.newBuilder();
