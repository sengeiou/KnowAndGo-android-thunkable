...
public class ShareFiles {
    ...
    private boolean isBase64File(Uri uri) {
        ...
        if (this.intentType == null) {
            ...
            return true;
        } else if (!this.intentType.equalsIgnoreCase(substring) && this.intentType.split("/")[0].equalsIgnoreCase(substring.split("/")[0])) {
    ...
    private boolean isLocalFile(Uri uri) {
        ...
        if (this.intentType == null) {
            ...
            return true;
        } else if (!this.intentType.equalsIgnoreCase(mimeType) && this.intentType.split("/")[0].equalsIgnoreCase(mimeType.split("/")[0])) {
            this.intentType = this.intentType.split("/")[0].concat("/*");
            return true;
