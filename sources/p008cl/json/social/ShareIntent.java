...
public abstract class ShareIntent {
    ...
    public void open(ReadableMap readableMap) throws ActivityNotFoundException {
        ...
        String str = "";
        if (hasValidKey(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, readableMap)) {
            str = readableMap.getString(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE);
        }
        if (hasValidKey("urls", readableMap)) {
            ...
            if (fileShares.isFile()) {
                ...
                intent2.putExtra("android.intent.extra.TEXT", str + StringUtils.SPACE + readableMap.getArray("urls").toString());
            } else {
            ...
            if (this.fileShare.isFile()) {
                ...
                intent3.putExtra("android.intent.extra.TEXT", str + StringUtils.SPACE + readableMap.getString(ImagesContract.URL));
            } else {
