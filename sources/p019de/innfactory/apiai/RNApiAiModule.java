package p019de.innfactory.apiai;
...
public class RNApiAiModule extends ReactContextBaseJavaModule implements AIListener {
    ...
    public void startListeningNative(Callback callback, Callback callback2) {
        ...
        getCurrentActivity().runOnUiThread(new Runnable() {
            public void run() {
                AIService unused = RNApiAiModule.this.aiService = AIService.getService(RNApiAiModule.this.getReactApplicationContext(), RNApiAiModule.this.config);
                ...
                RNApiAiModule.this.aiService.startListening(new RequestExtras(RNApiAiModule.this.mergeContexts(RNApiAiModule.this.contexts, RNApiAiModule.this.permantentContexts), RNApiAiModule.this.entities));
    ...
    public void onAudioLevel(float f) {
        if (this.onAudioLevelCallback != null) {
            try {
                this.onAudioLevelCallback.invoke(Float.valueOf(f));
            } catch (Exception e) {
                Log.e(TAG, e.getMessage(), e);
            }
        }
