...
final class C3625x4fc4299 extends Lambda implements Function0<String> {
    final /* synthetic */ Class $annotationClass;
    final /* synthetic */ Map $values;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C3625x4fc4299(Class cls, Map map) {
        super(0);
    ...
    public final String invoke() {
        ...
        CollectionsKt.joinTo$default(this.$values.entrySet(), sb, ", ", "(", ")", 0, (CharSequence) null, C3626xd18867f3.INSTANCE, 48, (Object) null);
