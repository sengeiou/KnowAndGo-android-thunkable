...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    /* renamed from: lt */
    private final String m2487lt() {
        return escape("<");
    }

    /* renamed from: gt */
    private final String m2486gt() {
        return escape(">");
    }
    ...
    public String renderAnnotation(@NotNull AnnotationDescriptor annotationDescriptor, @Nullable AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (annotationUseSiteTarget != null) {
            sb.append(annotationUseSiteTarget.getRenderName() + ParameterizedMessage.ERROR_MSG_SEPARATOR);
        }
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) {
        ...
        renderAnnotations$default(this, sb, constructorDescriptor, (AnnotationUseSiteTarget) null, 2, (Object) null);
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (unsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).getUnsubstitutedPrimaryConstructor()) != null) {
            ...
            if (!list.isEmpty()) {
                ...
                sb.append(CollectionsKt.joinToString$default(list, ", ", "(", ")", 0, (CharSequence) null, DescriptorRendererImpl$renderConstructor$1.INSTANCE, 24, (Object) null));
            }
        }
        if (getSecondaryConstructorsAsPrimary()) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0087, code lost:
        if ((getDebugMode() ? r8.declaresDefaultValue() : kotlin.reflect.jvm.internal.impl.resolve.descriptorUtil.DescriptorUtilsKt.declaresOrInheritsDefaultValue(r8)) != false) goto L_0x008b;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void renderValueParameter(kotlin.reflect.jvm.internal.impl.descriptors.ValueParameterDescriptor r8, boolean r9, java.lang.StringBuilder r10, boolean r11) {
        ...
        L_0x0054:
            ...
            r7.renderModifier(r10, r0, r2)
            java.lang.String r0 = "val"
            r7.renderModifier(r10, r1, r0)
        L_0x006c:
            r0 = r8
