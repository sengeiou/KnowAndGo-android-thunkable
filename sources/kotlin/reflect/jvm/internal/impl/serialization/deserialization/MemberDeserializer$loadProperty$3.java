...
final class MemberDeserializer$loadProperty$3 extends Lambda implements Function0<ConstantValue<?>> {
    ...
    public final ConstantValue<?> invoke() {
        ...
        AnnotationAndConstantLoader<AnnotationDescriptor, ConstantValue<?>> annotationAndConstantLoader = this.this$0.f3000c.getComponents().getAnnotationAndConstantLoader();
