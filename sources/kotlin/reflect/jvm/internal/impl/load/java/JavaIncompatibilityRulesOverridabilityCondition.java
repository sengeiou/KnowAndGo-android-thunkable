...
public final class JavaIncompatibilityRulesOverridabilityCondition implements ExternalOverridabilityCondition {
    ...
    public static final class Companion {
        ...
        private final boolean isPrimitiveCompareTo(FunctionDescriptor functionDescriptor) {
            ...
            if (classDescriptor2 == null || !KotlinBuiltIns.isPrimitiveClass(classDescriptor) || !Intrinsics.areEqual((Object) DescriptorUtilsKt.getFqNameSafe(classDescriptor), (Object) DescriptorUtilsKt.getFqNameSafe(classDescriptor2))) {
                return false;
            }
            return true;
        }
