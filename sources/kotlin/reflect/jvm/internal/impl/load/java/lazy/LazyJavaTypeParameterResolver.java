...
public final class LazyJavaTypeParameterResolver implements TypeParameterResolver {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f2980c;
    /* access modifiers changed from: private */
    public final DeclarationDescriptor containingDeclaration;
    private final MemoizedFunctionToNullable<JavaTypeParameter, LazyJavaTypeParameterDescriptor> resolve = this.f2980c.getStorageManager().createMemoizedFunctionWithNullableValues(new LazyJavaTypeParameterResolver$resolve$1(this));
    /* access modifiers changed from: private */
    ...
    public LazyJavaTypeParameterResolver(@NotNull LazyJavaResolverContext lazyJavaResolverContext, @NotNull DeclarationDescriptor declarationDescriptor, @NotNull JavaTypeParameterListOwner javaTypeParameterListOwner, int i) {
        ...
        this.f2980c = lazyJavaResolverContext;
    ...
    public TypeParameterDescriptor resolveTypeParameter(@NotNull JavaTypeParameter javaTypeParameter) {
        ...
        return invoke != null ? invoke : this.f2980c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter);
    }
}
