...
public final class UtilKt {
    ...
    private static final Annotation toAnnotationInstance(@NotNull AnnotationDescriptor annotationDescriptor) {
        ...
        for (Map.Entry entry : annotationDescriptor.getAllValueArguments().entrySet()) {
            ...
            Pair pair = runtimeValue != null ? TuplesKt.m2473to(name.asString(), runtimeValue) : null;
            if (pair != null) {
                arrayList.add(pair);
            }
        }
