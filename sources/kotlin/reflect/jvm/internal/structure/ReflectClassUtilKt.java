...
public final class ReflectClassUtilKt {
    ...
    static {
        ...
        for (KClass kClass : iterable) {
            arrayList.add(TuplesKt.m2473to(JvmClassMappingKt.getJavaObjectType(kClass), JvmClassMappingKt.getJavaPrimitiveType(kClass)));
        }
        ...
        for (KClass kClass2 : iterable2) {
            arrayList2.add(TuplesKt.m2473to(JvmClassMappingKt.getJavaPrimitiveType(kClass2), JvmClassMappingKt.getJavaObjectType(kClass2)));
        }
        ...
        for (Object next : listOf) {
            ...
            arrayList3.add(TuplesKt.m2473to((Class) next, Integer.valueOf(i)));
            i = i2;
        }
