...
public final class DurationKt {
    ...
    private static final double m3488timesmvk6XK0(int i, double d) {
        return Duration.m3470timesimpl(d, i);
    }
    ...
    private static final double m3487timeskIfJnKk(double d, double d2) {
        return Duration.m3469timesimpl(d2, d);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m3443constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
